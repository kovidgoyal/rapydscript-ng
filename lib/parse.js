...
"use strict";
COMPILER_VERSION = "ea365d792368f99fc7f957a9d1fd547a097cbe5f";
...
function parse($TEXT, options) {
    ...
    function do_import(key) {
        ...
        function safe_read(base_path) {
            ...
            var _$rapyd$_Iter7 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
        ...
        modpath = key.replace(".", "/");
        var _$rapyd$_Iter8 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
        for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
            location = _$rapyd$_Iter8[_$rapyd$_Index8];
            if (location) {
        ...
        if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
            var _$rapyd$_Iter9 = _$rapyd$_Iterable(cached.imported_module_ids);
            for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                ikey = _$rapyd$_Iter9[_$rapyd$_Index9];
                do_import(ikey);
            }
            IMPORTED[key] = {
                is_cached: true,
        ...
        var _$rapyd$_Iter10 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
        for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
            bitem = _$rapyd$_Iter10[_$rapyd$_Index10];
    ...
    import_ = function(from_import) {
        ...
        var _$rapyd$_Iter11 = _$rapyd$_Iterable(ans["imports"]);
        for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
            imp = _$rapyd$_Iter11[_$rapyd$_Index11];
            do_import(imp.key);
            ...
            if (from_import) {
                ...
                exports = {};
                var _$rapyd$_Iter12 = _$rapyd$_Iterable(IMPORTED[key].exports);
                ...
                var _$rapyd$_Iter13 = _$rapyd$_Iterable(argnames);
                for (var _$rapyd$_Index13 = 0; _$rapyd$_Index13 < _$rapyd$_Iter13.length; _$rapyd$_Index13++) {
                    argvar = _$rapyd$_Iter13[_$rapyd$_Index13];
                ...
                var _$rapyd$_Iter14 = _$rapyd$_Iterable(Object.keys(classes));
                for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                    cname = _$rapyd$_Iter14[_$rapyd$_Index14];
                    obj = classes[cname];
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var _$rapyd$_Iter15 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
