...
"use strict";
COMPILER_VERSION = "f439936fbe1eab1c60ff86800db450d832b92dc4";
...
function parse($TEXT, options) {
    ...
    import_ = function(from_import) {
        ...
        for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
            ...
            if (from_import) {
                ...
                var _$rapyd$_Iter11 = _$rapyd$_Iterable(argnames);
                for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                    argvar = _$rapyd$_Iter11[_$rapyd$_Index11];
                ...
                var _$rapyd$_Iter12 = _$rapyd$_Iterable(Object.keys(classes));
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var _$rapyd$_Iter13 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var _$rapyd$_Iter14 = _$rapyd$_Iterable(enumerate(a));
