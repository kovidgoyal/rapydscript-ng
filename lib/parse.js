...
"use strict";
COMPILER_VERSION = "a8216ce319f964689498346dd4f40d69646ed77f";
...
function parse($TEXT, options) {
    ...
    function do_import(key) {
        ...
        var _$rapyd$_Iter8 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
        for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
            bitem = _$rapyd$_Iter8[_$rapyd$_Index8];
            baselib_items[bitem] = true;
        }
    }
    import_ = function(from_import) {
        var ans, tok, tmp, last_tok, alias, aimp, _$rapyd$_Unpack, classes, argnames, bracketed, aname, argvar, obj, key, cname, imp;
        ans = new AST_Imports({
            "imports": []
        });
        while (true) {
        ...
        var _$rapyd$_Iter9 = _$rapyd$_Iterable(ans["imports"]);
        for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
            imp = _$rapyd$_Iter9[_$rapyd$_Index9];
            do_import(imp.key);
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var _$rapyd$_Iter13 = _$rapyd$_Iterable(enumerate(a));
