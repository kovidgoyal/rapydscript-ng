...
"use strict";
COMPILER_VERSION = "d494ce0701287698c874b583891ee75d792ff97c";
...
function parse($TEXT, options) {
    var module_id, baselib_items, IMPORTED, IMPORTING, S, obj, cname, statement, import_, class_, function_, nonlocal_, const_, new_, expr_atom, array_, object_, subscripts, maybe_unary, expr_op, maybe_conditional, maybe_assign, expression;
    ...
    if (options.classes) {
        var _$rapyd$_Iter2 = _$rapyd$_Iterable(options.classes);
        for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
            cname = _$rapyd$_Iter2[_$rapyd$_Index2];
        ...
        if (Array.isArray(body)) {
            for (name in body) {
                ...
                if (obj instanceof AST_Function || obj instanceof AST_Class) {
                    ...
                    var _$rapyd$_Iter3 = _$rapyd$_Iterable([ "body", "alternative" ]);
    ...
    function do_import(key) {
        var package_module_id, modpath, _$rapyd$_Unpack, data, filename, src_code, location, cached, srchash, bitem;
        ...
        var _$rapyd$_Iter6 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
        for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
            bitem = _$rapyd$_Iter6[_$rapyd$_Index6];
            baselib_items[bitem] = true;
        }
    }
    import_ = function(from_import) {
        var ans, tok, tmp, last_tok, alias, imp, _$rapyd$_Unpack, classes, argnames, bracketed, aname, argvar, obj, key, cname;
        ans = new AST_Imports({
            "imports": []
        });
        while (true) {
            ...
            imp.start = _$rapyd$_Unpack[0];
            imp.end = _$rapyd$_Unpack[1];
        ...
        var _$rapyd$_Iter7 = _$rapyd$_Iterable(ans["imports"]);
        for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
            imp = _$rapyd$_Iter7[_$rapyd$_Index7];
            do_import(imp.key);
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var _$rapyd$_Iter11 = _$rapyd$_Iterable(enumerate(a));
