...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "4647af4b951a9ae1d7c07c7bf292343e724ae9f1";
...
;
            ...
            function function_(in_class, ctor) {
                var name, staticmethod, property_getter, property_setter, _$rapyd$_chain_assign_temp, staticloc, is_generator, definition, assignments, j, i, nonlocals;
...
;
    ...
    (function(){
        ...
        function print_with(self, output) {
            ...
            var _$rapyd$_Iter58 = _$rapyd$_Iterable(self.clauses);
