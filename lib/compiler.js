...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "4c43bb2ac6477ddc6e379e0d53658c0d20c59d6e";
        ...
        function print_class(output) {
            ...
            if (property_names.length) {
                ...
                output.with_parens(function() {
                    ...
                    output.with_block(function() {
                        var prop, name;
                        var _$rapyd$_Iter58 = _$rapyd$_Iterable(property_names);
...
;
    ...
    (function(){
        ...
        function write_imports(module, output) {
            ...
            imports = _$rapyd$_list_decorate([]);
            var _$rapyd$_Iter59 = _$rapyd$_Iterable(Object.keys(module.imports));
            for (var _$rapyd$_Index59 = 0; _$rapyd$_Index59 < _$rapyd$_Iter59.length; _$rapyd$_Index59++) {
                import_id = _$rapyd$_Iter59[_$rapyd$_Index59];
            ...
            for (var _$rapyd$_Index60 = 0; _$rapyd$_Index60 < _$rapyd$_Iter60.length; _$rapyd$_Index60++) {
                ...
                var _$rapyd$_Iter61 = _$rapyd$_Iterable(module_.nonlocalvars);
        ...
        function declare_exports(module_id, exports, submodules, output) {
            var seen, symbol;
            seen = {};
            var _$rapyd$_Iter64 = _$rapyd$_Iterable(exports);
            for (var _$rapyd$_Index64 = 0; _$rapyd$_Index64 < _$rapyd$_Iter64.length; _$rapyd$_Index64++) {
                symbol = _$rapyd$_Iter64[_$rapyd$_Index64];
        ...
        function declare_submodules(module_id, submodules, output) {
            ...
            seen = {};
            var _$rapyd$_Iter65 = _$rapyd$_Iterable(submodules);
            for (var _$rapyd$_Index65 = 0; _$rapyd$_Index65 < _$rapyd$_Iter65.length; _$rapyd$_Index65++) {
                sub_module_id = _$rapyd$_Iter65[_$rapyd$_Index65];
                ...
                output.with_block(function() {
                    ...
                    if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                        ...
                        if (self.srchash && self.filename) {
                            ...
                            var _$rapyd$_Iter66 = _$rapyd$_Iterable(Object.keys(self.classes));
                            for (var _$rapyd$_Index66 = 0; _$rapyd$_Index66 < _$rapyd$_Iter66.length; _$rapyd$_Index66++) {
                                cname = _$rapyd$_Iter66[_$rapyd$_Index66];
                            ...
                            var _$rapyd$_Iter67 = _$rapyd$_Iterable(self.exports);
                            for (var _$rapyd$_Index67 = 0; _$rapyd$_Index67 < _$rapyd$_Iter67.length; _$rapyd$_Index67++) {
                                symdef = _$rapyd$_Iter67[_$rapyd$_Index67];
                                cached.exports.push({
                                    "name": symdef.name
                                });
                            }
                            ...
                            for (var _$rapyd$_Index68 = 0; _$rapyd$_Index68 < _$rapyd$_Iter68.length; _$rapyd$_Index68++) {
                                beautify = _$rapyd$_Iter68[_$rapyd$_Index68];
                                var _$rapyd$_Iter69 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ true, false ]));
                                for (var _$rapyd$_Index69 = 0; _$rapyd$_Index69 < _$rapyd$_Iter69.length; _$rapyd$_Index69++) {
                                    auto_bind = _$rapyd$_Iter69[_$rapyd$_Index69];
                                    var _$rapyd$_Iter70 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ 5, 6 ]));
                                    for (var _$rapyd$_Index70 = 0; _$rapyd$_Index70 < _$rapyd$_Iter70.length; _$rapyd$_Index70++) {
                                        js_version = _$rapyd$_Iter70[_$rapyd$_Index70];
                                        co = new OutputStream({
                                            "beautify": beautify,
                                            "auto_bind": auto_bind,
    ...
    (function(){
        ...
        function print_assign(self, output) {
            ...
            if (self.operator === "=" && self.is_chained()) {
                ...
                var _$rapyd$_Iter71 = _$rapyd$_Iterable(left_hand_sides);
                for (var _$rapyd$_Index71 = 0; _$rapyd$_Index71 < _$rapyd$_Iter71.length; _$rapyd$_Index71++) {
                    lhs = _$rapyd$_Iter71[_$rapyd$_Index71];
                    print_assignment(new AST_Assign({
                        "left": lhs,
                        "right": temp_rhs,
    ...
    (function(){
        ...
        function best_of(a) {
            ...
            best = a[0];
            len_ = best.length;
            for (var _$rapyd$_Index72 = 1; _$rapyd$_Index72 < a.length; _$rapyd$_Index72++) {
                i = _$rapyd$_Index72;
                if (a[i].length < len_) {
                    best = a[i];
                    len_ = best.length;
    ...
    (function(){
        ...
        function generate_code() {
            ...
            DEFPRINT(AST_With, function(self, output) {
                ...
                var _$rapyd$_Iter75 = _$rapyd$_Iterable(self.clauses);
                for (var _$rapyd$_Index75 = 0; _$rapyd$_Index75 < _$rapyd$_Iter75.length; _$rapyd$_Index75++) {
                    clause = _$rapyd$_Iter75[_$rapyd$_Index75];
