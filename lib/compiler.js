(function(){
        ...
        AST_Lambda = DEFNODE("Lambda", "name argnames uses_arguments decorators is_generator", {
            ...
            "_walk": function(visitor) {
                ...
                return visitor._visit(node, function() {
                    var d;
                    if (node.decorators) {
                        var _$rapyd$_Iter0 = _$rapyd$_Iterable(node.decorators);
                        for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < _$rapyd$_Iter0.length; _$rapyd$_Index0++) {
                            d = _$rapyd$_Iter0[_$rapyd$_Index0];
                            d.walk(visitor);
                        }
                    }
                    if (node.name) {
        ...
        AST_Except = DEFNODE("Except", "argname errors", {
            ...
            "_walk": function(visitor) {
                ...
                return visitor._visit(this, function() {
                    ...
                    if (node.errors) {
                        var _$rapyd$_Iter2 = _$rapyd$_Iterable(node.errors);
                        for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                            e = _$rapyd$_Iter2[_$rapyd$_Index2];
                            e.walk(visitor);
                        }
                    }
                    walk_body(node, visitor);
    ...
    (function(){
        ...
        COMPILER_VERSION = "449203d722ca416d10ef3de7badee2c3e065e427";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            function do_import(key) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter4 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
                        ikey = _$rapyd$_Iter4[_$rapyd$_Index4];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        "is_cached": true,
                ...
                var _$rapyd$_Iter5 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                    bitem = _$rapyd$_Iter5[_$rapyd$_Index5];
            ...
            import_ = function(from_import) {
                ...
                var _$rapyd$_Iter6 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
                    imp = _$rapyd$_Iter6[_$rapyd$_Index6];
                    do_import(imp.key);
                    ...
                    if (from_import) {
                        ...
                        exports = {};
                        var _$rapyd$_Iter7 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
                            symdef = _$rapyd$_Iter7[_$rapyd$_Index7];
                        ...
                        var _$rapyd$_Iter8 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                            argvar = _$rapyd$_Iter8[_$rapyd$_Index8];
                        ...
                        var _$rapyd$_Iter9 = _$rapyd$_Iterable(Object.keys(classes));
                        for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                            cname = _$rapyd$_Iter9[_$rapyd$_Index9];
                            obj = classes[cname];
            ...
            function_ = function(in_class, ctor) {
                ...
                nonlocals.forEach(function(variable) {
                    var i;
                    var _$rapyd$_Iter10 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
    ...
    (function(){
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = [];
                var _$rapyd$_Iter1 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < _$rapyd$_Iter1.length; _$rapyd$_Index1++) {
                ...
                for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                    ...
                    var _$rapyd$_Iter3 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index3 = 0; _$rapyd$_Index3 < _$rapyd$_Iter3.length; _$rapyd$_Index3++) {
                ...
                var _$rapyd$_Iter5 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                    module_ = _$rapyd$_Iter5[_$rapyd$_Index5];
                    if (module_.module_id !== "__main__") {
                    ...
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter7 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
                                        dname = _$rapyd$_Iter7[_$rapyd$_Index7];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter8 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                    symbol = _$rapyd$_Iter8[_$rapyd$_Index8];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter9 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                    sub_module_id = _$rapyd$_Iter9[_$rapyd$_Index9];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter10 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
                                ...
                                var _$rapyd$_Iter11 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                                ...
                                var _$rapyd$_Iter12 = _$rapyd$_Iterable([ true, false ]);
                                for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
                                    beautify = _$rapyd$_Iter12[_$rapyd$_Index12];
                                    var _$rapyd$_Iter13 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index13 = 0; _$rapyd$_Index13 < _$rapyd$_Iter13.length; _$rapyd$_Index13++) {
                                        auto_bind = _$rapyd$_Iter13[_$rapyd$_Index13];
                                        co = OutputStream({
                                            "beautify": beautify,
                                            "auto_bind": auto_bind,
                                            "private_scope": false,
