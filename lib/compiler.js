...
ValueError.prototype.name = "ValueError";
    ...
    (function(){
        ...
        COMPILER_VERSION = "2c4fdaa4751eb382b98e03f3eb1756c02e5abbff";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
                ...
                if (Array.isArray(body)) {
                    ...
                    for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                        ...
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter12 = _$rapyd$_Iterable([ "body", "alternative" ]);
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter18 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter19 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
                ...
                if (allow_calls && is_("punc", "(") && !S.token.nlb) {
                    ...
                    if (expr instanceof AST_SymbolRef && expr.name === "JS") {
                        ...
                        if (c) {
                            ...
                            tmp_ = expr.name;
                            if (tmp_ === "bind" || tmp_ === "rebind_all" || tmp_ === "dir" || tmp_ === "enumerate" || tmp_ === "mixin" || tmp_ === "print" || tmp_ === "range" || tmp_ === "reversed" || tmp_ === "getattr" || tmp_ === "setattr" || tmp_ === "hasattr" || tmp_ === "iter" || tmp_ === "list") {
                    ...
                    toplevel = new AST_Toplevel({
                        ...
                        "strict": function() {
                            ...
                            for (var _$rapyd$_Index29 = 0; _$rapyd$_Index29 < _$rapyd$_Iter29.length; _$rapyd$_Index29++) {
                                stmt = _$rapyd$_Iter29[_$rapyd$_Index29];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter44 = _$rapyd$_Iterable([ true, false ]);
                                for (var _$rapyd$_Index44 = 0; _$rapyd$_Index44 < _$rapyd$_Iter44.length; _$rapyd$_Index44++) {
                                    ...
                                    var _$rapyd$_Iter45 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index45 = 0; _$rapyd$_Index45 < _$rapyd$_Iter45.length; _$rapyd$_Index45++) {
                                        ...
                                        var _$rapyd$_Iter46 = _$rapyd$_Iterable([ 5, 6 ]);
