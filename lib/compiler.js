(function(){
    ...
    (function(){
        ...
        COMPILER_VERSION = "14544d039f03ae31888dc89964dae51a51bf0758";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
                ...
                if (allow_calls && is_("punc", "(") && !S.token.nlb) {
                    ...
                    if (expr instanceof AST_SymbolRef && expr.name === "JS") {
                        ...
                        if (c) {
                            ...
                            tmp_ = expr.name;
                            if (tmp_ === "bind" || tmp_ === "rebind_all" || tmp_ === "dir" || tmp_ === "enumerate" || tmp_ === "mixin" || tmp_ === "print" || tmp_ === "range" || tmp_ === "reversed" || tmp_ === "sum" || tmp_ === "getattr" || tmp_ === "setattr" || tmp_ === "hasattr") {
