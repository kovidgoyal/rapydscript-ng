(function(){
    ...
    (function(){
        ...
        COMPILER_VERSION = "d9cef92f32e4985fc04aef07bc753f8855f47ac1";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
                ...
                if (func_call) {
                    tmp = [];
                    tmp.kwargs = [];
                    var _$rapyd$_Iter15 = _$rapyd$_Iterable(enumerate(a));
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function spaced() {
                ...
                var _$rapyd$_Iter17 = _$rapyd$_Iterable(enumerate(arguments));
                for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
                    _$rapyd$_Unpack = _$rapyd$_Iter17[_$rapyd$_Index17];
                    i = _$rapyd$_Unpack[0];
                    x = _$rapyd$_Unpack[1];
                    if (i > 0) {
                        space();
            ...
            function prologue(module_) {
                ...
                if (!options.omit_baselib) {
                    var _$rapyd$_Iter18 = _$rapyd$_Iterable(module_.baselib);
                    for (var _$rapyd$_Index18 = 0; _$rapyd$_Index18 < _$rapyd$_Iter18.length; _$rapyd$_Index18++) {
                        lib = _$rapyd$_Iter18[_$rapyd$_Index18];
                        dump_baselib(lib);
                    }
                }
            }
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = [];
                var _$rapyd$_Iter19 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index19 = 0; _$rapyd$_Index19 < _$rapyd$_Iter19.length; _$rapyd$_Index19++) {
                    import_id = _$rapyd$_Iter19[_$rapyd$_Index19];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter20 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index20 = 0; _$rapyd$_Index20 < _$rapyd$_Iter20.length; _$rapyd$_Index20++) {
                    module_ = _$rapyd$_Iter20[_$rapyd$_Index20];
                    var _$rapyd$_Iter21 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                        name = _$rapyd$_Iter21[_$rapyd$_Index21];
                ...
                var _$rapyd$_Iter23 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                    module_ = _$rapyd$_Iter23[_$rapyd$_Index23];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter24 = _$rapyd$_Iterable(enumerate(a));
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter25 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                                        dname = _$rapyd$_Iter25[_$rapyd$_Index25];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter26 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < _$rapyd$_Iter26.length; _$rapyd$_Index26++) {
                    symbol = _$rapyd$_Iter26[_$rapyd$_Index26];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter27 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index27 = 0; _$rapyd$_Index27 < _$rapyd$_Iter27.length; _$rapyd$_Index27++) {
                    sub_module_id = _$rapyd$_Iter27[_$rapyd$_Index27];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter28 = _$rapyd$_Iterable(Object.keys(self.classes));
                                ...
                                var _$rapyd$_Iter29 = _$rapyd$_Iterable(self.exports);
                                ...
                                for (var _$rapyd$_Index30 = 0; _$rapyd$_Index30 < _$rapyd$_Iter30.length; _$rapyd$_Index30++) {
                                    beautify = _$rapyd$_Iter30[_$rapyd$_Index30];
                                    var _$rapyd$_Iter31 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index31 = 0; _$rapyd$_Index31 < _$rapyd$_Iter31.length; _$rapyd$_Index31++) {
                                        auto_bind = _$rapyd$_Iter31[_$rapyd$_Index31];
                                        co = OutputStream({
                                            beautify: beautify,
                                            auto_bind: auto_bind,
                                            private_scope: false,
