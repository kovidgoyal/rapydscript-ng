...
function _$rapyd$_int() {
    var ans, base;
    ans = parseInt.apply(null, arguments);
    if (isNaN(ans)) {
        base = (arguments.length > 1) ? arguments[1] : 10;
        throw new ValueError("Invalid literal for int with base " + base + ": " + arguments[0]);
    }
    return ans;
}
...
_$rapyd$_str.format = function() {
    ...
    return template.replace(/([{}])\1|[{](.*?)(?:!([^:]+?)?)?(?::(.+?))?[}]/g, function(match, literal, key, transformer, format_spec) {
...
var str = _$rapyd$_str;
            ...
            for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                ...
                if (parts.length >= 2) {
                    ...
                    if (code_point !== undefined && parts[1]) {
                        ans[parts[1]] = ans[parts[1].toLowerCase()] = code_point;
                    }
                }
            }
            return ans;
        ...
        function tokenizer($TEXT, filename) {
            ...
            function read_escape_sequence() {
                ...
                if (q === "N" && peek() === "{") {
                    ...
                    next();
                    if (!name || !Object.prototype.hasOwnProperty.call(ALIAS_MAP, name)) {
                        return "\\N{" + name + "}";
                    }
                    code = ALIAS_MAP[name];
                    if (code <= 65535) {
    ...
    (function(){
        ...
        COMPILER_VERSION = "eced06899a7ef05d123a5c84b6b35c93d22ed14e";
