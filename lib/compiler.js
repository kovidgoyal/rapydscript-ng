(function(){
    ...
    function _$rapyd$_interpolate_kwargs_constructor(apply, f, fargs) {
            if (apply) {
                f.apply(this,  fargs);
            } else {
                _$rapyd$_interpolate_kwargs.call(this,  f,  fargs);
            }
            return this;
        };
...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "8974969a4dae38ad89559ddb3709db963390f274";
...
;
    ...
    (function(){
        ...
        function print_function_call(self, output) {
            var is_new, has_kwarg_items, has_kwarg_formals, has_kwargs;
