...
var bool = _$rapyd$_bool;
    ...
    (function(){
        ...
        COMPILER_VERSION = "6578bb2f7ff8e5f5352de396b27c44f82436c455";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
                ...
                if (_$rapyd$_bool((_$rapyd$_bool(_$rapyd$_cond_temp = (allow_calls) ? is_("punc", "(") : allow_calls)) ? !(_$rapyd$_bool(S.token.nlb)) : _$rapyd$_cond_temp)) {
                    ...
                    if (_$rapyd$_bool((_$rapyd$_bool(_$rapyd$_cond_temp = expr instanceof AST_SymbolRef)) ? expr.name === "JS" : _$rapyd$_cond_temp)) {
                        ...
                        if (_$rapyd$_bool(c)) {
                            ...
                            tmp_ = expr.name;
                            if (_$rapyd$_bool((_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = tmp_ === "bind")) ? _$rapyd$_cond_temp : tmp_ === "rebind_all")) ? _$rapyd$_cond_temp : tmp_ === "dir")) ? _$rapyd$_cond_temp : tmp_ === "enumerate")) ? _$rapyd$_cond_temp : tmp_ === "mixin")) ? _$rapyd$_cond_temp : tmp_ === "print")) ? _$rapyd$_cond_temp : tmp_ === "range")) ? _$rapyd$_cond_temp : tmp_ === "reversed")) ? _$rapyd$_cond_temp : tmp_ === "getattr")) ? _$rapyd$_cond_temp : tmp_ === "setattr")) ? _$rapyd$_cond_temp : tmp_ === "hasattr")) ? _$rapyd$_cond_temp : tmp_ === "iter")) {
                                ...
                                S.in_parenthesized_expr = false;
                                return ret;
                            } else if (_$rapyd$_bool((_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = tmp_ === "len")) ? _$rapyd$_cond_temp : tmp_ === "abs")) ? _$rapyd$_cond_temp : tmp_ === "max")) ? _$rapyd$_cond_temp : tmp_ === "min")) {
                                baselib_items[tmp_ + "()"] = true;
                            } else if (_$rapyd$_bool((_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = (_$rapyd$_bool(_$rapyd$_cond_temp = tmp_ === "sum")) ? _$rapyd$_cond_temp : tmp_ === "map")) ? _$rapyd$_cond_temp : tmp_ === "zip")) ? _$rapyd$_cond_temp : tmp_ === "filter")) {
