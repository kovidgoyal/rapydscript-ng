...
;
        ...
        AST_Lambda = DEFNODE("Lambda", "name argnames decorators is_generator", {
...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "78a5d142383827a1951ac13962cf2b22066890b5";
...
;
            ...
            function function_(in_class) {
                var name, staticmethod, property_getter, property_setter, _$rapyd$_chain_assign_temp, staticloc, ctor, is_generator, definition, assignments, j, i, nonlocals;
        ...
        function print_class(output) {
            ...
            if (property_names.length) {
                ...
                output.with_parens(function() {
                    ...
                    output.with_block(function() {
                        var prop, name;
                        var _$rapyd$_Iter61 = _$rapyd$_Iterable(property_names);
