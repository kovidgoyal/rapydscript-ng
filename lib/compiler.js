...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "ab4eb688118eaef83ae6004cf0d3f62c0a34e00f";
...
;
    ...
    (function(){
        ...
        no_constructor_parens.__argnames__ = ["self", "output"];
                ...
                output.with_parens((function() {
                    var _$rapyd$_anonfunc = function () {
                        self.args.forEach((function() {
                            var _$rapyd$_anonfunc = function (expr, i) {
                                if (i) {
                                    output.comma();
                                }
                                expr.print(output);
                            ...
                            _$rapyd$_anonfunc.__argnames__ = ["expr", "i"];
                            return _$rapyd$_anonfunc;
                        })());
                        if (has_kwargs) {
                            if (self.args.length) {
