(function(){
    ...
    var desugar_kwargs = (function _$rapyd$_desugar_kwargs() {
        if (Object.assign) {
            return function() {
                var ans;
                ans = {};
    ...
    (function(){
        ...
        function make_predicate(words) {
            ...
            if (typeof Set === "function") {
                ...
                a = {};
                var _$rapyd$_Iter3 = _$rapyd$_Iterable(words);
        ...
        _$rapyd$_modules["utils"]["find_if"] = find_if;
    ...
    (function(){
        ...
        AST_Class = DEFNODE("Class", "init name parent static external bound decorators module_id", {
            ...
            _walk: function(visitor) {
                ...
                return visitor._visit(node, function() {
                    var d;
                    if (node.decorators) {
                        var _$rapyd$_Iter13 = _$rapyd$_Iterable(node.decorators);
                        for (var _$rapyd$_Index13 = 0; _$rapyd$_Index13 < _$rapyd$_Iter13.length; _$rapyd$_Index13++) {
                            d = _$rapyd$_Iter13[_$rapyd$_Index13];
                            d.walk(visitor);
                        }
                    }
                    node.name._walk(visitor);
        ...
        AST_Except = DEFNODE("Except", "argname errors", {
            ...
            _walk: function(visitor) {
                ...
                return visitor._visit(this, function() {
                    ...
                    if (node.errors) {
                        var _$rapyd$_Iter14 = _$rapyd$_Iterable(node.errors);
                        for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                            e = _$rapyd$_Iter14[_$rapyd$_Index14];
                            e.walk(visitor);
                        }
                    }
                    walk_body(node, visitor);
        ...
        _$rapyd$_modules["ast"]["AST_LabeledStatement"] = AST_LabeledStatement;
        ...
        _$rapyd$_modules["ast"]["AST_ObjectSetter"] = AST_ObjectSetter;

        _$rapyd$_modules["ast"]["AST_ObjectGetter"] = AST_ObjectGetter;
        ...
        _$rapyd$_modules["ast"]["AST_Label"] = AST_Label;

        _$rapyd$_modules["ast"]["AST_SymbolRef"] = AST_SymbolRef;

        _$rapyd$_modules["ast"]["AST_LabelRef"] = AST_LabelRef;
    ...
    (function(){
        var __name__ = "parse";
        var COMPILER_VERSION, ALL_KEYWORDS, KEYWORDS, RESERVED_WORDS, KEYWORDS_BEFORE_EXPRESSION, KEYWORDS_ATOM, NATIVE_CLASSES, COMMON_STATIC, OPERATOR_CHARS, RE_HEX_NUMBER, RE_OCT_NUMBER, RE_DEC_NUMBER, OPERATORS, OP_MAP, WHITESPACE_CHARS, PUNC_BEFORE_EXPRESSION, PUNC_CHARS, REGEXP_MODIFIERS, UNICODE, IDENTIFIER_PAT, EX_EOF, UNARY_PREFIX, UNARY_POSTFIX, ASSIGNMENT, PRECEDENCE, STATEMENTS_WITH_LABELS, ATOMIC_START_TOKEN;
        "use strict";
        ...
        var find_if = _$rapyd$_modules["utils"].find_if;
        ...
        var AST_Label = _$rapyd$_modules["ast"].AST_Label;
        var AST_LabelRef = _$rapyd$_modules["ast"].AST_LabelRef;
        var AST_LabeledStatement = _$rapyd$_modules["ast"].AST_LabeledStatement;
        ...
        var AST_ObjectGetter = _$rapyd$_modules["ast"].AST_ObjectGetter;
        var AST_ObjectKeyVal = _$rapyd$_modules["ast"].AST_ObjectKeyVal;
        var AST_ObjectSetter = _$rapyd$_modules["ast"].AST_ObjectSetter;
        ...
        COMPILER_VERSION = "5752c81b1f57038314fd00b61d7af5c2238d50e2";
        ...
        function JS_Parse_Error() {
            JS_Parse_Error.prototype.__init__.apply(this, arguments);
        }
        _$rapyd$_extends(JS_Parse_Error, Error);
        JS_Parse_Error.prototype.__init__ = function __init__(message, line, col, pos, is_eof){
            var self = this;
            Error.prototype.constructor.call(self);
        ...
        JS_Parse_Error.prototype.toString = function toString(){
            var self = this;
        ...
        _$rapyd$_extends(ImportError, JS_Parse_Error);
        ...
        function parse($TEXT, options) {
            ...
            if (options.classes) {
                var _$rapyd$_Iter47 = _$rapyd$_Iterable(options.classes);
                ...
                if (Array.isArray(body)) {
                    for (name in body) {
                        ...
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter48 = _$rapyd$_Iterable([ "body", "alternative" ]);
                            for (var _$rapyd$_Index48 = 0; _$rapyd$_Index48 < _$rapyd$_Iter48.length; _$rapyd$_Index48++) {
                                x = _$rapyd$_Iter48[_$rapyd$_Index48];
                                opt = obj[x];
                                if (opt) {
            ...
            function import_error(message) {
                var ctx;
                ctx = S.input.context();
                throw new ImportError(message, ctx.tokline, ctx.tokcol, ctx.tokpos);
            }
            function do_import(key) {
                var package_module_id, modpath, _$rapyd$_Unpack, data, filename, src_code, location, cached, srchash, ikey, bitem;
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter49 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
                    for (var _$rapyd$_Index49 = 0; _$rapyd$_Index49 < _$rapyd$_Iter49.length; _$rapyd$_Index49++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter49[_$rapyd$_Index49];
                        i = _$rapyd$_Unpack[0];
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter50 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
                for (var _$rapyd$_Index50 = 0; _$rapyd$_Index50 < _$rapyd$_Iter50.length; _$rapyd$_Index50++) {
                    location = _$rapyd$_Iter50[_$rapyd$_Index50];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter51 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index51 = 0; _$rapyd$_Index51 < _$rapyd$_Iter51.length; _$rapyd$_Index51++) {
                        ikey = _$rapyd$_Iter51[_$rapyd$_Index51];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        is_cached: true,
                ...
                var _$rapyd$_Iter52 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index52 = 0; _$rapyd$_Index52 < _$rapyd$_Iter52.length; _$rapyd$_Index52++) {
                    bitem = _$rapyd$_Iter52[_$rapyd$_Index52];
                    baselib_items[bitem] = true;
                }
                imported_module_ids.push(key);
            }
            import_ = function(from_import) {
                var ans, tok, tmp, last_tok, alias, aimp, _$rapyd$_Unpack, classes, argnames, bracketed, exports, symdef, aname, argvar, obj, key, cname, imp;
                ans = new AST_Imports({
                    "imports": []
                });
                while (true) {
                ...
                var _$rapyd$_Iter53 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index53 = 0; _$rapyd$_Index53 < _$rapyd$_Iter53.length; _$rapyd$_Index53++) {
                    imp = _$rapyd$_Iter53[_$rapyd$_Index53];
                    do_import(imp.key);
                    ...
                    if (from_import) {
                        ...
                        exports = {};
                        var _$rapyd$_Iter54 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index54 = 0; _$rapyd$_Index54 < _$rapyd$_Iter54.length; _$rapyd$_Index54++) {
                            symdef = _$rapyd$_Iter54[_$rapyd$_Index54];
                        ...
                        var _$rapyd$_Iter55 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index55 = 0; _$rapyd$_Index55 < _$rapyd$_Iter55.length; _$rapyd$_Index55++) {
                            argvar = _$rapyd$_Iter55[_$rapyd$_Index55];
                        ...
                        var _$rapyd$_Iter56 = _$rapyd$_Iterable(Object.keys(classes));
                        for (var _$rapyd$_Index56 = 0; _$rapyd$_Index56 < _$rapyd$_Iter56.length; _$rapyd$_Index56++) {
                            cname = _$rapyd$_Iter56[_$rapyd$_Index56];
                            obj = classes[cname];
            ...
            function_ = function(in_class, ctor) {
                ...
                nonlocals.forEach(function(variable) {
                    var i;
                    var _$rapyd$_Iter57 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
                    for (var _$rapyd$_Index57 = 0; _$rapyd$_Index57 < _$rapyd$_Iter57.length; _$rapyd$_Index57++) {
                        i = _$rapyd$_Iter57[_$rapyd$_Index57];
            ...
            function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
                ...
                if (func_call) {
                    tmp = [];
                    tmp.kwargs = [];
                    var _$rapyd$_Iter58 = _$rapyd$_Iterable(enumerate(a));
                    for (var _$rapyd$_Index58 = 0; _$rapyd$_Index58 < _$rapyd$_Iter58.length; _$rapyd$_Index58++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter58[_$rapyd$_Index58];
                        i = _$rapyd$_Unpack[0];
        ...
        _$rapyd$_modules["parse"]["ALL_KEYWORDS"] = ALL_KEYWORDS;

        _$rapyd$_modules["parse"]["KEYWORDS"] = KEYWORDS;

        _$rapyd$_modules["parse"]["RESERVED_WORDS"] = RESERVED_WORDS;

        _$rapyd$_modules["parse"]["KEYWORDS_BEFORE_EXPRESSION"] = KEYWORDS_BEFORE_EXPRESSION;

        _$rapyd$_modules["parse"]["KEYWORDS_ATOM"] = KEYWORDS_ATOM;

        _$rapyd$_modules["parse"]["NATIVE_CLASSES"] = NATIVE_CLASSES;

        _$rapyd$_modules["parse"]["COMMON_STATIC"] = COMMON_STATIC;

        _$rapyd$_modules["parse"]["OPERATOR_CHARS"] = OPERATOR_CHARS;

        _$rapyd$_modules["parse"]["RE_HEX_NUMBER"] = RE_HEX_NUMBER;

        _$rapyd$_modules["parse"]["RE_OCT_NUMBER"] = RE_OCT_NUMBER;

        _$rapyd$_modules["parse"]["RE_DEC_NUMBER"] = RE_DEC_NUMBER;

        _$rapyd$_modules["parse"]["OPERATORS"] = OPERATORS;

        _$rapyd$_modules["parse"]["OP_MAP"] = OP_MAP;

        _$rapyd$_modules["parse"]["WHITESPACE_CHARS"] = WHITESPACE_CHARS;

        _$rapyd$_modules["parse"]["PUNC_BEFORE_EXPRESSION"] = PUNC_BEFORE_EXPRESSION;

        _$rapyd$_modules["parse"]["PUNC_CHARS"] = PUNC_CHARS;

        _$rapyd$_modules["parse"]["REGEXP_MODIFIERS"] = REGEXP_MODIFIERS;

        _$rapyd$_modules["parse"]["UNICODE"] = UNICODE;

        _$rapyd$_modules["parse"]["IDENTIFIER_PAT"] = IDENTIFIER_PAT;

        _$rapyd$_modules["parse"]["EX_EOF"] = EX_EOF;

        _$rapyd$_modules["parse"]["UNARY_PREFIX"] = UNARY_PREFIX;

        _$rapyd$_modules["parse"]["UNARY_POSTFIX"] = UNARY_POSTFIX;
        ...
        _$rapyd$_modules["parse"]["is_letter"] = is_letter;

        _$rapyd$_modules["parse"]["is_digit"] = is_digit;

        _$rapyd$_modules["parse"]["is_alphanumeric_char"] = is_alphanumeric_char;

        _$rapyd$_modules["parse"]["is_unicode_combining_mark"] = is_unicode_combining_mark;

        _$rapyd$_modules["parse"]["is_unicode_connector_punctuation"] = is_unicode_connector_punctuation;

        _$rapyd$_modules["parse"]["is_identifier"] = is_identifier;

        _$rapyd$_modules["parse"]["is_identifier_start"] = is_identifier_start;

        _$rapyd$_modules["parse"]["is_identifier_char"] = is_identifier_char;

        _$rapyd$_modules["parse"]["parse_js_number"] = parse_js_number;

        _$rapyd$_modules["parse"]["JS_Parse_Error"] = JS_Parse_Error;

        _$rapyd$_modules["parse"]["ImportError"] = ImportError;

        _$rapyd$_modules["parse"]["js_error"] = js_error;

        _$rapyd$_modules["parse"]["is_token"] = is_token;

        _$rapyd$_modules["parse"]["tokenizer"] = tokenizer;
    ...
    (function(){
        ...
        var is_identifier_char = _$rapyd$_modules["parse"].is_identifier_char;
        var is_identifier = _$rapyd$_modules["parse"].is_identifier;
        ...
        function OutputStream(options) {
            ...
            function spaced() {
                ...
                var _$rapyd$_Iter120 = _$rapyd$_Iterable(enumerate(arguments));
                for (var _$rapyd$_Index120 = 0; _$rapyd$_Index120 < _$rapyd$_Iter120.length; _$rapyd$_Index120++) {
                    _$rapyd$_Unpack = _$rapyd$_Iter120[_$rapyd$_Index120];
                    i = _$rapyd$_Unpack[0];
                    x = _$rapyd$_Unpack[1];
                    if (i > 0) {
                        space();
            ...
            function prologue(module_) {
                ...
                if (!options.omit_baselib) {
                    var _$rapyd$_Iter121 = _$rapyd$_Iterable(module_.baselib);
                    for (var _$rapyd$_Index121 = 0; _$rapyd$_Index121 < _$rapyd$_Iter121.length; _$rapyd$_Index121++) {
                        lib = _$rapyd$_Iter121[_$rapyd$_Index121];
                        dump_baselib(lib);
                    }
                }
            }
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                var imports, import_id, name, module_, nonlocalvars;
                imports = [];
                var _$rapyd$_Iter122 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index122 = 0; _$rapyd$_Index122 < _$rapyd$_Iter122.length; _$rapyd$_Index122++) {
                    import_id = _$rapyd$_Iter122[_$rapyd$_Index122];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter123 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index123 = 0; _$rapyd$_Index123 < _$rapyd$_Iter123.length; _$rapyd$_Index123++) {
                    module_ = _$rapyd$_Iter123[_$rapyd$_Index123];
                    var _$rapyd$_Iter124 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index124 = 0; _$rapyd$_Index124 < _$rapyd$_Iter124.length; _$rapyd$_Index124++) {
                        name = _$rapyd$_Iter124[_$rapyd$_Index124];
                ...
                var _$rapyd$_Iter125 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index125 = 0; _$rapyd$_Index125 < _$rapyd$_Iter125.length; _$rapyd$_Index125++) {
                    module_ = _$rapyd$_Iter125[_$rapyd$_Index125];
                ...
                var _$rapyd$_Iter126 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index126 = 0; _$rapyd$_Index126 < _$rapyd$_Iter126.length; _$rapyd$_Index126++) {
                    module_ = _$rapyd$_Iter126[_$rapyd$_Index126];
                    if (module_.module_id !== "__main__") {
            ...
            function display_complex_body(node, is_toplevel, output) {
                var offset, a, i, _$rapyd$_Unpack, c, arg, kw, dname, nargs;
                offset = 0;
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter127 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index127 = 0; _$rapyd$_Index127 < _$rapyd$_Iter127.length; _$rapyd$_Index127++) {
                                _$rapyd$_Unpack = _$rapyd$_Iter127[_$rapyd$_Index127];
                                c = _$rapyd$_Unpack[0];
                                arg = _$rapyd$_Unpack[1];
                                i = c - offset;
                                if (i >= 0) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter128 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index128 = 0; _$rapyd$_Index128 < _$rapyd$_Iter128.length; _$rapyd$_Index128++) {
                                        dname = _$rapyd$_Iter128[_$rapyd$_Index128];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter129 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index129 = 0; _$rapyd$_Index129 < _$rapyd$_Iter129.length; _$rapyd$_Index129++) {
                    symbol = _$rapyd$_Iter129[_$rapyd$_Index129];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter130 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index130 = 0; _$rapyd$_Index130 < _$rapyd$_Iter130.length; _$rapyd$_Index130++) {
                    sub_module_id = _$rapyd$_Iter130[_$rapyd$_Index130];
            ...
            function print_module(self, output) {
                ...
                output.with_parens(function() {
                    output.print("function()");
                    output.with_block(function() {
                        var okey, cached, cobj, cname, symdef, co, raw, auto_bind, beautify;
                        if (output.option("write_name")) {
                            output.indent();
                            output.print("var ");
                        ...
                        function output_key(beautify, auto_bind) {
                            return "beautify:" + beautify + " auto_bind:" + auto_bind;
                        }
                        okey = output_key(output.option("beautify"), output.option("auto_bind"));
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter131 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index131 = 0; _$rapyd$_Index131 < _$rapyd$_Iter131.length; _$rapyd$_Index131++) {
                                    cname = _$rapyd$_Iter131[_$rapyd$_Index131];
                                ...
                                var _$rapyd$_Iter132 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index132 = 0; _$rapyd$_Index132 < _$rapyd$_Iter132.length; _$rapyd$_Index132++) {
                                    symdef = _$rapyd$_Iter132[_$rapyd$_Index132];
                                    cached.exports.push({
                                        name: symdef.name
                                    });
                                }
                                var _$rapyd$_Iter133 = _$rapyd$_Iterable([ true, false ]);
                                for (var _$rapyd$_Index133 = 0; _$rapyd$_Index133 < _$rapyd$_Iter133.length; _$rapyd$_Index133++) {
                                    beautify = _$rapyd$_Iter133[_$rapyd$_Index133];
                                    var _$rapyd$_Iter134 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index134 = 0; _$rapyd$_Index134 < _$rapyd$_Iter134.length; _$rapyd$_Index134++) {
                                        auto_bind = _$rapyd$_Iter134[_$rapyd$_Index134];
                                        co = OutputStream({
                                            beautify: beautify,
                                            auto_bind: auto_bind,
                                            private_scope: false,
                                        ...
                                        raw = co.toString();
                                        cached.outputs[output_key(beautify, auto_bind)] = raw;
                                    }
                                }
                                try {
            ...
            DEFPRINT(AST_Imports, function(container, output) {
                ...
                var _$rapyd$_Iter135 = _$rapyd$_Iterable(container.imports);
                for (var _$rapyd$_Index135 = 0; _$rapyd$_Index135 < _$rapyd$_Iter135.length; _$rapyd$_Index135++) {
                    self = _$rapyd$_Iter135[_$rapyd$_Index135];
                    output.import(self.module);
                    if (self.argnames) {
                        var _$rapyd$_Iter136 = _$rapyd$_Iterable(self.argnames);
                        for (var _$rapyd$_Index136 = 0; _$rapyd$_Index136 < _$rapyd$_Iter136.length; _$rapyd$_Index136++) {
                            argname = _$rapyd$_Iter136[_$rapyd$_Index136];
        ...
        codegen();
        _$rapyd$_modules["output"]["INDEX_COUNTER"] = INDEX_COUNTER;

        _$rapyd$_modules["output"]["OutputStream"] = OutputStream;

        _$rapyd$_modules["output"]["reset_index_counter"] = reset_index_counter;
    ...
    (function(){
        ...
        var path, fs, ast, ast_node;
        var DefaultsError = _$rapyd$_modules["utils"].DefaultsError;
        var string_template = _$rapyd$_modules["utils"].string_template;
        
        var parse = _$rapyd$_modules["parse"].parse;
        var ALL_KEYWORDS = _$rapyd$_modules["parse"].ALL_KEYWORDS;
        var IDENTIFIER_PAT = _$rapyd$_modules["parse"].IDENTIFIER_PAT;
        var NATIVE_CLASSES = _$rapyd$_modules["parse"].NATIVE_CLASSES;
        var ImportError = _$rapyd$_modules["parse"].ImportError;
        var JS_Parse_Error = _$rapyd$_modules["parse"].JS_Parse_Error;
        var tokenizer = _$rapyd$_modules["parse"].tokenizer;
        
        var OutputStream = _$rapyd$_modules["output"].OutputStream;
        var reset_index_counter = _$rapyd$_modules["output"].reset_index_counter;
        
        path = require("path");
        fs = require("fs");
        function parse_baselib(src_path, beautify) {
            var baselib_path, baselib_ast, output;
            baselib_path = path.join(src_path, "baselib.pyj");
            baselib_ast = parse(fs.readFileSync(baselib_path, "utf-8"));
            output = OutputStream({
                private_scope: false,
                beautify: beautify,
                write_name: false,
        ...
        if (typeof exports === "object") {
            ...
            var _$rapyd$_Iter1 = _$rapyd$_Iterable(ast);
            for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < _$rapyd$_Iter1.length; _$rapyd$_Index1++) {
                ast_node = _$rapyd$_Iter1[_$rapyd$_Index1];
