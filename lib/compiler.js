(function(){
    ...
    (function(){
        ...
        COMPILER_VERSION = "d96de4100a081f09be55423b5f19e86ba4ce85f7";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            object_ = embed_tokens(function() {
                var a, first, start, left, has_non_const_keys;
                expect("{");
                first = true;
        ...
        function codegen() {
            ...
            AST_Lambda.DEFMETHOD("_do_print", function(output, nokeyword) {
                ...
                function internalsub() {
                    ...
                    function_args(self.argnames, output, false);
            ...
            AST_Class.DEFMETHOD("_do_print", function(output) {
                ...
                define_method = function(stmt) {
                    ...
                    function internalsub() {
                        ...
                        output.space();
                        output.print(name);
                        function_args(stmt.argnames, output, self.static.indexOf(name) === -1);
