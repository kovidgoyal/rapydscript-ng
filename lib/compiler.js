(function(){
    ...
    (function(){
        ...
        COMPILER_VERSION = "f3c4a30242945001c8de39a1b1ea9b8a2eb3c5ad";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            statement = embed_tokens(function() {
                var dir, stat, tmp_, start, func, chain, is_yield_from, tmp;
            ...
            function_ = function(in_class, ctor) {
                var is_accessor, name, staticloc, staticmethod, is_generator, definition, assignments, j, i, nonlocals;
                ...
                if (allow_calls && is_("punc", "(") && !S.token.nlb) {
                    ...
                    if (expr instanceof AST_SymbolRef && expr.name === "JS") {
                        ...
                        if (c) {
                            ...
                            tmp_ = expr.name;
                            if (tmp_ === "bind" || tmp_ === "rebind_all" || tmp_ === "dir" || tmp_ === "enumerate" || tmp_ === "mixin" || tmp_ === "print" || tmp_ === "range" || tmp_ === "reversed" || tmp_ === "sum" || tmp_ === "getattr" || tmp_ === "setattr" || tmp_ === "hasattr" || tmp_ === "iter") {
