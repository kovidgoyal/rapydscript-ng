...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "92826593db0a6b5234d812ed23efd5e0e53bdd28";
        ...
        function parse($TEXT, options) {
                ...
                if (Array.isArray(body)) {
                    ...
                    for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                        ...
                        if (stmt instanceof AST_ForIn) {
                            ...
                            var _$rapyd$_Iter22 = _$rapyd$_Iterable(stmt.clauses);
                            for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
                                clause = _$rapyd$_Iter22[_$rapyd$_Index22];
                                if (clause.alias) {
                    ...
                    if (body.is_chained()) {
                        var _$rapyd$_Iter23 = _$rapyd$_Iterable(body.traverse_chain()[0]);
            ...
            function scan_for_nonlocal_defs(body) {
                ...
                vars = [];
                if (Array.isArray(body)) {
                    var _$rapyd$_Iter24 = _$rapyd$_Iterable(body);
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter25 = _$rapyd$_Iterable(enumerate(_$rapyd$_list_decorate([ base_path + ".pyj", base_path + "/__init__.pyj" ])));
                    for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                        _$rapyd$_unpack = _$rapyd$_Iter25[_$rapyd$_Index25];
                        i = _$rapyd$_unpack[0];
...
;
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter26 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ options.basedir, options.libdir ]));
                for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < _$rapyd$_Iter26.length; _$rapyd$_Index26++) {
                    location = _$rapyd$_Iter26[_$rapyd$_Index26];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter27 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index27 = 0; _$rapyd$_Index27 < _$rapyd$_Iter27.length; _$rapyd$_Index27++) {
                        ikey = _$rapyd$_Iter27[_$rapyd$_Index27];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        "is_cached": true,
                ...
                var _$rapyd$_Iter28 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index28 = 0; _$rapyd$_Index28 < _$rapyd$_Iter28.length; _$rapyd$_Index28++) {
                    bitem = _$rapyd$_Iter28[_$rapyd$_Index28];
...
;
                ...
                var _$rapyd$_Iter29 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index29 = 0; _$rapyd$_Index29 < _$rapyd$_Iter29.length; _$rapyd$_Index29++) {
                    imp = _$rapyd$_Iter29[_$rapyd$_Index29];
                    do_import(imp.key);
...
;
                        ...
                        exports = {};
                        var _$rapyd$_Iter30 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index30 = 0; _$rapyd$_Index30 < _$rapyd$_Iter30.length; _$rapyd$_Index30++) {
                            symdef = _$rapyd$_Iter30[_$rapyd$_Index30];
                        ...
                        var _$rapyd$_Iter31 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index31 = 0; _$rapyd$_Index31 < _$rapyd$_Iter31.length; _$rapyd$_Index31++) {
                            argvar = _$rapyd$_Iter31[_$rapyd$_Index31];
                        ...
                        var _$rapyd$_Iter32 = _$rapyd$_Iterable(Object.keys(classes));
                        for (var _$rapyd$_Index32 = 0; _$rapyd$_Index32 < _$rapyd$_Iter32.length; _$rapyd$_Index32++) {
                            cname = _$rapyd$_Iter32[_$rapyd$_Index32];
                            obj = classes[cname];
    ...
    (function(){
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = _$rapyd$_list_decorate([]);
                var _$rapyd$_Iter39 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index39 = 0; _$rapyd$_Index39 < _$rapyd$_Iter39.length; _$rapyd$_Index39++) {
                    import_id = _$rapyd$_Iter39[_$rapyd$_Index39];
                ...
                for (var _$rapyd$_Index40 = 0; _$rapyd$_Index40 < _$rapyd$_Iter40.length; _$rapyd$_Index40++) {
                    ...
                    var _$rapyd$_Iter41 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index41 = 0; _$rapyd$_Index41 < _$rapyd$_Iter41.length; _$rapyd$_Index41++) {
                        name = _$rapyd$_Iter41[_$rapyd$_Index41];
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter44 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index44 = 0; _$rapyd$_Index44 < _$rapyd$_Iter44.length; _$rapyd$_Index44++) {
                                _$rapyd$_unpack = _$rapyd$_Iter44[_$rapyd$_Index44];
                                c = _$rapyd$_unpack[0];
                                arg = _$rapyd$_unpack[1];
                                i = c - offset;
                                if (i >= 0) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter45 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index45 = 0; _$rapyd$_Index45 < _$rapyd$_Iter45.length; _$rapyd$_Index45++) {
                                        dname = _$rapyd$_Iter45[_$rapyd$_Index45];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter46 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index46 = 0; _$rapyd$_Index46 < _$rapyd$_Iter46.length; _$rapyd$_Index46++) {
                    symbol = _$rapyd$_Iter46[_$rapyd$_Index46];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter47 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index47 = 0; _$rapyd$_Index47 < _$rapyd$_Iter47.length; _$rapyd$_Index47++) {
                    sub_module_id = _$rapyd$_Iter47[_$rapyd$_Index47];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter48 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index48 = 0; _$rapyd$_Index48 < _$rapyd$_Iter48.length; _$rapyd$_Index48++) {
                                    cname = _$rapyd$_Iter48[_$rapyd$_Index48];
                                ...
                                var _$rapyd$_Iter49 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index49 = 0; _$rapyd$_Index49 < _$rapyd$_Iter49.length; _$rapyd$_Index49++) {
                                    symdef = _$rapyd$_Iter49[_$rapyd$_Index49];
                                    cached.exports.push({
                                        "name": symdef.name
                                    });
                                }
                                ...
                                for (var _$rapyd$_Index50 = 0; _$rapyd$_Index50 < _$rapyd$_Iter50.length; _$rapyd$_Index50++) {
                                    beautify = _$rapyd$_Iter50[_$rapyd$_Index50];
                                    ...
                                    for (var _$rapyd$_Index51 = 0; _$rapyd$_Index51 < _$rapyd$_Iter51.length; _$rapyd$_Index51++) {
                                        auto_bind = _$rapyd$_Iter51[_$rapyd$_Index51];
                                        var _$rapyd$_Iter52 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ 5, 6 ]));
                                        for (var _$rapyd$_Index52 = 0; _$rapyd$_Index52 < _$rapyd$_Iter52.length; _$rapyd$_Index52++) {
                                            js_version = _$rapyd$_Iter52[_$rapyd$_Index52];
                                            co = OutputStream({
                                                "beautify": beautify,
                                                "auto_bind": auto_bind,
            ...
            DEFPRINT(AST_With, function(self, output) {
                ...
                var _$rapyd$_Iter55 = _$rapyd$_Iterable(self.clauses);
                        ...
                        if (len(properties)) {
                            ...
                            output.with_parens(function() {
                                [output.print("this"), output.comma(), output.space(), output.with_block(function() {
                                    var prop, name;
                                    var _$rapyd$_Iter59 = _$rapyd$_Iterable(properties);
            ...
            DEFPRINT(AST_Assign, function(self, output) {
                ...
                if (self.operator === "=" && self.is_chained()) {
                    ...
                    [output.end_statement(), output.indent()];
                    var _$rapyd$_Iter60 = _$rapyd$_Iterable(left_hand_sides);
                    for (var _$rapyd$_Index60 = 0; _$rapyd$_Index60 < _$rapyd$_Iter60.length; _$rapyd$_Index60++) {
                        lhs = _$rapyd$_Iter60[_$rapyd$_Index60];
                        print_assignment(new AST_Assign({
                            "left": lhs,
                            "right": temp_rhs,
