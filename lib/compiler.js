...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "5c277d2922491c1490d6c0c378b1543d552dfd13";
        ...
        function parse($TEXT, options) {
            var import_dirs, location, module_id, baselib_items, imported_module_ids, IMPORTED, IMPORTING, S, obj, cname, statement, import_, class_, function_, nonlocal_, const_, new_, expr_atom, array_, object_, subscripts, maybe_unary, expr_op, maybe_conditional, maybe_assign, expression;
            ...
            var _$rapyd$_Iter16 = _$rapyd$_Iterable([options.libdir, options.basedir]);
            ...
            if (options.classes) {
                var _$rapyd$_Iter17 = _$rapyd$_Iterable(options.classes);
                for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
                    cname = _$rapyd$_Iter17[_$rapyd$_Index17];
                ...
                if (Array.isArray(body)) {
                    ...
                    for (var _$rapyd$_Index18 = 0; _$rapyd$_Index18 < _$rapyd$_Iter18.length; _$rapyd$_Index18++) {
                        ...
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter19 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ "body", "alternative" ]));
            ...
            function scan_for_local_vars(body) {
                ...
                function scan_in_array(arr) {
                    var x;
                    var _$rapyd$_Iter22 = _$rapyd$_Iterable(arr);
                ...
                if (Array.isArray(body)) {
                    ...
                    for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                        ...
                        if (stmt instanceof AST_ForIn) {
                            ...
                            var _$rapyd$_Iter24 = _$rapyd$_Iterable(stmt.clauses);
                            for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
                                clause = _$rapyd$_Iter24[_$rapyd$_Index24];
                                if (clause.alias) {
                    ...
                    if (body.is_chained()) {
                        var _$rapyd$_Iter25 = _$rapyd$_Iterable(body.traverse_chain()[0]);
                        for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                            lhs = _$rapyd$_Iter25[_$rapyd$_Index25];
                            add_assign_lhs(lhs);
                        }
            ...
            function scan_for_nonlocal_defs(body) {
                ...
                vars = [];
                if (Array.isArray(body)) {
                    var _$rapyd$_Iter26 = _$rapyd$_Iterable(body);
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter27 = _$rapyd$_Iterable(enumerate(_$rapyd$_list_decorate([ base_path + ".pyj", base_path + "/__init__.pyj" ])));
                    for (var _$rapyd$_Index27 = 0; _$rapyd$_Index27 < _$rapyd$_Iter27.length; _$rapyd$_Index27++) {
                        _$rapyd$_unpack = _$rapyd$_Iter27[_$rapyd$_Index27];
                        i = _$rapyd$_unpack[0];
...
;
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter28 = _$rapyd$_Iterable(import_dirs);
                for (var _$rapyd$_Index28 = 0; _$rapyd$_Index28 < _$rapyd$_Iter28.length; _$rapyd$_Index28++) {
                    location = _$rapyd$_Iter28[_$rapyd$_Index28];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter29 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index29 = 0; _$rapyd$_Index29 < _$rapyd$_Iter29.length; _$rapyd$_Index29++) {
                        ikey = _$rapyd$_Iter29[_$rapyd$_Index29];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        "is_cached": true,
                ...
                var _$rapyd$_Iter30 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index30 = 0; _$rapyd$_Index30 < _$rapyd$_Iter30.length; _$rapyd$_Index30++) {
                    bitem = _$rapyd$_Iter30[_$rapyd$_Index30];
...
;
                ...
                var _$rapyd$_Iter31 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index31 = 0; _$rapyd$_Index31 < _$rapyd$_Iter31.length; _$rapyd$_Index31++) {
                    imp = _$rapyd$_Iter31[_$rapyd$_Index31];
                    do_import(imp.key);
...
;
                        ...
                        exports = {};
                        var _$rapyd$_Iter32 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index32 = 0; _$rapyd$_Index32 < _$rapyd$_Iter32.length; _$rapyd$_Index32++) {
                            symdef = _$rapyd$_Iter32[_$rapyd$_Index32];
                        ...
                        var _$rapyd$_Iter33 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index33 = 0; _$rapyd$_Index33 < _$rapyd$_Iter33.length; _$rapyd$_Index33++) {
                            argvar = _$rapyd$_Iter33[_$rapyd$_Index33];
                        ...
                        var _$rapyd$_Iter34 = _$rapyd$_Iterable(Object.keys(classes));
                        for (var _$rapyd$_Index34 = 0; _$rapyd$_Index34 < _$rapyd$_Iter34.length; _$rapyd$_Index34++) {
                            cname = _$rapyd$_Iter34[_$rapyd$_Index34];
                            obj = classes[cname];
            ...
            class_ = function() {
                ...
                visitor = new walker();
                var _$rapyd$_Iter36 = _$rapyd$_Iterable(definition.body);
...
;
            ...
            function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
                ...
                if (func_call) {
                    ...
                    var _$rapyd$_Iter37 = _$rapyd$_Iterable(a);
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function prologue(module_) {
                ...
                var _$rapyd$_Iter39 = _$rapyd$_Iterable(baselib_items);
                for (var _$rapyd$_Index39 = 0; _$rapyd$_Index39 < _$rapyd$_Iter39.length; _$rapyd$_Index39++) {
                    lib = _$rapyd$_Iter39[_$rapyd$_Index39];
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = _$rapyd$_list_decorate([]);
                var _$rapyd$_Iter41 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index41 = 0; _$rapyd$_Index41 < _$rapyd$_Iter41.length; _$rapyd$_Index41++) {
                    import_id = _$rapyd$_Iter41[_$rapyd$_Index41];
                ...
                for (var _$rapyd$_Index42 = 0; _$rapyd$_Index42 < _$rapyd$_Iter42.length; _$rapyd$_Index42++) {
                    ...
                    var _$rapyd$_Iter43 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index43 = 0; _$rapyd$_Index43 < _$rapyd$_Iter43.length; _$rapyd$_Index43++) {
                        name = _$rapyd$_Iter43[_$rapyd$_Index43];
                ...
                var _$rapyd$_Iter45 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index45 = 0; _$rapyd$_Index45 < _$rapyd$_Iter45.length; _$rapyd$_Index45++) {
                    module_ = _$rapyd$_Iter45[_$rapyd$_Index45];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter46 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index46 = 0; _$rapyd$_Index46 < _$rapyd$_Iter46.length; _$rapyd$_Index46++) {
                                _$rapyd$_unpack = _$rapyd$_Iter46[_$rapyd$_Index46];
                                c = _$rapyd$_unpack[0];
                                arg = _$rapyd$_unpack[1];
                                i = c - offset;
                                if (i >= 0) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter47 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index47 = 0; _$rapyd$_Index47 < _$rapyd$_Iter47.length; _$rapyd$_Index47++) {
                                        dname = _$rapyd$_Iter47[_$rapyd$_Index47];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter48 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index48 = 0; _$rapyd$_Index48 < _$rapyd$_Iter48.length; _$rapyd$_Index48++) {
                    symbol = _$rapyd$_Iter48[_$rapyd$_Index48];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter49 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index49 = 0; _$rapyd$_Index49 < _$rapyd$_Iter49.length; _$rapyd$_Index49++) {
                    sub_module_id = _$rapyd$_Iter49[_$rapyd$_Index49];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter50 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index50 = 0; _$rapyd$_Index50 < _$rapyd$_Iter50.length; _$rapyd$_Index50++) {
                                    cname = _$rapyd$_Iter50[_$rapyd$_Index50];
                                ...
                                var _$rapyd$_Iter51 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index51 = 0; _$rapyd$_Index51 < _$rapyd$_Iter51.length; _$rapyd$_Index51++) {
                                    symdef = _$rapyd$_Iter51[_$rapyd$_Index51];
                                    cached.exports.push({
                                        "name": symdef.name
                                    });
                                }
                                ...
                                for (var _$rapyd$_Index52 = 0; _$rapyd$_Index52 < _$rapyd$_Iter52.length; _$rapyd$_Index52++) {
                                    beautify = _$rapyd$_Iter52[_$rapyd$_Index52];
                                    var _$rapyd$_Iter53 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ true, false ]));
                                    for (var _$rapyd$_Index53 = 0; _$rapyd$_Index53 < _$rapyd$_Iter53.length; _$rapyd$_Index53++) {
                                        auto_bind = _$rapyd$_Iter53[_$rapyd$_Index53];
                                        var _$rapyd$_Iter54 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ 5, 6 ]));
                                        for (var _$rapyd$_Index54 = 0; _$rapyd$_Index54 < _$rapyd$_Iter54.length; _$rapyd$_Index54++) {
                                            js_version = _$rapyd$_Iter54[_$rapyd$_Index54];
                                            co = OutputStream({
                                                "beautify": beautify,
                                                "auto_bind": auto_bind,
            ...
            DEFPRINT(AST_With, function(self, output) {
                ...
                var _$rapyd$_Iter57 = _$rapyd$_Iterable(self.clauses);
                        ...
                        if (len(properties)) {
                            ...
                            output.with_parens(function() {
                                [output.print("this"), output.comma(), output.space(), output.with_block(function() {
                                    var prop, name;
                                    var _$rapyd$_Iter61 = _$rapyd$_Iterable(properties);
                                    for (var _$rapyd$_Index61 = 0; _$rapyd$_Index61 < _$rapyd$_Iter61.length; _$rapyd$_Index61++) {
                                        name = _$rapyd$_Iter61[_$rapyd$_Index61];
                                        ...
                                        output.with_block(function() {
                                            ...
                                            [output.indent(), output.print("\"configurable\":"), output.space(), output.print("true"), 
                                            output.comma(), output.newline()];
                                            if (prop.getter) {
            ...
            DEFPRINT(AST_Assign, function(self, output) {
                ...
                if (self.operator === "=" && self.is_chained()) {
                    ...
                    [output.end_statement(), output.indent()];
                    var _$rapyd$_Iter62 = _$rapyd$_Iterable(left_hand_sides);
                    for (var _$rapyd$_Index62 = 0; _$rapyd$_Index62 < _$rapyd$_Iter62.length; _$rapyd$_Index62++) {
                        lhs = _$rapyd$_Iter62[_$rapyd$_Index62];
                        print_assignment(new AST_Assign({
                            "left": lhs,
                            "right": temp_rhs,
