...
_$rapyd$_str.format = function() {
    ...
    function resolve_format_spec(format_spec) {
        return format_spec.replace(_$rapyd$_str._template_resolve_fs_pat, function(match, key) {
...
_$rapyd$_str.endswith = function(string, suffixes, start, end) {
    ...
    if (typeof suffixes === "string") {
        suffixes = _$rapyd$_list_decorate([ suffixes ]);
    }
    if (end !== undefined) {
...
var str = _$rapyd$_str;
    ...
    (function(){
        ...
        function tokenizer($TEXT, filename) {
            ...
            read_string = with_eof_error("Unterminated string constant", function(is_raw_literal) {
                var quote, ret, is_multiline, ch;
                quote = next();
                ret = "";
                is_multiline = false;
                if (peek() === quote) {
    ...
    (function(){
        ...
        COMPILER_VERSION = "0b6dc838660fc3c88ea596e075c9b9d4a2eb7ac4";
        ...
        function parse($TEXT, options) {
            ...
            if (options.classes) {
                var _$rapyd$_Iter11 = _$rapyd$_Iterable(options.classes);
                for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                    cname = _$rapyd$_Iter11[_$rapyd$_Index11];
            ...
            function scan_for_top_level_callables(body) {
                ...
                if (Array.isArray(body)) {
                    ...
                    for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
                        obj = _$rapyd$_Iter12[_$rapyd$_Index12];
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter13 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ "body", "alternative" ]));
                            for (var _$rapyd$_Index13 = 0; _$rapyd$_Index13 < _$rapyd$_Iter13.length; _$rapyd$_Index13++) {
                                x = _$rapyd$_Iter13[_$rapyd$_Index13];
                                opt = obj[x];
                                if (opt) {
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter19 = _$rapyd$_Iterable(enumerate(_$rapyd$_list_decorate([ base_path + ".pyj", base_path + "/__init__.pyj" ])));
                    for (var _$rapyd$_Index19 = 0; _$rapyd$_Index19 < _$rapyd$_Iter19.length; _$rapyd$_Index19++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter19[_$rapyd$_Index19];
                        i = _$rapyd$_Unpack[0];
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter20 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ options.basedir, options.libdir ]));
                for (var _$rapyd$_Index20 = 0; _$rapyd$_Index20 < _$rapyd$_Iter20.length; _$rapyd$_Index20++) {
                    location = _$rapyd$_Iter20[_$rapyd$_Index20];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter21 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                        ikey = _$rapyd$_Iter21[_$rapyd$_Index21];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        "is_cached": true,
                ...
                var _$rapyd$_Iter22 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
                    bitem = _$rapyd$_Iter22[_$rapyd$_Index22];
            ...
            import_ = function(from_import) {
                ...
                var _$rapyd$_Iter23 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                    imp = _$rapyd$_Iter23[_$rapyd$_Index23];
                    do_import(imp.key);
                    ...
                    if (from_import) {
                        ...
                        exports = {};
                        var _$rapyd$_Iter24 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
                            symdef = _$rapyd$_Iter24[_$rapyd$_Index24];
                        ...
                        var _$rapyd$_Iter25 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                            argvar = _$rapyd$_Iter25[_$rapyd$_Index25];
                        ...
                        var _$rapyd$_Iter26 = _$rapyd$_Iterable(Object.keys(classes));
                        for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < _$rapyd$_Iter26.length; _$rapyd$_Index26++) {
                            cname = _$rapyd$_Iter26[_$rapyd$_Index26];
                            obj = classes[cname];
            ...
            class_ = function() {
                ...
                visitor = new walker();
                var _$rapyd$_Iter28 = _$rapyd$_Iterable(definition.body);
                for (var _$rapyd$_Index28 = 0; _$rapyd$_Index28 < _$rapyd$_Iter28.length; _$rapyd$_Index28++) {
                    stmt = _$rapyd$_Iter28[_$rapyd$_Index28];
            ...
            subscripts = function(expr, allow_calls) {
                var start, is_py_sub, slice_bounds, is_slice, assignment, str_, ret, c, funcname, tmp_, args;
                start = expr.start;
                if (is_("punc", ".")) {
                    next();
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function prologue(module_) {
                ...
                var _$rapyd$_Iter31 = _$rapyd$_Iterable(baselib_items);
                for (var _$rapyd$_Index31 = 0; _$rapyd$_Index31 < _$rapyd$_Iter31.length; _$rapyd$_Index31++) {
                    lib = _$rapyd$_Iter31[_$rapyd$_Index31];
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = _$rapyd$_list_decorate([]);
                var _$rapyd$_Iter33 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index33 = 0; _$rapyd$_Index33 < _$rapyd$_Iter33.length; _$rapyd$_Index33++) {
                    import_id = _$rapyd$_Iter33[_$rapyd$_Index33];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter34 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index34 = 0; _$rapyd$_Index34 < _$rapyd$_Iter34.length; _$rapyd$_Index34++) {
                    module_ = _$rapyd$_Iter34[_$rapyd$_Index34];
                    var _$rapyd$_Iter35 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index35 = 0; _$rapyd$_Index35 < _$rapyd$_Iter35.length; _$rapyd$_Index35++) {
                        name = _$rapyd$_Iter35[_$rapyd$_Index35];
                ...
                var _$rapyd$_Iter37 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index37 = 0; _$rapyd$_Index37 < _$rapyd$_Iter37.length; _$rapyd$_Index37++) {
                    module_ = _$rapyd$_Iter37[_$rapyd$_Index37];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter38 = _$rapyd$_Iterable(enumerate(a));
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter39 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index39 = 0; _$rapyd$_Index39 < _$rapyd$_Iter39.length; _$rapyd$_Index39++) {
                                        dname = _$rapyd$_Iter39[_$rapyd$_Index39];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter40 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index40 = 0; _$rapyd$_Index40 < _$rapyd$_Iter40.length; _$rapyd$_Index40++) {
                    symbol = _$rapyd$_Iter40[_$rapyd$_Index40];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter41 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index41 = 0; _$rapyd$_Index41 < _$rapyd$_Iter41.length; _$rapyd$_Index41++) {
                    sub_module_id = _$rapyd$_Iter41[_$rapyd$_Index41];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter42 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index42 = 0; _$rapyd$_Index42 < _$rapyd$_Iter42.length; _$rapyd$_Index42++) {
                                    cname = _$rapyd$_Iter42[_$rapyd$_Index42];
                                ...
                                var _$rapyd$_Iter43 = _$rapyd$_Iterable(self.exports);
                                ...
                                for (var _$rapyd$_Index44 = 0; _$rapyd$_Index44 < _$rapyd$_Iter44.length; _$rapyd$_Index44++) {
                                    beautify = _$rapyd$_Iter44[_$rapyd$_Index44];
                                    var _$rapyd$_Iter45 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ true, false ]));
                                    for (var _$rapyd$_Index45 = 0; _$rapyd$_Index45 < _$rapyd$_Iter45.length; _$rapyd$_Index45++) {
                                        auto_bind = _$rapyd$_Iter45[_$rapyd$_Index45];
                                        var _$rapyd$_Iter46 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ 5, 6 ]));
                                        for (var _$rapyd$_Index46 = 0; _$rapyd$_Index46 < _$rapyd$_Iter46.length; _$rapyd$_Index46++) {
                                            js_version = _$rapyd$_Iter46[_$rapyd$_Index46];
                                            co = OutputStream({
                                                "beautify": beautify,
                                                "auto_bind": auto_bind,
