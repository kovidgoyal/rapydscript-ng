(function(){
    ...
    function _$rapyd$_Iterable(iterable) {
            ...
            if (typeof Symbol === "function" && typeof iterable[Symbol.iterator] === "function") {
                iterator = iterable[Symbol.iterator]();
                ans = [];
                result = iterator.next();
                if (iterable[Symbol.iterator] === iterable.entries) {
                    while (!result.done) {
    ...
    (function(){
        ...
        COMPILER_VERSION = "fe1a26fd9a0845a207db7345c06c8abfa4165f8a";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            if (options.classes) {
                var _$rapyd$_Iter4 = _$rapyd$_Iterable(options.classes);
                for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
                    cname = _$rapyd$_Iter4[_$rapyd$_Index4];
                ...
                if (Array.isArray(body)) {
                    for (name in body) {
                        ...
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter5 = _$rapyd$_Iterable([ "body", "alternative" ]);
                            for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                                x = _$rapyd$_Iter5[_$rapyd$_Index5];
                                opt = obj[x];
                                if (opt) {
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter6 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter7 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
                for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
                    location = _$rapyd$_Iter7[_$rapyd$_Index7];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter8 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                        ikey = _$rapyd$_Iter8[_$rapyd$_Index8];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        is_cached: true,
                ...
                var _$rapyd$_Iter9 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                    bitem = _$rapyd$_Iter9[_$rapyd$_Index9];
            ...
            import_ = function(from_import) {
                ...
                var _$rapyd$_Iter10 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
                    imp = _$rapyd$_Iter10[_$rapyd$_Index10];
                    do_import(imp.key);
                    ...
                    if (from_import) {
                        ...
                        exports = {};
                        var _$rapyd$_Iter11 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                            symdef = _$rapyd$_Iter11[_$rapyd$_Index11];
                        ...
                        var _$rapyd$_Iter12 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
                            argvar = _$rapyd$_Iter12[_$rapyd$_Index12];
                        ...
                        var _$rapyd$_Iter13 = _$rapyd$_Iterable(Object.keys(classes));
                        for (var _$rapyd$_Index13 = 0; _$rapyd$_Index13 < _$rapyd$_Iter13.length; _$rapyd$_Index13++) {
                            cname = _$rapyd$_Iter13[_$rapyd$_Index13];
                            obj = classes[cname];
            ...
            function_ = function(in_class, ctor) {
                ...
                nonlocals.forEach(function(variable) {
                    var i;
                    var _$rapyd$_Iter14 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
            ...
            function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
                var first, saw_starargs, tmp, arg, a;
                first = true;
                a = [];
                saw_starargs = false;
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function prologue(module_) {
                ...
                if (!options.omit_baselib) {
                    var _$rapyd$_Iter17 = _$rapyd$_Iterable(module_.baselib);
                    for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
                        lib = _$rapyd$_Iter17[_$rapyd$_Index17];
                        dump_baselib(lib);
                    }
                }
            }
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = [];
                var _$rapyd$_Iter18 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index18 = 0; _$rapyd$_Index18 < _$rapyd$_Iter18.length; _$rapyd$_Index18++) {
                    import_id = _$rapyd$_Iter18[_$rapyd$_Index18];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter19 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index19 = 0; _$rapyd$_Index19 < _$rapyd$_Iter19.length; _$rapyd$_Index19++) {
                    module_ = _$rapyd$_Iter19[_$rapyd$_Index19];
                    var _$rapyd$_Iter20 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index20 = 0; _$rapyd$_Index20 < _$rapyd$_Iter20.length; _$rapyd$_Index20++) {
                        name = _$rapyd$_Iter20[_$rapyd$_Index20];
                ...
                var _$rapyd$_Iter21 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                    module_ = _$rapyd$_Iter21[_$rapyd$_Index21];
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter23 = _$rapyd$_Iterable(enumerate(a));
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter24 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
                                        dname = _$rapyd$_Iter24[_$rapyd$_Index24];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter25 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                    symbol = _$rapyd$_Iter25[_$rapyd$_Index25];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter26 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < _$rapyd$_Iter26.length; _$rapyd$_Index26++) {
                    sub_module_id = _$rapyd$_Iter26[_$rapyd$_Index26];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter27 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index27 = 0; _$rapyd$_Index27 < _$rapyd$_Iter27.length; _$rapyd$_Index27++) {
                                    cname = _$rapyd$_Iter27[_$rapyd$_Index27];
                                ...
                                var _$rapyd$_Iter28 = _$rapyd$_Iterable(self.exports);
                                ...
                                var _$rapyd$_Iter29 = _$rapyd$_Iterable([ true, false ]);
                                for (var _$rapyd$_Index29 = 0; _$rapyd$_Index29 < _$rapyd$_Iter29.length; _$rapyd$_Index29++) {
                                    beautify = _$rapyd$_Iter29[_$rapyd$_Index29];
                                    var _$rapyd$_Iter30 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index30 = 0; _$rapyd$_Index30 < _$rapyd$_Iter30.length; _$rapyd$_Index30++) {
                                        auto_bind = _$rapyd$_Iter30[_$rapyd$_Index30];
                                        co = OutputStream({
                                            beautify: beautify,
                                            auto_bind: auto_bind,
                                            private_scope: false,
                ...
                output.with_block(function() {
                    if (!(is_simple_for(self) || is_simple_for_in(self))) {
                        ...
                        if (self.init instanceof AST_Array) {
                            ...
                            output.print("_$rapyd$_Iter" + output.index_counter + "[_$rapyd$_Index" + output.index_counter + "];");
                            output.newline();
