(function(){
    ...
    (function(){
        ...
        COMPILER_VERSION = "fe2865233e7ab41a92bb2df70169761bfd559773";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            function scan_for_local_vars(body) {
                ...
                function extend(arr) {
                    var x;
                    var _$rapyd$_Iter2 = _$rapyd$_Iterable(arr);
                    for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                ...
                function scan_in_array(arr) {
                    ...
                    var _$rapyd$_Iter3 = _$rapyd$_Iterable(arr);
                    for (var _$rapyd$_Index3 = 0; _$rapyd$_Index3 < _$rapyd$_Iter3.length; _$rapyd$_Index3++) {
                        x = _$rapyd$_Iter3[_$rapyd$_Index3];
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter4 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter5 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
                for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                    location = _$rapyd$_Iter5[_$rapyd$_Index5];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter6 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
                        ikey = _$rapyd$_Iter6[_$rapyd$_Index6];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        "is_cached": true,
                ...
                var _$rapyd$_Iter7 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
                    bitem = _$rapyd$_Iter7[_$rapyd$_Index7];
            ...
            import_ = function(from_import) {
                ...
                var _$rapyd$_Iter8 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                    imp = _$rapyd$_Iter8[_$rapyd$_Index8];
                    do_import(imp.key);
                    ...
                    if (from_import) {
                        ...
                        exports = {};
                        var _$rapyd$_Iter9 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                            symdef = _$rapyd$_Iter9[_$rapyd$_Index9];
                        ...
                        var _$rapyd$_Iter10 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
                            argvar = _$rapyd$_Iter10[_$rapyd$_Index10];
                        ...
                        var _$rapyd$_Iter11 = _$rapyd$_Iterable(Object.keys(classes));
            ...
            function_ = function(in_class, ctor) {
                ...
                nonlocals.forEach(function(variable) {
                    var i;
                    var _$rapyd$_Iter12 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
                    ...
                    toplevel = new AST_Toplevel({
                        ...
                        "strict": function() {
                            ...
                            for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                                stmt = _$rapyd$_Iter14[_$rapyd$_Index14];
    ...
    (function(){
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = [];
                var _$rapyd$_Iter2 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                    import_id = _$rapyd$_Iter2[_$rapyd$_Index2];
                ...
                for (var _$rapyd$_Index3 = 0; _$rapyd$_Index3 < _$rapyd$_Iter3.length; _$rapyd$_Index3++) {
                    ...
                    var _$rapyd$_Iter4 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
                        name = _$rapyd$_Iter4[_$rapyd$_Index4];
                    ...
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter8 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                                        dname = _$rapyd$_Iter8[_$rapyd$_Index8];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter9 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                    symbol = _$rapyd$_Iter9[_$rapyd$_Index9];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter10 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
                    sub_module_id = _$rapyd$_Iter10[_$rapyd$_Index10];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter11 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                                    cname = _$rapyd$_Iter11[_$rapyd$_Index11];
                                ...
                                var _$rapyd$_Iter12 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
                                    symdef = _$rapyd$_Iter12[_$rapyd$_Index12];
                                    cached.exports.push({
                                        "name": symdef.name
                                    });
                                }
                                ...
                                for (var _$rapyd$_Index13 = 0; _$rapyd$_Index13 < _$rapyd$_Iter13.length; _$rapyd$_Index13++) {
                                    beautify = _$rapyd$_Iter13[_$rapyd$_Index13];
                                    var _$rapyd$_Iter14 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                                        auto_bind = _$rapyd$_Iter14[_$rapyd$_Index14];
                                        var _$rapyd$_Iter15 = _$rapyd$_Iterable([ 5, 6 ]);
                                        for (var _$rapyd$_Index15 = 0; _$rapyd$_Index15 < _$rapyd$_Iter15.length; _$rapyd$_Index15++) {
                                            js_version = _$rapyd$_Iter15[_$rapyd$_Index15];
                                            co = OutputStream({
                                                "beautify": beautify,
                                                "auto_bind": auto_bind,
