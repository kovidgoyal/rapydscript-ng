...
var str = _$rapyd$_str;
    ...
    (function(){
        ...
        COMPILER_VERSION = "8295e480086e967421cf4c745b08eec437d44880";
        ...
        function parse($TEXT, options) {
            ...
            function scan_for_local_vars(body) {
                ...
                function scan_assign(assign) {
                    if (assign.left instanceof AST_Array) {
                        push("_$rapyd$_Unpack");
                        scan_in_array(assign.left.elements);
                    } else if (assign.left.name) {
                        push(assign.left.name);
                    }
                    if (assign.right instanceof AST_Assign) {
                        scan_assign(assign.right);
                    } else if (assign.right instanceof AST_Seq) {
                        if (assign.right.cdr instanceof AST_Assign) {
                            push(assign.right.car.name);
                            scan_assign(assign.right.cdr);
                        } else if (assign.right.car instanceof AST_Assign) {
                            scan_assign(assign.right.car);
                        }
                    }
                }
                if (Array.isArray(body)) {
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter23 = _$rapyd$_Iterable(enumerate(_$rapyd$_list_decorate([ base_path + ".pyj", base_path + "/__init__.pyj" ])));
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter24 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ options.basedir, options.libdir ]));
            ...
            import_ = function(from_import) {
                var ans, tok, tmp, name, last_tok, key, alias, aimp, _$rapyd$_Unpack, classes, argnames, bracketed, exports, symdef, aname, obj, argvar, cname, imp;
                ans = new AST_Imports({
            ...
            class_ = function() {
                ...
                var _$rapyd$_Iter31 = _$rapyd$_Iterable(definition.body);
                for (var _$rapyd$_Index31 = 0; _$rapyd$_Index31 < _$rapyd$_Iter31.length; _$rapyd$_Index31++) {
                    stmt = _$rapyd$_Iter31[_$rapyd$_Index31];
            ...
            object_ = embed_tokens(function() {
                var first, has_non_const_keys, is_pydict, a, start, left, end;
                expect("{");
                first = true;
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function prologue(module_) {
                ...
                var _$rapyd$_Iter34 = _$rapyd$_Iterable(baselib_items);
                for (var _$rapyd$_Index34 = 0; _$rapyd$_Index34 < _$rapyd$_Iter34.length; _$rapyd$_Index34++) {
                    lib = _$rapyd$_Iter34[_$rapyd$_Index34];
        ...
        function codegen() {
            ...
            function bind_methods(methods, output) {
                var arg;
                if (methods) {
                    var _$rapyd$_Iter36 = _$rapyd$_Iterable(methods);
            ...
            function write_imports(module, output) {
                ...
                imports = _$rapyd$_list_decorate([]);
                var _$rapyd$_Iter37 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index37 = 0; _$rapyd$_Index37 < _$rapyd$_Iter37.length; _$rapyd$_Index37++) {
                    import_id = _$rapyd$_Iter37[_$rapyd$_Index37];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter38 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index38 = 0; _$rapyd$_Index38 < _$rapyd$_Iter38.length; _$rapyd$_Index38++) {
                    module_ = _$rapyd$_Iter38[_$rapyd$_Index38];
                    var _$rapyd$_Iter39 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index39 = 0; _$rapyd$_Index39 < _$rapyd$_Iter39.length; _$rapyd$_Index39++) {
                        name = _$rapyd$_Iter39[_$rapyd$_Index39];
                ...
                var _$rapyd$_Iter40 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index40 = 0; _$rapyd$_Index40 < _$rapyd$_Iter40.length; _$rapyd$_Index40++) {
                    module_ = _$rapyd$_Iter40[_$rapyd$_Index40];
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter42 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index42 = 0; _$rapyd$_Index42 < _$rapyd$_Iter42.length; _$rapyd$_Index42++) {
                                _$rapyd$_Unpack = _$rapyd$_Iter42[_$rapyd$_Index42];
                                c = _$rapyd$_Unpack[0];
                                arg = _$rapyd$_Unpack[1];
                                i = c - offset;
                                if (i >= 0) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter43 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index43 = 0; _$rapyd$_Index43 < _$rapyd$_Iter43.length; _$rapyd$_Index43++) {
                                        dname = _$rapyd$_Iter43[_$rapyd$_Index43];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter44 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index44 = 0; _$rapyd$_Index44 < _$rapyd$_Iter44.length; _$rapyd$_Index44++) {
                    symbol = _$rapyd$_Iter44[_$rapyd$_Index44];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter45 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index45 = 0; _$rapyd$_Index45 < _$rapyd$_Iter45.length; _$rapyd$_Index45++) {
                    sub_module_id = _$rapyd$_Iter45[_$rapyd$_Index45];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter46 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index46 = 0; _$rapyd$_Index46 < _$rapyd$_Iter46.length; _$rapyd$_Index46++) {
                                    cname = _$rapyd$_Iter46[_$rapyd$_Index46];
                                ...
                                var _$rapyd$_Iter47 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index47 = 0; _$rapyd$_Index47 < _$rapyd$_Iter47.length; _$rapyd$_Index47++) {
                                    symdef = _$rapyd$_Iter47[_$rapyd$_Index47];
                                    cached.exports.push({
                                        "name": symdef.name
                                    });
                                }
                                var _$rapyd$_Iter48 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ true, false ]));
                                for (var _$rapyd$_Index48 = 0; _$rapyd$_Index48 < _$rapyd$_Iter48.length; _$rapyd$_Index48++) {
                                    beautify = _$rapyd$_Iter48[_$rapyd$_Index48];
                                    ...
                                    for (var _$rapyd$_Index49 = 0; _$rapyd$_Index49 < _$rapyd$_Iter49.length; _$rapyd$_Index49++) {
                                        auto_bind = _$rapyd$_Iter49[_$rapyd$_Index49];
                                        var _$rapyd$_Iter50 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ 5, 6 ]));
                                        for (var _$rapyd$_Index50 = 0; _$rapyd$_Index50 < _$rapyd$_Iter50.length; _$rapyd$_Index50++) {
                                            js_version = _$rapyd$_Iter50[_$rapyd$_Index50];
                                            co = OutputStream({
                                                "beautify": beautify,
                                                "auto_bind": auto_bind,
            ...
            DEFPRINT(AST_ListComprehension, function(self, output) {
                var result_obj, add_to_result, push_func;
                result_obj = {
                    "ListComprehension": "[]",
                    "DictComprehension": "{}",
