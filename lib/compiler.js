(function(){
    ...
    (function(){
        ...
        COMPILER_VERSION = "860c6db6d3a852dddda6fedc5a39fc3c0e9efa4f";
        ...
        function parse($TEXT, options) {
            ...
            if (options.classes) {
                var _$rapyd$_Iter21 = _$rapyd$_Iterable(options.classes);
                for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                    cname = _$rapyd$_Iter21[_$rapyd$_Index21];
                ...
                if (Array.isArray(body)) {
                    for (name in body) {
                        ...
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter22 = _$rapyd$_Iterable([ "body", "alternative" ]);
                            for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
                                x = _$rapyd$_Iter22[_$rapyd$_Index22];
                                opt = obj[x];
                                if (opt) {
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter23 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
                    for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter23[_$rapyd$_Index23];
                        i = _$rapyd$_Unpack[0];
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter24 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
                for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
                    location = _$rapyd$_Iter24[_$rapyd$_Index24];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter25 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                        ikey = _$rapyd$_Iter25[_$rapyd$_Index25];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        is_cached: true,
                ...
                var _$rapyd$_Iter26 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < _$rapyd$_Iter26.length; _$rapyd$_Index26++) {
                    bitem = _$rapyd$_Iter26[_$rapyd$_Index26];
            ...
            import_ = function(from_import) {
                ...
                var _$rapyd$_Iter27 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index27 = 0; _$rapyd$_Index27 < _$rapyd$_Iter27.length; _$rapyd$_Index27++) {
                    imp = _$rapyd$_Iter27[_$rapyd$_Index27];
                    do_import(imp.key);
                    ...
                    if (from_import) {
                        ...
                        exports = {};
                        var _$rapyd$_Iter28 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index28 = 0; _$rapyd$_Index28 < _$rapyd$_Iter28.length; _$rapyd$_Index28++) {
                            symdef = _$rapyd$_Iter28[_$rapyd$_Index28];
                        ...
                        var _$rapyd$_Iter29 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index29 = 0; _$rapyd$_Index29 < _$rapyd$_Iter29.length; _$rapyd$_Index29++) {
                            argvar = _$rapyd$_Iter29[_$rapyd$_Index29];
                        ...
                        var _$rapyd$_Iter30 = _$rapyd$_Iterable(Object.keys(classes));
            ...
            function_ = function(in_class, ctor) {
                ...
                nonlocals.forEach(function(variable) {
                    var i;
                    var _$rapyd$_Iter31 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
                    for (var _$rapyd$_Index31 = 0; _$rapyd$_Index31 < _$rapyd$_Iter31.length; _$rapyd$_Index31++) {
                        i = _$rapyd$_Iter31[_$rapyd$_Index31];
            ...
            function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
                ...
                if (func_call) {
                    tmp = [];
                    tmp.kwargs = [];
                    var _$rapyd$_Iter32 = _$rapyd$_Iterable(enumerate(a));
                    for (var _$rapyd$_Index32 = 0; _$rapyd$_Index32 < _$rapyd$_Iter32.length; _$rapyd$_Index32++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter32[_$rapyd$_Index32];
                        i = _$rapyd$_Unpack[0];
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function spaced() {
                ...
                var _$rapyd$_Iter86 = _$rapyd$_Iterable(enumerate(arguments));
                for (var _$rapyd$_Index86 = 0; _$rapyd$_Index86 < _$rapyd$_Iter86.length; _$rapyd$_Index86++) {
                    _$rapyd$_Unpack = _$rapyd$_Iter86[_$rapyd$_Index86];
                    i = _$rapyd$_Unpack[0];
                    x = _$rapyd$_Unpack[1];
                    if (i > 0) {
                        space();
            ...
            function prologue(module_) {
                ...
                if (!options.omit_baselib) {
                    var _$rapyd$_Iter87 = _$rapyd$_Iterable(module_.baselib);
                    for (var _$rapyd$_Index87 = 0; _$rapyd$_Index87 < _$rapyd$_Iter87.length; _$rapyd$_Index87++) {
                        lib = _$rapyd$_Iter87[_$rapyd$_Index87];
                        dump_baselib(lib);
                    }
                }
            }
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = [];
                var _$rapyd$_Iter88 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index88 = 0; _$rapyd$_Index88 < _$rapyd$_Iter88.length; _$rapyd$_Index88++) {
                    import_id = _$rapyd$_Iter88[_$rapyd$_Index88];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter89 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index89 = 0; _$rapyd$_Index89 < _$rapyd$_Iter89.length; _$rapyd$_Index89++) {
                    module_ = _$rapyd$_Iter89[_$rapyd$_Index89];
                    var _$rapyd$_Iter90 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index90 = 0; _$rapyd$_Index90 < _$rapyd$_Iter90.length; _$rapyd$_Index90++) {
                        name = _$rapyd$_Iter90[_$rapyd$_Index90];
                ...
                var _$rapyd$_Iter91 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index91 = 0; _$rapyd$_Index91 < _$rapyd$_Iter91.length; _$rapyd$_Index91++) {
                    module_ = _$rapyd$_Iter91[_$rapyd$_Index91];
                ...
                var _$rapyd$_Iter92 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index92 = 0; _$rapyd$_Index92 < _$rapyd$_Iter92.length; _$rapyd$_Index92++) {
                    module_ = _$rapyd$_Iter92[_$rapyd$_Index92];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter93 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index93 = 0; _$rapyd$_Index93 < _$rapyd$_Iter93.length; _$rapyd$_Index93++) {
                                _$rapyd$_Unpack = _$rapyd$_Iter93[_$rapyd$_Index93];
                                c = _$rapyd$_Unpack[0];
                                arg = _$rapyd$_Unpack[1];
                                i = c - offset;
                                if (i >= 0) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter94 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index94 = 0; _$rapyd$_Index94 < _$rapyd$_Iter94.length; _$rapyd$_Index94++) {
                                        dname = _$rapyd$_Iter94[_$rapyd$_Index94];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter95 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index95 = 0; _$rapyd$_Index95 < _$rapyd$_Iter95.length; _$rapyd$_Index95++) {
                    symbol = _$rapyd$_Iter95[_$rapyd$_Index95];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter96 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index96 = 0; _$rapyd$_Index96 < _$rapyd$_Iter96.length; _$rapyd$_Index96++) {
                    sub_module_id = _$rapyd$_Iter96[_$rapyd$_Index96];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter97 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index97 = 0; _$rapyd$_Index97 < _$rapyd$_Iter97.length; _$rapyd$_Index97++) {
                                    cname = _$rapyd$_Iter97[_$rapyd$_Index97];
                                ...
                                var _$rapyd$_Iter98 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index98 = 0; _$rapyd$_Index98 < _$rapyd$_Iter98.length; _$rapyd$_Index98++) {
                                    symdef = _$rapyd$_Iter98[_$rapyd$_Index98];
                                    cached.exports.push({
                                        name: symdef.name
                                    });
                                }
                                var _$rapyd$_Iter99 = _$rapyd$_Iterable([ true, false ]);
                                for (var _$rapyd$_Index99 = 0; _$rapyd$_Index99 < _$rapyd$_Iter99.length; _$rapyd$_Index99++) {
                                    beautify = _$rapyd$_Iter99[_$rapyd$_Index99];
                                    var _$rapyd$_Iter100 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index100 = 0; _$rapyd$_Index100 < _$rapyd$_Iter100.length; _$rapyd$_Index100++) {
                                        auto_bind = _$rapyd$_Iter100[_$rapyd$_Index100];
                                        co = OutputStream({
                                            beautify: beautify,
                                            auto_bind: auto_bind,
                                            private_scope: false,
            ...
            DEFPRINT(AST_Imports, function(container, output) {
                ...
                var _$rapyd$_Iter101 = _$rapyd$_Iterable(container.imports);
                for (var _$rapyd$_Index101 = 0; _$rapyd$_Index101 < _$rapyd$_Iter101.length; _$rapyd$_Index101++) {
                    self = _$rapyd$_Iter101[_$rapyd$_Index101];
                    output.import(self.module);
                    if (self.argnames) {
                        var _$rapyd$_Iter102 = _$rapyd$_Iterable(self.argnames);
                        for (var _$rapyd$_Index102 = 0; _$rapyd$_Index102 < _$rapyd$_Iter102.length; _$rapyd$_Index102++) {
                            argname = _$rapyd$_Iter102[_$rapyd$_Index102];
    ...
    (function(){
        ...
        if (typeof exports === "object") {
            ...
            var _$rapyd$_Iter171 = _$rapyd$_Iterable(ast);
            for (var _$rapyd$_Index171 = 0; _$rapyd$_Index171 < _$rapyd$_Iter171.length; _$rapyd$_Index171++) {
                ast_node = _$rapyd$_Iter171[_$rapyd$_Index171];
