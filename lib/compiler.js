...
;
            ...
            if (methods) {
                var _$rapyd$_Iter0 = _$rapyd$_Iterable(methods);
                for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < _$rapyd$_Iter0.length; _$rapyd$_Index0++) {
                    i = _$rapyd$_Iter0[_$rapyd$_Index0];
                    if (/^\$/.test(i)) {
        ...
        AST_Node = DEFNODE("Node", "start end", {
            ...
            "_dump": function() {
                ...
                var _$rapyd$_Iter1 = _$rapyd$_Iterable(this);
                for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < _$rapyd$_Iter1.length; _$rapyd$_Index1++) {
                    ...
                    if (Array.isArray(this[key])) {
                        if (this[key].length) {
                            ...
                            if (depth > 1) {
                                var _$rapyd$_Iter2 = _$rapyd$_Iterable(this[key]);
                                for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                                    element = _$rapyd$_Iter2[_$rapyd$_Index2];
                        ...
                        if (this[key].TYPE) {
                            if (this[key].TYPE === "Token") {
                                ...
                                for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
                                    property = _$rapyd$_Iter4[_$rapyd$_Index4];
        ...
        AST_Lambda = DEFNODE("Lambda", "name argnames uses_arguments decorators is_generator", {
            ...
            "_walk": function(visitor) {
                ...
                return visitor._visit(node, function() {
                    var d;
                    if (node.decorators) {
                        var _$rapyd$_Iter5 = _$rapyd$_Iterable(node.decorators);
                        for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                            d = _$rapyd$_Iter5[_$rapyd$_Index5];
                            d.walk(visitor);
                        }
                    }
                    if (node.name) {
        ...
        AST_Except = DEFNODE("Except", "argname errors", {
            ...
            "_walk": function(visitor) {
                ...
                return visitor._visit(this, function() {
                    ...
                    if (node.errors) {
                        var _$rapyd$_Iter7 = _$rapyd$_Iterable(node.errors);
                        for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
                            e = _$rapyd$_Iter7[_$rapyd$_Index7];
                            e.walk(visitor);
                        }
                    }
                    walk_body(node, visitor);
            ...
            "flatten": function() {
                function flatten(arr) {
                    ...
                    for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                        value = _$rapyd$_Iter8[_$rapyd$_Index8];
...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "f2965a5a769be74d4365f626da1473cf0355a9a2";
        ...
        function parse($TEXT, options) {
            ...
            function scan_for_top_level_callables(body) {
                ...
                if (Array.isArray(body)) {
                    var _$rapyd$_Iter1 = _$rapyd$_Iterable(body);
                    for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < _$rapyd$_Iter1.length; _$rapyd$_Index1++) {
                        obj = _$rapyd$_Iter1[_$rapyd$_Index1];
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter2 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ "body", "alternative" ]));
                            for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
            ...
            function scan_for_classes(body) {
                var ans, obj;
                ans = {};
                var _$rapyd$_Iter3 = _$rapyd$_Iterable(body);
                for (var _$rapyd$_Index3 = 0; _$rapyd$_Index3 < _$rapyd$_Iter3.length; _$rapyd$_Index3++) {
                    obj = _$rapyd$_Iter3[_$rapyd$_Index3];
            ...
            function scan_for_local_vars(body) {
                ...
                function extend(arr) {
                    ...
                    for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
                        x = _$rapyd$_Iter4[_$rapyd$_Index4];
                        push(x);
                    }
                }
                function scan_in_array(arr) {
                    var x;
                    var _$rapyd$_Iter5 = _$rapyd$_Iterable(arr);
                    for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                ...
                if (Array.isArray(body)) {
                    ...
                    for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
                        ...
                        if (stmt instanceof AST_ForIn) {
                            ...
                            var _$rapyd$_Iter7 = _$rapyd$_Iterable(stmt.clauses);
                            for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
                                clause = _$rapyd$_Iter7[_$rapyd$_Index7];
                                if (clause.alias) {
                    ...
                    if (body.is_chained()) {
                        var _$rapyd$_Iter8 = _$rapyd$_Iterable(body.traverse_chain()[0]);
                        for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                            lhs = _$rapyd$_Iter8[_$rapyd$_Index8];
                            add_assign_lhs(lhs);
                        }
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter10 = _$rapyd$_Iterable(enumerate(_$rapyd$_list_decorate([ base_path + ".pyj", base_path + "/__init__.pyj" ])));
...
;
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter11 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ options.basedir, options.libdir ]));
                for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                    location = _$rapyd$_Iter11[_$rapyd$_Index11];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter12 = _$rapyd$_Iterable(cached.imported_module_ids);
                ...
                var _$rapyd$_Iter13 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
...
;
                ...
                var _$rapyd$_Iter14 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                    imp = _$rapyd$_Iter14[_$rapyd$_Index14];
                    do_import(imp.key);
...
;
                        ...
                        exports = {};
                        var _$rapyd$_Iter15 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index15 = 0; _$rapyd$_Index15 < _$rapyd$_Iter15.length; _$rapyd$_Index15++) {
                            symdef = _$rapyd$_Iter15[_$rapyd$_Index15];
                        ...
                        var _$rapyd$_Iter17 = _$rapyd$_Iterable(Object.keys(classes));
            ...
            class_ = function() {
                ...
                var _$rapyd$_Iter18 = _$rapyd$_Iterable(definition.body);
                for (var _$rapyd$_Index18 = 0; _$rapyd$_Index18 < _$rapyd$_Iter18.length; _$rapyd$_Index18++) {
                    stmt = _$rapyd$_Iter18[_$rapyd$_Index18];
                ...
                visitor = new walker();
                var _$rapyd$_Iter19 = _$rapyd$_Iterable(definition.body);
        ...
        function codegen() {
                        ...
                        if (len(properties)) {
                            ...
                            output.with_parens(function() {
                                [output.print("this"), output.comma(), output.space(), output.with_block(function() {
                                    var prop, name;
                                    var _$rapyd$_Iter23 = _$rapyd$_Iterable(properties);
            ...
            DEFPRINT(AST_Assign, function(self, output) {
                ...
                if (self.operator === "=" && self.is_chained()) {
                    ...
                    [output.end_statement(), output.indent()];
                    var _$rapyd$_Iter24 = _$rapyd$_Iterable(left_hand_sides);
