...
;
    ...
    (function(){
        ...
        ALIAS_MAP = function() {
            ...
            ans = {};
            var _$rapyd$_Iter0 = _$rapyd$_Iterable(DB.split("\n"));
    ...
    (function(){
        ...
        function DEFNODE(type, props, methods, base) {
            ...
            for (var _$rapyd$_Index0 = props.length - 1; _$rapyd$_Index0 > -1; _$rapyd$_Index0-=1) {
                i = _$rapyd$_Index0;
...
;
            ...
            if (methods) {
                var _$rapyd$_Iter1 = _$rapyd$_Iterable(methods);
        ...
        AST_Node = DEFNODE("Node", "start end", {
            ...
            "_dump": function() {
                ...
                var _$rapyd$_Iter2 = _$rapyd$_Iterable(this);
                for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                    ...
                    if (Array.isArray(this[key])) {
                        if (this[key].length) {
                            ...
                            if (depth > 1) {
                                var _$rapyd$_Iter3 = _$rapyd$_Iterable(this[key]);
                                for (var _$rapyd$_Index3 = 0; _$rapyd$_Index3 < _$rapyd$_Iter3.length; _$rapyd$_Index3++) {
                                    element = _$rapyd$_Iter3[_$rapyd$_Index3];
                                    element._dump(depth - 1, omit, offset + 1, true);
                                }
                            } else {
                                var _$rapyd$_Iter4 = _$rapyd$_Iterable(this[key]);
                                for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
                                    element = _$rapyd$_Iter4[_$rapyd$_Index4];
                        ...
                        if (this[key].TYPE) {
                            if (this[key].TYPE === "Token") {
                                ...
                                var _$rapyd$_Iter5 = _$rapyd$_Iterable(this[key]);
                                for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                                    property = _$rapyd$_Iter5[_$rapyd$_Index5];
        ...
        AST_Seq = DEFNODE("Seq", "car cdr", {
            ...
            "$from_array": function(array) {
                ...
                list = null;
                for (var _$rapyd$_Index9 = array.length - 1; _$rapyd$_Index9 > -1; _$rapyd$_Index9-=1) {
                    i = _$rapyd$_Index9;
        ...
        TreeWalker.prototype = {
            ...
            "find_parent": function(type) {
                var stack, x, i;
                stack = this.stack;
                for (var _$rapyd$_Index11 = stack.length - 1; _$rapyd$_Index11 > -1; _$rapyd$_Index11-=1) {
                    i = _$rapyd$_Index11;
                    x = stack[i];
    ...
    (function(){
        ...
        function is_string_modifier(val) {
            var ch;
            var _$rapyd$_Iter0 = _$rapyd$_Iterable(val);
            for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < _$rapyd$_Iter0.length; _$rapyd$_Index0++) {
                ch = _$rapyd$_Iter0[_$rapyd$_Index0];
        ...
        function tokenizer($TEXT, filename) {
            ...
            function token(type, value, is_comment, keep_newline) {
                ...
                if (!is_comment) {
                    ...
                    S.comments_before = [];
                    for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < ret.comments_before.length; _$rapyd$_Index1++) {
                        i = _$rapyd$_Index1;
...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "f55f86b8f03f6c4e385cc475f45ef6c910979984";
        ...
        PRECEDENCE = function(a, ret) {
            var b, j, i;
            for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < a.length; _$rapyd$_Index0++) {
                i = _$rapyd$_Index0;
                b = a[i];
                for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < b.length; _$rapyd$_Index1++) {
                    j = _$rapyd$_Index1;
                    ret[b[j]] = i + 1;
                }
            }
        ...
        function parse($TEXT, options) {
            ...
            var _$rapyd$_Iter2 = _$rapyd$_Iterable([options.libdir, options.basedir]);
            for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
            ...
            if (options.classes) {
                var _$rapyd$_Iter3 = _$rapyd$_Iterable(options.classes);
                for (var _$rapyd$_Index3 = 0; _$rapyd$_Index3 < _$rapyd$_Iter3.length; _$rapyd$_Index3++) {
                    cname = _$rapyd$_Iter3[_$rapyd$_Index3];
            ...
            function scan_for_top_level_callables(body) {
                ...
                if (Array.isArray(body)) {
                    var _$rapyd$_Iter4 = _$rapyd$_Iterable(body);
                    for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
                        obj = _$rapyd$_Iter4[_$rapyd$_Index4];
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter5 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ "body", "alternative" ]));
                            for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
            ...
            function scan_for_classes(body) {
                ...
                for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
                    obj = _$rapyd$_Iter6[_$rapyd$_Index6];
            ...
            function scan_for_local_vars(body) {
                ...
                if (Array.isArray(body)) {
                    var _$rapyd$_Iter9 = _$rapyd$_Iterable(body);
                    for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                        stmt = _$rapyd$_Iter9[_$rapyd$_Index9];
                        ...
                        if (stmt instanceof AST_ForIn) {
                            ...
                            var _$rapyd$_Iter10 = _$rapyd$_Iterable(stmt.clauses);
                            for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
                                clause = _$rapyd$_Iter10[_$rapyd$_Index10];
                                if (clause.alias) {
                    ...
                    if (body.is_chained()) {
                        var _$rapyd$_Iter11 = _$rapyd$_Iterable(body.traverse_chain()[0]);
                        for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                            lhs = _$rapyd$_Iter11[_$rapyd$_Index11];
                            add_assign_lhs(lhs);
                        }
            ...
            function get_class_in_scope(expr) {
                ...
                if (expr instanceof AST_SymbolRef) {
                    ...
                    for (var _$rapyd$_Index13 = S.classes.length - 1; _$rapyd$_Index13 > -1; _$rapyd$_Index13-=1) {
                        s = _$rapyd$_Index13;
                    ...
                    if (expr instanceof AST_SymbolRef) {
                        ...
                        if (len(referenced_path) > 1) {
                            ...
                            for (var _$rapyd$_Index14 = S.classes.length - 1; _$rapyd$_Index14 > -1; _$rapyd$_Index14-=1) {
                                s = _$rapyd$_Index14;
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter15 = _$rapyd$_Iterable(enumerate(_$rapyd$_list_decorate([ base_path + ".pyj", base_path + "/__init__.pyj" ])));
...
;
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter16 = _$rapyd$_Iterable(import_dirs);
                for (var _$rapyd$_Index16 = 0; _$rapyd$_Index16 < _$rapyd$_Iter16.length; _$rapyd$_Index16++) {
                    location = _$rapyd$_Iter16[_$rapyd$_Index16];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter17 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
                        ikey = _$rapyd$_Iter17[_$rapyd$_Index17];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        "is_cached": true,
                ...
                var _$rapyd$_Iter18 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index18 = 0; _$rapyd$_Index18 < _$rapyd$_Iter18.length; _$rapyd$_Index18++) {
                    bitem = _$rapyd$_Iter18[_$rapyd$_Index18];
...
;
                ...
                var _$rapyd$_Iter19 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index19 = 0; _$rapyd$_Index19 < _$rapyd$_Iter19.length; _$rapyd$_Index19++) {
                    imp = _$rapyd$_Iter19[_$rapyd$_Index19];
                    do_import(imp.key);
...
;
                        ...
                        exports = {};
                        var _$rapyd$_Iter20 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index20 = 0; _$rapyd$_Index20 < _$rapyd$_Iter20.length; _$rapyd$_Index20++) {
                            symdef = _$rapyd$_Iter20[_$rapyd$_Index20];
                        ...
                        var _$rapyd$_Iter21 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                            argvar = _$rapyd$_Iter21[_$rapyd$_Index21];
                        ...
                        var _$rapyd$_Iter22 = _$rapyd$_Iterable(Object.keys(classes));
            ...
            class_ = function() {
                ...
                var _$rapyd$_Iter23 = _$rapyd$_Iterable(definition.body);
                for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                    stmt = _$rapyd$_Iter23[_$rapyd$_Index23];
...
;
                ...
                visitor = new walker();
                var _$rapyd$_Iter24 = _$rapyd$_Iterable(definition.body);
                for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
                    stmt = _$rapyd$_Iter24[_$rapyd$_Index24];
...
;
                ...
                for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < assignments.length; _$rapyd$_Index25++) {
                    i = _$rapyd$_Index25;
                    for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < definition.argnames.length + 1; _$rapyd$_Index26++) {
                        j = _$rapyd$_Index26;
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function prologue(module_) {
                ...
                var _$rapyd$_Iter0 = _$rapyd$_Iterable(baselib_items);
                for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < _$rapyd$_Iter0.length; _$rapyd$_Index0++) {
                ...
                var _$rapyd$_Iter1 = _$rapyd$_Iterable(baselib_items);
                for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < _$rapyd$_Iter1.length; _$rapyd$_Index1++) {
                    lib = _$rapyd$_Iter1[_$rapyd$_Index1];
        ...
        function codegen() {
            ...
            function bind_methods(methods, output) {
                var arg;
                if (methods) {
                    var _$rapyd$_Iter2 = _$rapyd$_Iterable(methods);
                    for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                        arg = _$rapyd$_Iter2[_$rapyd$_Index2];
                        output.indent();
                        output.print("this.");
                        output.assign(arg);
            ...
            function write_imports(module, output) {
                ...
                imports = _$rapyd$_list_decorate([]);
                var _$rapyd$_Iter3 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index3 = 0; _$rapyd$_Index3 < _$rapyd$_Iter3.length; _$rapyd$_Index3++) {
                    import_id = _$rapyd$_Iter3[_$rapyd$_Index3];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter4 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index4 = 0; _$rapyd$_Index4 < _$rapyd$_Iter4.length; _$rapyd$_Index4++) {
                    module_ = _$rapyd$_Iter4[_$rapyd$_Index4];
                    var _$rapyd$_Iter5 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index5 = 0; _$rapyd$_Index5 < _$rapyd$_Iter5.length; _$rapyd$_Index5++) {
                        name = _$rapyd$_Iter5[_$rapyd$_Index5];
                ...
                var _$rapyd$_Iter6 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
                    module_ = _$rapyd$_Iter6[_$rapyd$_Index6];
                ...
                var _$rapyd$_Iter7 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index7 = 0; _$rapyd$_Index7 < _$rapyd$_Iter7.length; _$rapyd$_Index7++) {
                    module_ = _$rapyd$_Iter7[_$rapyd$_Index7];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter8 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter9 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                                        dname = _$rapyd$_Iter9[_$rapyd$_Index9];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter10 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter11 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                    sub_module_id = _$rapyd$_Iter11[_$rapyd$_Index11];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter12 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
                                ...
                                var _$rapyd$_Iter13 = _$rapyd$_Iterable(self.exports);
                                ...
                                var _$rapyd$_Iter14 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ true, false ]));
                                for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                                    beautify = _$rapyd$_Iter14[_$rapyd$_Index14];
                                    var _$rapyd$_Iter15 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ true, false ]));
                                    for (var _$rapyd$_Index15 = 0; _$rapyd$_Index15 < _$rapyd$_Iter15.length; _$rapyd$_Index15++) {
                                        auto_bind = _$rapyd$_Iter15[_$rapyd$_Index15];
                                        var _$rapyd$_Iter16 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ 5, 6 ]));
                                        for (var _$rapyd$_Index16 = 0; _$rapyd$_Index16 < _$rapyd$_Iter16.length; _$rapyd$_Index16++) {
            ...
            DEFPRINT(AST_Imports, function(container, output) {
                ...
                var _$rapyd$_Iter17 = _$rapyd$_Iterable(container.imports);
                for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
                    self = _$rapyd$_Iter17[_$rapyd$_Index17];
                    output.import(self.module);
                    if (self.argnames) {
                        var _$rapyd$_Iter18 = _$rapyd$_Iterable(self.argnames);
                        for (var _$rapyd$_Index18 = 0; _$rapyd$_Index18 < _$rapyd$_Iter18.length; _$rapyd$_Index18++) {
                            argname = _$rapyd$_Iter18[_$rapyd$_Index18];
...
;
            ...
            DEFPRINT(AST_With, function(self, output) {
                ...
                var _$rapyd$_Iter19 = _$rapyd$_Iterable(self.clauses);
                for (var _$rapyd$_Index19 = 0; _$rapyd$_Index19 < _$rapyd$_Iter19.length; _$rapyd$_Index19++) {
                    clause = _$rapyd$_Iter19[_$rapyd$_Index19];
                ...
                output.with_block(function() {
                    var clause;
                    var _$rapyd$_Iter20 = _$rapyd$_Iterable(exits);
                    for (var _$rapyd$_Index20 = 0; _$rapyd$_Index20 < _$rapyd$_Iter20.length; _$rapyd$_Index20++) {
                        clause = _$rapyd$_Iter20[_$rapyd$_Index20];
                ...
                output.with_block(function() {
                    ...
                    output.end_statement()];
                    var _$rapyd$_Iter21 = _$rapyd$_Iterable(exits);
                    for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                        clause = _$rapyd$_Iter21[_$rapyd$_Index21];
                        output.indent();
            ...
            AST_Class.DEFMETHOD("_do_print", function(output) {
                ...
                if (property_names.length) {
                    ...
                    output.with_parens(function() {
                        ...
                        output.with_block(function() {
                            var prop, name;
                            var _$rapyd$_Iter22 = _$rapyd$_Iterable(property_names);
                            for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
                                name = _$rapyd$_Iter22[_$rapyd$_Index22];
            ...
            DEFPRINT(AST_Assign, function(self, output) {
                ...
                if (self.operator === "=" && self.is_chained()) {
                    ...
                    [output.end_statement(), output.indent()];
                    var _$rapyd$_Iter23 = _$rapyd$_Iterable(left_hand_sides);
                    for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                        lhs = _$rapyd$_Iter23[_$rapyd$_Index23];
                        print_assignment(new AST_Assign({
                            "left": lhs,
                            "right": temp_rhs,
            ...
            function best_of(a) {
                ...
                best = a[0];
                len_ = best.length;
                for (var _$rapyd$_Index24 = 1; _$rapyd$_Index24 < a.length; _$rapyd$_Index24++) {
                    i = _$rapyd$_Index24;
                    if (a[i].length < len_) {
                        best = a[i];
                        len_ = best.length;
    ...
    (function(){
        ...
        if (typeof exports === "object") {
            ...
            var _$rapyd$_Iter0 = _$rapyd$_Iterable(ast);
            for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < _$rapyd$_Iter0.length; _$rapyd$_Index0++) {
                ast_node = _$rapyd$_Iter0[_$rapyd$_Index0];
