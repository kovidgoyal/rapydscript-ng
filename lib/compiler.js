...
;
    ...
    (function(){
        ...
        KEYWORDS = "as break case class const continue debugger def del do elif else except finally for from if import in instanceof is new nonlocal pass raise return yield switch til to try typeof var void while with or and not delete default";
...
;
            ...
            function next_token() {
                ...
                } else if (tmp_ === 114 && "\"'".indexOf(S.text.charAt(S.pos + 1)) !== -1) {
                    next();
                    return read_string(true);
                } else if (tmp_ === 118 && "\"'".indexOf(S.text.charAt(S.pos + 1)) !== -1) {
                    next();
                    return read_string(false, true);
                } else if (tmp_ === 35) {
    ...
    (function(){
        ...
        COMPILER_VERSION = "57a6565e56a153b4efe1fe22561eaf5e87515116";
        ...
        function parse($TEXT, options) {
            ...
            if (options.classes) {
                var _$rapyd$_Iter15 = _$rapyd$_Iterable(options.classes);
                for (var _$rapyd$_Index15 = 0; _$rapyd$_Index15 < _$rapyd$_Iter15.length; _$rapyd$_Index15++) {
                    cname = _$rapyd$_Iter15[_$rapyd$_Index15];
            ...
            function scan_for_top_level_callables(body) {
                ...
                if (Array.isArray(body)) {
                    ...
                    for (var _$rapyd$_Index16 = 0; _$rapyd$_Index16 < _$rapyd$_Iter16.length; _$rapyd$_Index16++) {
                        obj = _$rapyd$_Iter16[_$rapyd$_Index16];
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter17 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ "body", "alternative" ]));
                            for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
                                x = _$rapyd$_Iter17[_$rapyd$_Index17];
                                opt = obj[x];
                                if (opt) {
            ...
            function scan_for_local_vars(body) {
                ...
                if (Array.isArray(body)) {
                    ...
                    if (body.is_chained()) {
                        var _$rapyd$_Iter22 = _$rapyd$_Iterable(body.traverse_chain()[0]);
                        for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
                            lhs = _$rapyd$_Iter22[_$rapyd$_Index22];
                            add_assign_lhs(lhs);
                        }
            ...
            function scan_for_nonlocal_defs(body) {
                ...
                vars = [];
                if (Array.isArray(body)) {
                    var _$rapyd$_Iter23 = _$rapyd$_Iterable(body);
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter24 = _$rapyd$_Iterable(enumerate(_$rapyd$_list_decorate([ base_path + ".pyj", base_path + "/__init__.pyj" ])));
...
;
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter25 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ options.basedir, options.libdir ]));
...
;
            ...
            class_ = function() {
                ...
                var _$rapyd$_Iter32 = _$rapyd$_Iterable(definition.body);
                ...
                visitor = new walker();
                var _$rapyd$_Iter33 = _$rapyd$_Iterable(definition.body);
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function prologue(module_) {
                ...
                var _$rapyd$_Iter35 = _$rapyd$_Iterable(baselib_items);
                for (var _$rapyd$_Index35 = 0; _$rapyd$_Index35 < _$rapyd$_Iter35.length; _$rapyd$_Index35++) {
                    lib = _$rapyd$_Iter35[_$rapyd$_Index35];
                ...
                var _$rapyd$_Iter36 = _$rapyd$_Iterable(baselib_items);
                for (var _$rapyd$_Index36 = 0; _$rapyd$_Index36 < _$rapyd$_Iter36.length; _$rapyd$_Index36++) {
                    lib = _$rapyd$_Iter36[_$rapyd$_Index36];
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = _$rapyd$_list_decorate([]);
                var _$rapyd$_Iter38 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index38 = 0; _$rapyd$_Index38 < _$rapyd$_Iter38.length; _$rapyd$_Index38++) {
                    import_id = _$rapyd$_Iter38[_$rapyd$_Index38];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter39 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index39 = 0; _$rapyd$_Index39 < _$rapyd$_Iter39.length; _$rapyd$_Index39++) {
                    module_ = _$rapyd$_Iter39[_$rapyd$_Index39];
                    var _$rapyd$_Iter40 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index40 = 0; _$rapyd$_Index40 < _$rapyd$_Iter40.length; _$rapyd$_Index40++) {
                        name = _$rapyd$_Iter40[_$rapyd$_Index40];
                ...
                var _$rapyd$_Iter42 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index42 = 0; _$rapyd$_Index42 < _$rapyd$_Iter42.length; _$rapyd$_Index42++) {
                    module_ = _$rapyd$_Iter42[_$rapyd$_Index42];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter43 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index43 = 0; _$rapyd$_Index43 < _$rapyd$_Iter43.length; _$rapyd$_Index43++) {
                                _$rapyd$_unpack = _$rapyd$_Iter43[_$rapyd$_Index43];
                                c = _$rapyd$_unpack[0];
                                arg = _$rapyd$_unpack[1];
                                i = c - offset;
                                if (i >= 0) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter44 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index44 = 0; _$rapyd$_Index44 < _$rapyd$_Iter44.length; _$rapyd$_Index44++) {
                                        dname = _$rapyd$_Iter44[_$rapyd$_Index44];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter45 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index45 = 0; _$rapyd$_Index45 < _$rapyd$_Iter45.length; _$rapyd$_Index45++) {
                    symbol = _$rapyd$_Iter45[_$rapyd$_Index45];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter46 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index46 = 0; _$rapyd$_Index46 < _$rapyd$_Iter46.length; _$rapyd$_Index46++) {
                    sub_module_id = _$rapyd$_Iter46[_$rapyd$_Index46];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter47 = _$rapyd$_Iterable(Object.keys(self.classes));
                                ...
                                var _$rapyd$_Iter48 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index48 = 0; _$rapyd$_Index48 < _$rapyd$_Iter48.length; _$rapyd$_Index48++) {
                                    symdef = _$rapyd$_Iter48[_$rapyd$_Index48];
                                    cached.exports.push({
                                        "name": symdef.name
                                    });
                                }
                                var _$rapyd$_Iter49 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ true, false ]));
                                for (var _$rapyd$_Index49 = 0; _$rapyd$_Index49 < _$rapyd$_Iter49.length; _$rapyd$_Index49++) {
                                    beautify = _$rapyd$_Iter49[_$rapyd$_Index49];
                                    var _$rapyd$_Iter50 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ true, false ]));
                                    for (var _$rapyd$_Index50 = 0; _$rapyd$_Index50 < _$rapyd$_Iter50.length; _$rapyd$_Index50++) {
                                        auto_bind = _$rapyd$_Iter50[_$rapyd$_Index50];
                                        var _$rapyd$_Iter51 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ 5, 6 ]));
                                        for (var _$rapyd$_Index51 = 0; _$rapyd$_Index51 < _$rapyd$_Iter51.length; _$rapyd$_Index51++) {
                                            js_version = _$rapyd$_Iter51[_$rapyd$_Index51];
                                            co = OutputStream({
                                                "beautify": beautify,
                                                "auto_bind": auto_bind,
                        ...
                        if (len(properties)) {
                            ...
                            output.with_parens(function() {
                                [output.print("this"), output.comma(), output.space(), output.with_block(function() {
                                    var prop, name;
                                    var _$rapyd$_Iter55 = _$rapyd$_Iterable(properties);
                                    for (var _$rapyd$_Index55 = 0; _$rapyd$_Index55 < _$rapyd$_Iter55.length; _$rapyd$_Index55++) {
                                        name = _$rapyd$_Iter55[_$rapyd$_Index55];
            ...
            DEFPRINT(AST_Assign, function(self, output) {
                ...
                if (self.operator === "=" && self.is_chained()) {
                    ...
                    [output.end_statement(), output.indent()];
                    var _$rapyd$_Iter56 = _$rapyd$_Iterable(left_hand_sides);
                    for (var _$rapyd$_Index56 = 0; _$rapyd$_Index56 < _$rapyd$_Iter56.length; _$rapyd$_Index56++) {
                        lhs = _$rapyd$_Iter56[_$rapyd$_Index56];
                        print_assignment(new AST_Assign({
                            "left": lhs,
                            "right": temp_rhs,
