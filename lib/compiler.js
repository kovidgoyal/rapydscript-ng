...
ValueError.prototype.name = "ValueError";
    ...
    (function(){
        ...
        COMPILER_VERSION = "f8492f80f97b5bc6dae893d3cd06c592c038e549";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function prologue(module_) {
                ...
                var _$rapyd$_Iter20 = _$rapyd$_Iterable(baselib_items);
                ...
                var _$rapyd$_Iter21 = _$rapyd$_Iterable(baselib_items);
                for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                    lib = _$rapyd$_Iter21[_$rapyd$_Index21];
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = [];
                var _$rapyd$_Iter22 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
                    import_id = _$rapyd$_Iter22[_$rapyd$_Index22];
                ...
                for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                    ...
                    var _$rapyd$_Iter24 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
                        name = _$rapyd$_Iter24[_$rapyd$_Index24];
                ...
                var _$rapyd$_Iter26 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < _$rapyd$_Iter26.length; _$rapyd$_Index26++) {
                    module_ = _$rapyd$_Iter26[_$rapyd$_Index26];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter27 = _$rapyd$_Iterable(enumerate(a));
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter28 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index28 = 0; _$rapyd$_Index28 < _$rapyd$_Iter28.length; _$rapyd$_Index28++) {
                                        dname = _$rapyd$_Iter28[_$rapyd$_Index28];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter29 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index29 = 0; _$rapyd$_Index29 < _$rapyd$_Iter29.length; _$rapyd$_Index29++) {
                    symbol = _$rapyd$_Iter29[_$rapyd$_Index29];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter30 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index30 = 0; _$rapyd$_Index30 < _$rapyd$_Iter30.length; _$rapyd$_Index30++) {
                    sub_module_id = _$rapyd$_Iter30[_$rapyd$_Index30];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter31 = _$rapyd$_Iterable(Object.keys(self.classes));
                                ...
                                var _$rapyd$_Iter32 = _$rapyd$_Iterable(self.exports);
                                ...
                                for (var _$rapyd$_Index33 = 0; _$rapyd$_Index33 < _$rapyd$_Iter33.length; _$rapyd$_Index33++) {
                                    beautify = _$rapyd$_Iter33[_$rapyd$_Index33];
                                    var _$rapyd$_Iter34 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index34 = 0; _$rapyd$_Index34 < _$rapyd$_Iter34.length; _$rapyd$_Index34++) {
                                        auto_bind = _$rapyd$_Iter34[_$rapyd$_Index34];
                                        var _$rapyd$_Iter35 = _$rapyd$_Iterable([ 5, 6 ]);
                                        for (var _$rapyd$_Index35 = 0; _$rapyd$_Index35 < _$rapyd$_Iter35.length; _$rapyd$_Index35++) {
                                            js_version = _$rapyd$_Iter35[_$rapyd$_Index35];
                                            co = OutputStream({
                                                "beautify": beautify,
                                                "auto_bind": auto_bind,
