(function(){
    ...
    (function(){
        ...
        function make_predicate(words) {
            ...
            if (typeof Set === "function") {
                ...
                a = {};
                var _$rapyd$_Iter2 = _$rapyd$_Iterable(words);
    ...
    (function(){
        ...
        JS_Parse_Error.prototype.__init__ = function __init__(message, filename, line, col, pos, is_eof){
            var self = this;
        ...
        _$rapyd$_modules["errors"]["JS_Parse_Error"] = JS_Parse_Error;
    ...
    (function(){
        var __name__ = "ast";
        var AST_Token, AST_Node, AST_Statement, AST_Debugger, AST_Directive, AST_SimpleStatement, AST_Block, AST_BlockStatement, AST_EmptyStatement, AST_StatementWithBody, AST_DWLoop, AST_Do, AST_While, AST_ForIn, AST_ForJS, AST_ListComprehension, AST_With, AST_Scope, AST_Toplevel, AST_Import, AST_Imports, AST_Decorator, AST_Lambda, AST_Accessor, AST_Function, AST_Class, AST_Method, AST_Jump, AST_Exit, AST_Return, AST_Throw, AST_LoopControl, AST_Break, AST_Continue, AST_If, AST_Switch, AST_SwitchBranch, AST_Default, AST_Case, AST_Try, AST_Catch, AST_Except, AST_Finally, AST_Definitions, AST_Var, AST_Const, AST_VarDef, AST_BaseCall, AST_Call, AST_ClassCall, AST_New, AST_Seq, AST_PropAccess, AST_Dot, AST_Sub, AST_Splice, AST_Unary, AST_UnaryPrefix, AST_UnaryPostfix, AST_Binary, AST_Conditional, AST_Assign, AST_Array, AST_Object, AST_ObjectProperty, AST_ObjectKeyVal, AST_ObjectSetter, AST_ObjectGetter, AST_Symbol, AST_SymbolAlias, AST_SymbolAccessor, AST_SymbolDeclaration, AST_SymbolVar, AST_ImportedVar, AST_SymbolConst, AST_SymbolNonlocal, AST_SymbolFunarg, AST_SymbolDefun, AST_SymbolLambda, AST_SymbolCatch, AST_SymbolRef, AST_This, AST_Constant, AST_String, AST_Verbatim, AST_Number, AST_RegExp, AST_Atom, AST_Null, AST_NaN, AST_Undefined, AST_Hole, AST_Infinity, AST_Boolean, AST_False, AST_True;
        "use strict";
        ...
        AST_Class = DEFNODE("Class", "init name parent static external bound decorators module_id", {
            ...
            _walk: function(visitor) {
                ...
                return visitor._visit(node, function() {
                    var d;
                    if (node.decorators) {
                        var _$rapyd$_Iter8 = _$rapyd$_Iterable(node.decorators);
                        for (var _$rapyd$_Index8 = 0; _$rapyd$_Index8 < _$rapyd$_Iter8.length; _$rapyd$_Index8++) {
                            d = _$rapyd$_Iter8[_$rapyd$_Index8];
                            d.walk(visitor);
                        }
                    }
                    node.name._walk(visitor);
        ...
        AST_Except = DEFNODE("Except", "argname errors", {
            ...
            _walk: function(visitor) {
                ...
                return visitor._visit(this, function() {
                    ...
                    if (node.errors) {
                        var _$rapyd$_Iter9 = _$rapyd$_Iterable(node.errors);
                        for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                            e = _$rapyd$_Iter9[_$rapyd$_Index9];
                            e.walk(visitor);
                        }
                    }
                    walk_body(node, visitor);
    ...
    (function(){
        ...
        var RE_HEX_NUMBER, RE_OCT_NUMBER, RE_DEC_NUMBER, UNARY_POSTFIX, OPERATOR_CHARS, OPERATORS, OP_MAP, WHITESPACE_CHARS, PUNC_BEFORE_EXPRESSION, PUNC_CHARS, REGEXP_MODIFIERS, ALL_KEYWORDS, KEYWORDS, RESERVED_WORDS, KEYWORDS_BEFORE_EXPRESSION, KEYWORDS_ATOM, IDENTIFIER_PAT, UNICODE, EX_EOF;
        ...
        var JS_Parse_Error = _$rapyd$_modules["errors"].JS_Parse_Error;
        ...
        function tokenizer($TEXT, filename) {
            ...
            function parse_error(err, is_eof) {
                throw new JS_Parse_Error(err, filename, S.tokline, S.tokcol, S.tokpos, is_eof);
            }
            ...
            read_regexp = with_eof_error("Unterminated regular expression", function() {
                var in_class, prev_backslash, regexp, mods;
    ...
    (function(){
        ...
        COMPILER_VERSION = "39e984e6bb9cd893ea88089462d61b4afc2f63f1";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            if (options.classes) {
                var _$rapyd$_Iter22 = _$rapyd$_Iterable(options.classes);
                for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
                    cname = _$rapyd$_Iter22[_$rapyd$_Index22];
            ...
            function croak(msg, line, col, pos, is_eof) {
                var ctx;
                ctx = S.input.context();
                throw new JS_Parse_Error(msg, ctx.filename, line !== undefined ? line : ctx.tokline, col !== undefined ? col : ctx.tokcol, pos !== undefined ? pos : ctx.tokpos, is_eof);
            }
                ...
                if (Array.isArray(body)) {
                    for (name in body) {
                        ...
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter23 = _$rapyd$_Iterable([ "body", "alternative" ]);
                            for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                                x = _$rapyd$_Iter23[_$rapyd$_Index23];
                                opt = obj[x];
                                if (opt) {
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter24 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
                    for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter24[_$rapyd$_Index24];
                        i = _$rapyd$_Unpack[0];
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter25 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
                for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                    location = _$rapyd$_Iter25[_$rapyd$_Index25];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter26 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < _$rapyd$_Iter26.length; _$rapyd$_Index26++) {
                        ikey = _$rapyd$_Iter26[_$rapyd$_Index26];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        is_cached: true,
                ...
                var _$rapyd$_Iter27 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index27 = 0; _$rapyd$_Index27 < _$rapyd$_Iter27.length; _$rapyd$_Index27++) {
                    bitem = _$rapyd$_Iter27[_$rapyd$_Index27];
            ...
            import_ = function(from_import) {
                ...
                var _$rapyd$_Iter28 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index28 = 0; _$rapyd$_Index28 < _$rapyd$_Iter28.length; _$rapyd$_Index28++) {
                    imp = _$rapyd$_Iter28[_$rapyd$_Index28];
                    do_import(imp.key);
                    ...
                    if (from_import) {
                        ...
                        exports = {};
                        var _$rapyd$_Iter29 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        for (var _$rapyd$_Index29 = 0; _$rapyd$_Index29 < _$rapyd$_Iter29.length; _$rapyd$_Index29++) {
                            symdef = _$rapyd$_Iter29[_$rapyd$_Index29];
                        ...
                        var _$rapyd$_Iter30 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index30 = 0; _$rapyd$_Index30 < _$rapyd$_Iter30.length; _$rapyd$_Index30++) {
                            argvar = _$rapyd$_Iter30[_$rapyd$_Index30];
                        ...
                        var _$rapyd$_Iter31 = _$rapyd$_Iterable(Object.keys(classes));
                        for (var _$rapyd$_Index31 = 0; _$rapyd$_Index31 < _$rapyd$_Iter31.length; _$rapyd$_Index31++) {
                            cname = _$rapyd$_Iter31[_$rapyd$_Index31];
                            obj = classes[cname];
            ...
            function_ = function(in_class, ctor) {
                ...
                nonlocals.forEach(function(variable) {
                    var i;
                    var _$rapyd$_Iter32 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
                    for (var _$rapyd$_Index32 = 0; _$rapyd$_Index32 < _$rapyd$_Iter32.length; _$rapyd$_Index32++) {
                        i = _$rapyd$_Iter32[_$rapyd$_Index32];
            ...
            function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
                ...
                if (func_call) {
                    tmp = [];
                    tmp.kwargs = [];
                    var _$rapyd$_Iter33 = _$rapyd$_Iterable(enumerate(a));
                    for (var _$rapyd$_Index33 = 0; _$rapyd$_Index33 < _$rapyd$_Iter33.length; _$rapyd$_Index33++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter33[_$rapyd$_Index33];
                        i = _$rapyd$_Unpack[0];
    ...
    (function(){
        ...
        var is_identifier = _$rapyd$_modules["tokenizer"].is_identifier;
        ...
        function OutputStream(options) {
            ...
            function spaced() {
                ...
                var _$rapyd$_Iter87 = _$rapyd$_Iterable(enumerate(arguments));
                for (var _$rapyd$_Index87 = 0; _$rapyd$_Index87 < _$rapyd$_Iter87.length; _$rapyd$_Index87++) {
                    _$rapyd$_Unpack = _$rapyd$_Iter87[_$rapyd$_Index87];
                    i = _$rapyd$_Unpack[0];
                    x = _$rapyd$_Unpack[1];
                    if (i > 0) {
                        space();
            ...
            function prologue(module_) {
                ...
                if (!options.omit_baselib) {
                    var _$rapyd$_Iter88 = _$rapyd$_Iterable(module_.baselib);
                    for (var _$rapyd$_Index88 = 0; _$rapyd$_Index88 < _$rapyd$_Iter88.length; _$rapyd$_Index88++) {
                        lib = _$rapyd$_Iter88[_$rapyd$_Index88];
                        dump_baselib(lib);
                    }
                }
            }
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = [];
                var _$rapyd$_Iter89 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index89 = 0; _$rapyd$_Index89 < _$rapyd$_Iter89.length; _$rapyd$_Index89++) {
                    import_id = _$rapyd$_Iter89[_$rapyd$_Index89];
                ...
                nonlocalvars = {};
                var _$rapyd$_Iter90 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index90 = 0; _$rapyd$_Index90 < _$rapyd$_Iter90.length; _$rapyd$_Index90++) {
                    module_ = _$rapyd$_Iter90[_$rapyd$_Index90];
                    var _$rapyd$_Iter91 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index91 = 0; _$rapyd$_Index91 < _$rapyd$_Iter91.length; _$rapyd$_Index91++) {
                        name = _$rapyd$_Iter91[_$rapyd$_Index91];
                ...
                var _$rapyd$_Iter93 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index93 = 0; _$rapyd$_Index93 < _$rapyd$_Iter93.length; _$rapyd$_Index93++) {
                    module_ = _$rapyd$_Iter93[_$rapyd$_Index93];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter94 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index94 = 0; _$rapyd$_Index94 < _$rapyd$_Iter94.length; _$rapyd$_Index94++) {
                                _$rapyd$_Unpack = _$rapyd$_Iter94[_$rapyd$_Index94];
                                c = _$rapyd$_Unpack[0];
                                arg = _$rapyd$_Unpack[1];
                                i = c - offset;
                                if (i >= 0) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter95 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index95 = 0; _$rapyd$_Index95 < _$rapyd$_Iter95.length; _$rapyd$_Index95++) {
                                        dname = _$rapyd$_Iter95[_$rapyd$_Index95];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter96 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index96 = 0; _$rapyd$_Index96 < _$rapyd$_Iter96.length; _$rapyd$_Index96++) {
                    symbol = _$rapyd$_Iter96[_$rapyd$_Index96];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter97 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index97 = 0; _$rapyd$_Index97 < _$rapyd$_Iter97.length; _$rapyd$_Index97++) {
                    sub_module_id = _$rapyd$_Iter97[_$rapyd$_Index97];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter98 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index98 = 0; _$rapyd$_Index98 < _$rapyd$_Iter98.length; _$rapyd$_Index98++) {
                                    cname = _$rapyd$_Iter98[_$rapyd$_Index98];
                                ...
                                var _$rapyd$_Iter99 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index99 = 0; _$rapyd$_Index99 < _$rapyd$_Iter99.length; _$rapyd$_Index99++) {
                                    symdef = _$rapyd$_Iter99[_$rapyd$_Index99];
                                    cached.exports.push({
                                        name: symdef.name
                                    });
                                }
                                ...
                                for (var _$rapyd$_Index100 = 0; _$rapyd$_Index100 < _$rapyd$_Iter100.length; _$rapyd$_Index100++) {
                                    beautify = _$rapyd$_Iter100[_$rapyd$_Index100];
                                    var _$rapyd$_Iter101 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index101 = 0; _$rapyd$_Index101 < _$rapyd$_Iter101.length; _$rapyd$_Index101++) {
                                        auto_bind = _$rapyd$_Iter101[_$rapyd$_Index101];
                                        co = OutputStream({
                                            beautify: beautify,
                                            auto_bind: auto_bind,
                                            private_scope: false,
            ...
            DEFPRINT(AST_Imports, function(container, output) {
                ...
                var _$rapyd$_Iter102 = _$rapyd$_Iterable(container.imports);
                for (var _$rapyd$_Index102 = 0; _$rapyd$_Index102 < _$rapyd$_Iter102.length; _$rapyd$_Index102++) {
                    self = _$rapyd$_Iter102[_$rapyd$_Index102];
                    output.import(self.module);
                    if (self.argnames) {
                        var _$rapyd$_Iter103 = _$rapyd$_Iterable(self.argnames);
                        for (var _$rapyd$_Index103 = 0; _$rapyd$_Index103 < _$rapyd$_Iter103.length; _$rapyd$_Index103++) {
                            argname = _$rapyd$_Iter103[_$rapyd$_Index103];
    ...
    (function(){
        ...
        if (typeof exports === "object") {
            ...
            var _$rapyd$_Iter172 = _$rapyd$_Iterable(ast);
            for (var _$rapyd$_Index172 = 0; _$rapyd$_Index172 < _$rapyd$_Iter172.length; _$rapyd$_Index172++) {
                ast_node = _$rapyd$_Iter172[_$rapyd$_Index172];
