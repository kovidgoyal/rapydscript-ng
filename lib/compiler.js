(function(){
        ...
        AST_Lambda = DEFNODE("Lambda", "name argnames uses_arguments decorators", {
            ...
            _walk: function(visitor) {
                ...
                return visitor._visit(node, function() {
                    var d;
                    if (node.decorators) {
                        var _$rapyd$_Iter9 = _$rapyd$_Iterable(node.decorators);
                        for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                            d = _$rapyd$_Iter9[_$rapyd$_Index9];
                            d.walk(visitor);
                        }
                    }
                    if (node.name) {
        ...
        AST_Class = DEFNODE("Class", "init name parent static external bound decorators module_id statements", {
            ...
            _walk: function(visitor) {
                ...
                return visitor._visit(node, function() {
                    var d;
                    if (node.decorators) {
                        var _$rapyd$_Iter10 = _$rapyd$_Iterable(node.decorators);
                        for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
                            d = _$rapyd$_Iter10[_$rapyd$_Index10];
                            d.walk(visitor);
                        }
                    }
                    node.name._walk(visitor);
        ...
        AST_Except = DEFNODE("Except", "argname errors", {
            ...
            _walk: function(visitor) {
                ...
                return visitor._visit(this, function() {
                    ...
                    if (node.errors) {
                        var _$rapyd$_Iter11 = _$rapyd$_Iterable(node.errors);
                        for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                            e = _$rapyd$_Iter11[_$rapyd$_Index11];
                            e.walk(visitor);
                        }
                    }
                    walk_body(node, visitor);
    ...
    (function(){
        ...
        COMPILER_VERSION = "bcdb98ab5319e81028a817a850cbcad289902d2c";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            if (options.classes) {
                var _$rapyd$_Iter24 = _$rapyd$_Iterable(options.classes);
                for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
                    cname = _$rapyd$_Iter24[_$rapyd$_Index24];
                ...
                if (Array.isArray(body)) {
                    for (name in body) {
                        ...
                        if (obj instanceof AST_Function || obj instanceof AST_Class) {
                            ...
                            var _$rapyd$_Iter25 = _$rapyd$_Iterable([ "body", "alternative" ]);
                            for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                                x = _$rapyd$_Iter25[_$rapyd$_Index25];
                                opt = obj[x];
                                if (opt) {
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter26 = _$rapyd$_Iterable(enumerate([ base_path + ".pyj", base_path + "/__init__.pyj" ]));
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter27 = _$rapyd$_Iterable([ options.basedir, options.libdir ]);
            ...
            function_ = function(in_class, ctor) {
                ...
                nonlocals.forEach(function(variable) {
                    var i;
                    var _$rapyd$_Iter34 = _$rapyd$_Iterable(dir(definition.localvars).reverse());
                    for (var _$rapyd$_Index34 = 0; _$rapyd$_Index34 < _$rapyd$_Iter34.length; _$rapyd$_Index34++) {
                        i = _$rapyd$_Iter34[_$rapyd$_Index34];
            ...
            function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
                ...
                if (func_call) {
                    tmp = [];
                    tmp.kwargs = [];
                    var _$rapyd$_Iter35 = _$rapyd$_Iterable(enumerate(a));
                    for (var _$rapyd$_Index35 = 0; _$rapyd$_Index35 < _$rapyd$_Iter35.length; _$rapyd$_Index35++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter35[_$rapyd$_Index35];
                        i = _$rapyd$_Unpack[0];
                ...
                if (allow_calls && is_("punc", "(") && !S.token.nlb) {
                    ...
                    if (expr instanceof AST_SymbolRef && expr.name === "JS") {
                        ...
                        if (c) {
                            ...
                            tmp_ = expr.name;
                            if (tmp_ === "abs" || tmp_ === "bind" || tmp_ === "rebind_all" || tmp_ === "dir" || tmp_ === "enumerate" || tmp_ === "mixin" || tmp_ === "print" || tmp_ === "range" || tmp_ === "reversed" || tmp_ === "sum" || tmp_ === "getattr" || tmp_ === "setattr" || tmp_ === "hasattr") {
                                ...
                                S.in_parenthesized_expr = false;
                                return ret;
                            } else if (tmp_ === "symbolfor" || tmp_ === "len") {
                                baselib_items[tmp_ + "()"] = true;
                            }
                        }
                        ret = subscripts(new AST_Call({
    ...
    (function(){
        ...
        function OutputStream(options) {
            ...
            function spaced() {
                ...
                var _$rapyd$_Iter89 = _$rapyd$_Iterable(enumerate(arguments));
                for (var _$rapyd$_Index89 = 0; _$rapyd$_Index89 < _$rapyd$_Iter89.length; _$rapyd$_Index89++) {
                    _$rapyd$_Unpack = _$rapyd$_Iter89[_$rapyd$_Index89];
                    i = _$rapyd$_Unpack[0];
                    x = _$rapyd$_Unpack[1];
                    if (i > 0) {
                        space();
            ...
            function prologue(module_) {
                ...
                if (!options.omit_baselib) {
                    var _$rapyd$_Iter90 = _$rapyd$_Iterable(module_.baselib);
                    for (var _$rapyd$_Index90 = 0; _$rapyd$_Index90 < _$rapyd$_Iter90.length; _$rapyd$_Index90++) {
                        lib = _$rapyd$_Iter90[_$rapyd$_Index90];
                        dump_baselib(lib);
                    }
                }
            }
        ...
        function codegen() {
            ...
            function write_imports(module, output) {
                ...
                imports = [];
                var _$rapyd$_Iter91 = _$rapyd$_Iterable(Object.keys(module.imports));
                for (var _$rapyd$_Index91 = 0; _$rapyd$_Index91 < _$rapyd$_Iter91.length; _$rapyd$_Index91++) {
                    import_id = _$rapyd$_Iter91[_$rapyd$_Index91];
                ...
                for (var _$rapyd$_Index92 = 0; _$rapyd$_Index92 < _$rapyd$_Iter92.length; _$rapyd$_Index92++) {
                    ...
                    var _$rapyd$_Iter93 = _$rapyd$_Iterable(module_.nonlocalvars);
                    for (var _$rapyd$_Index93 = 0; _$rapyd$_Index93 < _$rapyd$_Iter93.length; _$rapyd$_Index93++) {
                        name = _$rapyd$_Iter93[_$rapyd$_Index93];
                ...
                var _$rapyd$_Iter94 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index94 = 0; _$rapyd$_Index94 < _$rapyd$_Iter94.length; _$rapyd$_Index94++) {
                    module_ = _$rapyd$_Iter94[_$rapyd$_Index94];
                ...
                var _$rapyd$_Iter95 = _$rapyd$_Iterable(imports);
                for (var _$rapyd$_Index95 = 0; _$rapyd$_Index95 < _$rapyd$_Iter95.length; _$rapyd$_Index95++) {
                    module_ = _$rapyd$_Iter95[_$rapyd$_Index95];
                    if (module_.module_id !== "__main__") {
                ...
                if (node instanceof AST_Scope) {
                    if (node.argnames) {
                        if (node.argnames.is_simple_func !== true) {
                            ...
                            var _$rapyd$_Iter96 = _$rapyd$_Iterable(enumerate(a));
                            for (var _$rapyd$_Index96 = 0; _$rapyd$_Index96 < _$rapyd$_Iter96.length; _$rapyd$_Index96++) {
                                _$rapyd$_Unpack = _$rapyd$_Iter96[_$rapyd$_Index96];
                                c = _$rapyd$_Unpack[0];
                                arg = _$rapyd$_Unpack[1];
                                i = c - offset;
                                if (i >= 0) {
                            ...
                            if (a.kwargs || a.has_defaults) {
                                ...
                                output.end_statement();
                                if (a.has_defaults) {
                                    var _$rapyd$_Iter97 = _$rapyd$_Iterable(Object.keys(a.defaults));
                                    for (var _$rapyd$_Index97 = 0; _$rapyd$_Index97 < _$rapyd$_Iter97.length; _$rapyd$_Index97++) {
                                        dname = _$rapyd$_Iter97[_$rapyd$_Index97];
                                        output.indent();
            ...
            function declare_exports(module_id, exports, submodules, output) {
                var seen, symbol;
                seen = {};
                var _$rapyd$_Iter98 = _$rapyd$_Iterable(exports);
                for (var _$rapyd$_Index98 = 0; _$rapyd$_Index98 < _$rapyd$_Iter98.length; _$rapyd$_Index98++) {
                    symbol = _$rapyd$_Iter98[_$rapyd$_Index98];
            ...
            function declare_submodules(module_id, submodules, output) {
                ...
                seen = {};
                var _$rapyd$_Iter99 = _$rapyd$_Iterable(submodules);
                for (var _$rapyd$_Index99 = 0; _$rapyd$_Index99 < _$rapyd$_Iter99.length; _$rapyd$_Index99++) {
                    sub_module_id = _$rapyd$_Iter99[_$rapyd$_Index99];
                    ...
                    output.with_block(function() {
                        ...
                        if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                            ...
                            if (self.srchash && self.filename) {
                                ...
                                var _$rapyd$_Iter100 = _$rapyd$_Iterable(Object.keys(self.classes));
                                for (var _$rapyd$_Index100 = 0; _$rapyd$_Index100 < _$rapyd$_Iter100.length; _$rapyd$_Index100++) {
                                    cname = _$rapyd$_Iter100[_$rapyd$_Index100];
                                ...
                                var _$rapyd$_Iter101 = _$rapyd$_Iterable(self.exports);
                                for (var _$rapyd$_Index101 = 0; _$rapyd$_Index101 < _$rapyd$_Iter101.length; _$rapyd$_Index101++) {
                                    symdef = _$rapyd$_Iter101[_$rapyd$_Index101];
                                    cached.exports.push({
                                        name: symdef.name
                                    });
                                }
                                var _$rapyd$_Iter102 = _$rapyd$_Iterable([ true, false ]);
                                for (var _$rapyd$_Index102 = 0; _$rapyd$_Index102 < _$rapyd$_Iter102.length; _$rapyd$_Index102++) {
                                    beautify = _$rapyd$_Iter102[_$rapyd$_Index102];
                                    var _$rapyd$_Iter103 = _$rapyd$_Iterable([ true, false ]);
                                    for (var _$rapyd$_Index103 = 0; _$rapyd$_Index103 < _$rapyd$_Iter103.length; _$rapyd$_Index103++) {
                                        auto_bind = _$rapyd$_Iter103[_$rapyd$_Index103];
                                        co = OutputStream({
                                            beautify: beautify,
                                            auto_bind: auto_bind,
                                            private_scope: false,
            ...
            DEFPRINT(AST_Imports, function(container, output) {
                ...
                var _$rapyd$_Iter104 = _$rapyd$_Iterable(container.imports);
                for (var _$rapyd$_Index104 = 0; _$rapyd$_Index104 < _$rapyd$_Iter104.length; _$rapyd$_Index104++) {
                    self = _$rapyd$_Iter104[_$rapyd$_Index104];
                    output.import(self.module);
                    if (self.argnames) {
                        var _$rapyd$_Iter105 = _$rapyd$_Iterable(self.argnames);
                        for (var _$rapyd$_Index105 = 0; _$rapyd$_Index105 < _$rapyd$_Iter105.length; _$rapyd$_Index105++) {
                            argname = _$rapyd$_Iter105[_$rapyd$_Index105];
    ...
    (function(){
        ...
        if (typeof exports === "object") {
            ...
            var _$rapyd$_Iter174 = _$rapyd$_Iterable(ast);
            for (var _$rapyd$_Index174 = 0; _$rapyd$_Index174 < _$rapyd$_Iter174.length; _$rapyd$_Index174++) {
                ast_node = _$rapyd$_Iter174[_$rapyd$_Index174];
