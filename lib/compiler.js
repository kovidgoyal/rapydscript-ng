...
;
        ...
        AST_Function = DEFNODE("Function", "return_annotation", {
            ...
            "$propdoc": {
                "return_annotation": "[AST_Symbol?] The return type annotation provided (if any)"
            }
        }, AST_Lambda);
        ...
        AST_SymbolFunarg = DEFNODE("SymbolFunarg", "annotation", {
            "$documentation": "Symbol naming a function argument, possible with an annotation.",
            "$propdoc": {
                "annotation": "[AST_Symbol?] The annotation provided for this argument (if any)"
            }
        }, AST_SymbolVar);
...
;
    ...
    (function(){
        ...
        COMPILER_VERSION = "86ac626b886d92e5cb27a2c8157d7b65bbb3c4b5";
...
;
            ...
            function function_(in_class, is_expression) {
                var name, staticmethod, property_getter, property_setter, _$rapyd$_chain_assign_temp, staticloc, ctor, return_annotation, is_generator, definition, assignments, j, i, nonlocals;
...
;
                ...
                definition = new ctor({
                    ...
                    "argnames": function(a) {
                        ...
                        function get_arg() {
                            var name_token, name_ctx, annotation, sym;
                            ...
                            if ((peek().type === "punc" || typeof peek().type === "object" && _$rapyd$_equals(peek().type, "punc")) && (peek().value === ":" || typeof peek().value === "object" && _$rapyd$_equals(peek().value, ":"))) {
                                next();
                                expect(":");
                                annotation = expression(false, false);
                                ...
                                if (!is_("name")) {
                                    if ((S.input.context().tokline !== def_line && (typeof S.input.context().tokline !== "object" || _$rapyd$_not_equals(S.input.context().tokline, def_line)))) {
                        ...
                        if (is_("punc", "->")) {
                            next();
                            return_annotation = expression(false, false);
                        }
                        S.in_parenthesized_expr = false;
                        a.defaults = defaults;
...
;
    ...
    (function(){
        ...
        OutputStream.prototype.prologue = function prologue(module_) {
            var self = this;
            ...
            for (var _$rapyd$_Index54 = 0; _$rapyd$_Index54 < _$rapyd$_Iter54.length; _$rapyd$_Index54++) {
                ...
                if (self.options.js_version >= 6 && (lib === "iterable" || lib === "yield")) {
                    continue;
                }
                if (lib === "yield") {
                    self.dump_yield();
    ...
    (function(){
        ...
        function function_preamble(node, output, offset) {
            ...
            if (node.argnames) {
                if (node.argnames.is_simple_func !== true) {
                    ...
                    var _$rapyd$_Iter59 = _$rapyd$_Iterable(enumerate(a));
                    for (var _$rapyd$_Index59 = 0; _$rapyd$_Index59 < _$rapyd$_Iter59.length; _$rapyd$_Index59++) {
                        _$rapyd$_unpack = _$rapyd$_Iter59[_$rapyd$_Index59];
                        c = _$rapyd$_unpack[0];
                        arg = _$rapyd$_unpack[1];
                        i = c - offset;
                        if (i >= 0) {
                    ...
                    if (a.kwargs || a.has_defaults) {
                        ...
                        output.end_statement();
                        if (a.has_defaults) {
                            var _$rapyd$_Iter60 = _$rapyd$_Iterable(Object.keys(a.defaults));
                            for (var _$rapyd$_Index60 = 0; _$rapyd$_Index60 < _$rapyd$_Iter60.length; _$rapyd$_Index60++) {
                                dname = _$rapyd$_Iter60[_$rapyd$_Index60];
                                output.indent();
        ...
        function print_function(output, nokeyword) {
            var self;
            self = this;
        ...
        function print_class(output) {
            ...
            if (property_names.length) {
                ...
                output.with_parens(function() {
                    ...
                    output.with_block(function() {
                        var prop, name;
                        var _$rapyd$_Iter62 = _$rapyd$_Iterable(property_names);
...
;
    ...
    (function(){
        ...
        function write_imports(module, output) {
            ...
            imports = _$rapyd$_list_decorate([]);
            var _$rapyd$_Iter63 = _$rapyd$_Iterable(Object.keys(module.imports));
            for (var _$rapyd$_Index63 = 0; _$rapyd$_Index63 < _$rapyd$_Iter63.length; _$rapyd$_Index63++) {
                import_id = _$rapyd$_Iter63[_$rapyd$_Index63];
            ...
            for (var _$rapyd$_Index64 = 0; _$rapyd$_Index64 < _$rapyd$_Iter64.length; _$rapyd$_Index64++) {
                ...
                var _$rapyd$_Iter65 = _$rapyd$_Iterable(module_.nonlocalvars);
                for (var _$rapyd$_Index65 = 0; _$rapyd$_Index65 < _$rapyd$_Iter65.length; _$rapyd$_Index65++) {
                    name = _$rapyd$_Iter65[_$rapyd$_Index65];
            ...
            var _$rapyd$_Iter67 = _$rapyd$_Iterable(imports);
            for (var _$rapyd$_Index67 = 0; _$rapyd$_Index67 < _$rapyd$_Iter67.length; _$rapyd$_Index67++) {
                module_ = _$rapyd$_Iter67[_$rapyd$_Index67];
        ...
        function declare_exports(module_id, exports, submodules, output) {
            ...
            seen = {};
            output.newline();
            var _$rapyd$_Iter68 = _$rapyd$_Iterable(exports);
            for (var _$rapyd$_Index68 = 0; _$rapyd$_Index68 < _$rapyd$_Iter68.length; _$rapyd$_Index68++) {
                symbol = _$rapyd$_Iter68[_$rapyd$_Index68];
        ...
        function declare_submodules(module_id, submodules, output) {
            ...
            seen = {};
            var _$rapyd$_Iter69 = _$rapyd$_Iterable(submodules);
            for (var _$rapyd$_Index69 = 0; _$rapyd$_Index69 < _$rapyd$_Iter69.length; _$rapyd$_Index69++) {
                sub_module_id = _$rapyd$_Iter69[_$rapyd$_Index69];
