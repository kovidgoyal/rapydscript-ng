...
var list_wrap = _$rapyd$_list_decorate;
    ...
    (function(){
        ...
        function tokenizer($TEXT, filename) {
            ...
            function read_operator(prefix) {
                ...
                op = grow(prefix || next());
                if (_$rapyd$_in(op, _$rapyd$_list_decorate([ "++", "--", "===", "!==" ]))) {
    ...
    (function(){
        var __name__ = "parse";
        var COMPILER_VERSION, NATIVE_CLASSES, ERROR_CLASSES, COMMON_STATIC, UNARY_PREFIX, ASSIGNMENT, PRECEDENCE, STATEMENTS_WITH_LABELS, ATOMIC_START_TOKEN;
        var make_predicate = _$rapyd$_modules["utils"].make_predicate;
        ...
        COMPILER_VERSION = "7a63af7833ff8e237dc1dac270c1a27dee47ba19";
        NATIVE_CLASSES = {
            "Image": {},
            "RegExp": {},
            "Error": {},
        ...
        function parse($TEXT, options) {
            ...
            function scan_for_local_vars(body) {
                ...
                if (Array.isArray(body)) {
                    ...
                    for (var _$rapyd$_Index6 = 0; _$rapyd$_Index6 < _$rapyd$_Iter6.length; _$rapyd$_Index6++) {
                        ...
                        } else if (stmt instanceof AST_If && is_nested_comparison(stmt.condition)) {
                            push("_$rapyd$_Temp");
                        } else if (stmt instanceof AST_Exit && is_nested_comparison(stmt.value)) {
                            push("_$rapyd$_Temp");
                        }
                    }
                } else if (body.body) {
            ...
            function do_import(key) {
                ...
                function safe_read(base_path) {
                    ...
                    var _$rapyd$_Iter8 = _$rapyd$_Iterable(enumerate(_$rapyd$_list_decorate([ base_path + ".pyj", base_path + "/__init__.pyj" ])));
                ...
                modpath = key.replace(".", "/");
                var _$rapyd$_Iter9 = _$rapyd$_Iterable(_$rapyd$_list_decorate([ options.basedir, options.libdir ]));
                for (var _$rapyd$_Index9 = 0; _$rapyd$_Index9 < _$rapyd$_Iter9.length; _$rapyd$_Index9++) {
                    location = _$rapyd$_Iter9[_$rapyd$_Index9];
                    if (location) {
                ...
                if (cached && cached["version"] === COMPILER_VERSION && cached["signature"] === srchash) {
                    var _$rapyd$_Iter10 = _$rapyd$_Iterable(cached.imported_module_ids);
                    for (var _$rapyd$_Index10 = 0; _$rapyd$_Index10 < _$rapyd$_Iter10.length; _$rapyd$_Index10++) {
                        ikey = _$rapyd$_Iter10[_$rapyd$_Index10];
                        do_import(ikey);
                    }
                    IMPORTED[key] = {
                        "is_cached": true,
                ...
                var _$rapyd$_Iter11 = _$rapyd$_Iterable(Object.keys(IMPORTED[key].baselib));
                for (var _$rapyd$_Index11 = 0; _$rapyd$_Index11 < _$rapyd$_Iter11.length; _$rapyd$_Index11++) {
                    bitem = _$rapyd$_Iter11[_$rapyd$_Index11];
            ...
            import_ = function(from_import) {
                ...
                var _$rapyd$_Iter12 = _$rapyd$_Iterable(ans["imports"]);
                for (var _$rapyd$_Index12 = 0; _$rapyd$_Index12 < _$rapyd$_Iter12.length; _$rapyd$_Index12++) {
                    imp = _$rapyd$_Iter12[_$rapyd$_Index12];
                    do_import(imp.key);
                    ...
                    if (from_import) {
                        ...
                        exports = {};
                        var _$rapyd$_Iter13 = _$rapyd$_Iterable(IMPORTED[key].exports);
                        ...
                        var _$rapyd$_Iter14 = _$rapyd$_Iterable(argnames);
                        for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                            argvar = _$rapyd$_Iter14[_$rapyd$_Index14];
                        ...
                        var _$rapyd$_Iter15 = _$rapyd$_Iterable(Object.keys(classes));
            ...
            class_ = function() {
                ...
                var _$rapyd$_Iter16 = _$rapyd$_Iterable(definition.body);
                ...
                visitor = new walker();
                var _$rapyd$_Iter17 = _$rapyd$_Iterable(definition.body);
                ...
                if (allow_calls && is_("punc", "(") && !S.token.nlb) {
                    ...
                    if (expr instanceof AST_SymbolRef && expr.name === "JS") {
                        ...
                        if (c) {
                            ...
                            tmp_ = expr.name;
                            if (tmp_ === "bind" || tmp_ === "rebind_all" || tmp_ === "dir" || tmp_ === "enumerate" || tmp_ === "mixin" || tmp_ === "print" || tmp_ === "range" || tmp_ === "reversed" || tmp_ === "getattr" || tmp_ === "setattr" || tmp_ === "hasattr" || tmp_ === "iter") {
                                ...
                                S.in_parenthesized_expr = false;
                                return ret;
                            } else if (tmp_ === "len" || tmp_ === "abs" || tmp_ === "max" || tmp_ === "min") {
                                baselib_items[tmp_ + "()"] = true;
                            } else if (tmp_ === "sum" || tmp_ === "map" || tmp_ === "zip" || tmp_ === "filter") {
