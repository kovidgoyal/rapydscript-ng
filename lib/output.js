...
function OutputStream(options) {
    ...
    function spaced() {
        ...
        var _$rapyd$_Iter15 = _$rapyd$_Iterable(enumerate(arguments));
    ...
    function prologue(module_) {
        ...
        if (!options.omit_baselib) {
            var _$rapyd$_Iter16 = _$rapyd$_Iterable(module_.baselib);
            for (var _$rapyd$_Index16 = 0; _$rapyd$_Index16 < _$rapyd$_Iter16.length; _$rapyd$_Index16++) {
                lib = _$rapyd$_Iter16[_$rapyd$_Index16];
                dump_baselib(lib);
            }
        }
    }
...
(function() {
    ...
    function write_imports(module, output) {
        ...
        imports = [];
        var _$rapyd$_Iter17 = _$rapyd$_Iterable(Object.keys(module.imports));
        for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
            import_id = _$rapyd$_Iter17[_$rapyd$_Index17];
        ...
        nonlocalvars = {};
        var _$rapyd$_Iter18 = _$rapyd$_Iterable(imports);
        for (var _$rapyd$_Index18 = 0; _$rapyd$_Index18 < _$rapyd$_Iter18.length; _$rapyd$_Index18++) {
            module_ = _$rapyd$_Iter18[_$rapyd$_Index18];
            var _$rapyd$_Iter19 = _$rapyd$_Iterable(module_.nonlocalvars);
            for (var _$rapyd$_Index19 = 0; _$rapyd$_Index19 < _$rapyd$_Iter19.length; _$rapyd$_Index19++) {
                name = _$rapyd$_Iter19[_$rapyd$_Index19];
        ...
        if (node instanceof AST_Scope) {
            if (node.argnames) {
                if (node.argnames.is_simple_func !== true) {
                    ...
                    var _$rapyd$_Iter22 = _$rapyd$_Iterable(enumerate(a));
                    for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter22[_$rapyd$_Index22];
                        c = _$rapyd$_Unpack[0];
                    ...
                    if (a.kwargs || a.has_defaults) {
                        ...
                        output.end_statement();
                        if (a.has_defaults) {
                            var _$rapyd$_Iter23 = _$rapyd$_Iterable(Object.keys(a.defaults));
                            for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
                                dname = _$rapyd$_Iter23[_$rapyd$_Index23];
                                output.indent();
    ...
    function declare_exports(module_id, exports, submodules, output) {
        var seen, symbol;
        seen = {};
        var _$rapyd$_Iter24 = _$rapyd$_Iterable(exports);
        for (var _$rapyd$_Index24 = 0; _$rapyd$_Index24 < _$rapyd$_Iter24.length; _$rapyd$_Index24++) {
            symbol = _$rapyd$_Iter24[_$rapyd$_Index24];
    ...
    function declare_submodules(module_id, submodules, output) {
        ...
        seen = {};
        var _$rapyd$_Iter25 = _$rapyd$_Iterable(submodules);
        for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
            sub_module_id = _$rapyd$_Iter25[_$rapyd$_Index25];
    ...
    function print_module(self, output) {
        ...
        output.with_parens(function() {
            output.print("function()");
            output.with_block(function() {
                var okey, cached, cobj, cname, co, raw, auto_bind, beautify;
                if (output.option("write_name")) {
                    output.indent();
                    output.print("var ");
                ...
                if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                    ...
                    if (self.srchash && self.filename) {
                        ...
                        var _$rapyd$_Iter26 = _$rapyd$_Iterable(Object.keys(self.classes));
                        ...
                        var _$rapyd$_Iter27 = _$rapyd$_Iterable([ true, false ]);
                        for (var _$rapyd$_Index27 = 0; _$rapyd$_Index27 < _$rapyd$_Iter27.length; _$rapyd$_Index27++) {
                            beautify = _$rapyd$_Iter27[_$rapyd$_Index27];
                            var _$rapyd$_Iter28 = _$rapyd$_Iterable([ true, false ]);
                            for (var _$rapyd$_Index28 = 0; _$rapyd$_Index28 < _$rapyd$_Iter28.length; _$rapyd$_Index28++) {
                                auto_bind = _$rapyd$_Iter28[_$rapyd$_Index28];
                                co = OutputStream({
                                    beautify: beautify,
                                    auto_bind: auto_bind,
                                    private_scope: false,
