...
function OutputStream(options) {
    ...
    function spaced() {
        ...
        var _$rapyd$_Iter13 = _$rapyd$_Iterable(enumerate(arguments));
    ...
    function prologue(module_) {
        ...
        if (!options.omit_baselib) {
            var _$rapyd$_Iter14 = _$rapyd$_Iterable(module_.baselib);
            for (var _$rapyd$_Index14 = 0; _$rapyd$_Index14 < _$rapyd$_Iter14.length; _$rapyd$_Index14++) {
                lib = _$rapyd$_Iter14[_$rapyd$_Index14];
                dump_baselib(lib);
            }
        }
    }
...
(function() {
    ...
    function write_imports(module, output) {
        ...
        imports = [];
        var _$rapyd$_Iter15 = _$rapyd$_Iterable(Object.keys(module.imports));
        for (var _$rapyd$_Index15 = 0; _$rapyd$_Index15 < _$rapyd$_Iter15.length; _$rapyd$_Index15++) {
            import_id = _$rapyd$_Iter15[_$rapyd$_Index15];
        ...
        nonlocalvars = {};
        var _$rapyd$_Iter16 = _$rapyd$_Iterable(imports);
        for (var _$rapyd$_Index16 = 0; _$rapyd$_Index16 < _$rapyd$_Iter16.length; _$rapyd$_Index16++) {
            module_ = _$rapyd$_Iter16[_$rapyd$_Index16];
            var _$rapyd$_Iter17 = _$rapyd$_Iterable(module_.nonlocalvars);
            for (var _$rapyd$_Index17 = 0; _$rapyd$_Index17 < _$rapyd$_Iter17.length; _$rapyd$_Index17++) {
                name = _$rapyd$_Iter17[_$rapyd$_Index17];
        ...
        if (node instanceof AST_Scope) {
            if (node.argnames) {
                if (node.argnames.is_simple_func !== true) {
                    ...
                    var _$rapyd$_Iter20 = _$rapyd$_Iterable(enumerate(a));
                    for (var _$rapyd$_Index20 = 0; _$rapyd$_Index20 < _$rapyd$_Iter20.length; _$rapyd$_Index20++) {
                        _$rapyd$_Unpack = _$rapyd$_Iter20[_$rapyd$_Index20];
                        c = _$rapyd$_Unpack[0];
                    ...
                    if (a.kwargs || a.has_defaults) {
                        ...
                        output.end_statement();
                        if (a.has_defaults) {
                            var _$rapyd$_Iter21 = _$rapyd$_Iterable(Object.keys(a.defaults));
                            for (var _$rapyd$_Index21 = 0; _$rapyd$_Index21 < _$rapyd$_Iter21.length; _$rapyd$_Index21++) {
                                dname = _$rapyd$_Iter21[_$rapyd$_Index21];
                                output.indent();
    ...
    function declare_exports(module_id, exports, submodules, output) {
        var seen, symbol;
        seen = {};
        var _$rapyd$_Iter22 = _$rapyd$_Iterable(exports);
        for (var _$rapyd$_Index22 = 0; _$rapyd$_Index22 < _$rapyd$_Iter22.length; _$rapyd$_Index22++) {
            symbol = _$rapyd$_Iter22[_$rapyd$_Index22];
    ...
    function declare_submodules(module_id, submodules, output) {
        ...
        seen = {};
        var _$rapyd$_Iter23 = _$rapyd$_Iterable(submodules);
        for (var _$rapyd$_Index23 = 0; _$rapyd$_Index23 < _$rapyd$_Iter23.length; _$rapyd$_Index23++) {
            sub_module_id = _$rapyd$_Iter23[_$rapyd$_Index23];
            ...
            output.with_block(function() {
                ...
                if (self.is_cached && _$rapyd$_in(okey, self.outputs)) {
                    ...
                    if (self.srchash && self.filename) {
                        ...
                        var _$rapyd$_Iter24 = _$rapyd$_Iterable(Object.keys(self.classes));
                        ...
                        var _$rapyd$_Iter25 = _$rapyd$_Iterable([ true, false ]);
                        for (var _$rapyd$_Index25 = 0; _$rapyd$_Index25 < _$rapyd$_Iter25.length; _$rapyd$_Index25++) {
                            beautify = _$rapyd$_Iter25[_$rapyd$_Index25];
                            var _$rapyd$_Iter26 = _$rapyd$_Iterable([ true, false ]);
                            for (var _$rapyd$_Index26 = 0; _$rapyd$_Index26 < _$rapyd$_Iter26.length; _$rapyd$_Index26++) {
                                auto_bind = _$rapyd$_Iter26[_$rapyd$_Index26];
                                co = OutputStream({
                                    beautify: beautify,
                                    auto_bind: auto_bind,
                                    private_scope: false,
