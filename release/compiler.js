            ...
            for (var ρσ_Index10 of ρσ_Iter10) {
                ...
                if (Array.isArray(self[(typeof key === "number" && key < 0) ? self.length + key : key])) {
                    if (self[(typeof key === "number" && key < 0) ? self.length + key : key].length) {
                        ...
                        if (depth > 1) {
                            var ρσ_Iter11 = self[(typeof key === "number" && key < 0) ? self.length + key : key];
...
return this.__repr__();
        ...
        function AST_ArgsDef() {
            if (this.ρσ_object_id === undefined) Object.defineProperty(this, "ρσ_object_id", {"value":++ρσ_object_counter});
            AST_ArgsDef.prototype.__init__.apply(this, arguments);
        }
        ρσ_extends(AST_ArgsDef, AST_Node);
        AST_ArgsDef.prototype.__init__ = function __init__ () {
            AST_Node.prototype.__init__ && AST_Node.prototype.__init__.apply(this, arguments);
        };
        AST_ArgsDef.prototype._walk = function _walk(visitor) {
            var self = this;
            return visitor._visit(self, (function() {
                var ρσ_anonfunc = function () {
                    var arg;
                    var ρσ_Iter18 = self.args;
        ...
        if (!AST_ArgsDef.prototype._walk.__argnames__) Object.defineProperties(AST_ArgsDef.prototype._walk, {
            __argnames__ : {value: ["visitor"]},
            __module__ : {value: "ast"}
        });
        AST_ArgsDef.prototype.__repr__ = function __repr__ () {
            if(AST_Node.prototype.__repr__) return AST_Node.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        AST_ArgsDef.prototype.__str__ = function __str__ () {
            if(AST_Node.prototype.__str__) return AST_Node.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(AST_ArgsDef.prototype, "__bases__", {value: [AST_Node]});
        AST_ArgsDef.prototype.properties = (function(){
            var ρσ_d = Object.create(null);
            ρσ_d["args"] = "[AST_SymbolFunarg*] formal positional parameters";
            ρσ_d["starargs"] = "[AST_SymbolFunarg?] *args parameter, or None";
            ρσ_d["kwargs"] = "[AST_SymbolFunarg?] **kwargs parameter, or None";
            ρσ_d["defaults"] = "[Object] map of parameter name to default value expression";
            ρσ_d["has_defaults"] = "[bool] True if any parameter has a default value";
            ρσ_d["is_simple_func"] = "[bool] True if no starargs, no kwargs, and no defaults";
            return ρσ_d;
        }).call(this);
...
return this.__repr__();
        ...
        AST_Lambda.prototype.properties = (function(){
            ...
            ρσ_d["argnames"] = "[AST_ArgsDef] the function argument definitions";
...
return this.__repr__();
        ...
        AST_Definitions.prototype._walk = function _walk(visitor) {
            ...
            return visitor._visit(self, (function() {
                var ρσ_anonfunc = function () {
                    var def_;
                    var ρσ_Iter22 = self.definitions;
...
return this.__repr__();
        ...
        function AST_CallArg() {
            if (this.ρσ_object_id === undefined) Object.defineProperty(this, "ρσ_object_id", {"value":++ρσ_object_counter});
            AST_CallArg.prototype.__init__.apply(this, arguments);
        }
        ρσ_extends(AST_CallArg, AST_Node);
        AST_CallArg.prototype.__init__ = function __init__ () {
            AST_Node.prototype.__init__ && AST_Node.prototype.__init__.apply(this, arguments);
        };
        AST_CallArg.prototype._walk = function _walk(visitor) {
            var self = this;
            return visitor._visit(self, (function() {
                var ρσ_anonfunc = function () {
                    self.value._walk(visitor);
        ...
        if (!AST_CallArg.prototype._walk.__argnames__) Object.defineProperties(AST_CallArg.prototype._walk, {
            __argnames__ : {value: ["visitor"]},
            __module__ : {value: "ast"}
        });
        AST_CallArg.prototype.__repr__ = function __repr__ () {
            if(AST_Node.prototype.__repr__) return AST_Node.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        AST_CallArg.prototype.__str__ = function __str__ () {
            if(AST_Node.prototype.__str__) return AST_Node.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(AST_CallArg.prototype, "__bases__", {value: [AST_Node]});
        AST_CallArg.prototype.properties = (function(){
            var ρσ_d = Object.create(null);
            ρσ_d["value"] = "[AST_Node] the argument expression";
            ρσ_d["is_array"] = "[bool] True if this is a *arg (already an array/iterable)";
            return ρσ_d;
        }).call(this);

        function AST_CallArgs() {
            if (this.ρσ_object_id === undefined) Object.defineProperty(this, "ρσ_object_id", {"value":++ρσ_object_counter});
            AST_CallArgs.prototype.__init__.apply(this, arguments);
        }
        ρσ_extends(AST_CallArgs, AST_Node);
        AST_CallArgs.prototype.__init__ = function __init__ () {
            AST_Node.prototype.__init__ && AST_Node.prototype.__init__.apply(this, arguments);
        };
        AST_CallArgs.prototype._walk = function _walk(visitor) {
            var self = this;
            return visitor._visit(self, (function() {
                var ρσ_anonfunc = function () {
                    var arg, pair;
                    ...
                    if (self.kwarg_items) {
                        var ρσ_Iter25 = self.kwarg_items;
        ...
        if (!AST_CallArgs.prototype._walk.__argnames__) Object.defineProperties(AST_CallArgs.prototype._walk, {
            __argnames__ : {value: ["visitor"]},
            __module__ : {value: "ast"}
        });
        AST_CallArgs.prototype.__repr__ = function __repr__ () {
            if(AST_Node.prototype.__repr__) return AST_Node.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        AST_CallArgs.prototype.__str__ = function __str__ () {
            if(AST_Node.prototype.__str__) return AST_Node.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(AST_CallArgs.prototype, "__bases__", {value: [AST_Node]});
        AST_CallArgs.prototype.properties = (function(){
            var ρσ_d = Object.create(null);
            ρσ_d["args"] = "[AST_CallArg*] positional arguments";
            ρσ_d["kwargs"] = "[pair*] keyword argument pairs [key_node, value_node]";
            ρσ_d["kwarg_items"] = "[AST_SymbolRef*] **kwargs symbol references";
            ρσ_d["starargs"] = "[bool] True if *args were used in this call";
            return ρσ_d;
        }).call(this);
...
return this.__repr__();
        ...
        AST_BaseCall.prototype.properties = (function(){
            var ρσ_d = Object.create(null);
            ρσ_d["args"] = "[AST_CallArgs] the function call argument list";
            return ρσ_d;
        }).call(this);
...
return this.__repr__();
        ...
        AST_Seq.prototype.from_array = function from_array(array) {
            ...
            ans = null;
            for (var ρσ_Index26 = array.length - 1; ρσ_Index26 > -1; ρσ_Index26-=1) {
                i = ρσ_Index26;
...
return this.__repr__();
        ...
        TreeWalker.prototype.find_parent = function find_parent(type) {
            ...
            var stack, x, i;
            stack = self.stack;
            for (var ρσ_Index31 = stack.length - 1; ρσ_Index31 > -1; ρσ_Index31-=1) {
                i = ρσ_Index31;
...
return this.__repr__();
        ...
        ρσ_modules.ast.AST_ArgsDef = AST_ArgsDef;
        ...
        ρσ_modules.ast.AST_CallArg = AST_CallArg;
        ρσ_modules.ast.AST_CallArgs = AST_CallArgs;
    ...
    (function(){
        ...
        function is_simple_for_in(self) {
            if (is_node_type(self.object, AST_BaseCall) && is_node_type(self.object.expression, AST_SymbolRef) && self.object.expression.name === "dir" && self.object.args.args.length === 1) {
                return true;
            }
            return false;
        };
        ...
        function is_simple_for(self) {
            ...
            if (is_node_type(self.object, AST_BaseCall) && is_node_type(self.object.expression, AST_SymbolRef) && self.object.expression.name === "range" && !(is_node_type(self.init, AST_Array))) {
                ...
                l = a.length;
                if (l < 3 || is_node_type(a[2].value, AST_Number) || is_node_type(a[2].value, AST_Unary) && a[2].value.operator === "-" && is_node_type(a[2].value.expression, AST_Number)) {
                    if (l === 1 && !has_calls(a[0].value) || l > 1 && !has_calls(a[1].value)) {
                        return true;
                    }
                }
            }
...
ρσ_unpack = ρσ_unpack_asarray(2, ρσ_unpack);
    ...
    (function(){
        ...
        function function_annotation(self, output, strip_first, name) {
                        ...
                        if (self.argnames && self.argnames.args.length) {
                            ...
                            for (var ρσ_Index57 of ρσ_Iter57) {
                                ...
                                if (arg.annotation) {
                                    ...
                                    if (i < self.argnames.args.length - 1 || self.return_annotation) {
                                        output.comma();
                                    }
                                }
                            }
            ...
            if (self.argnames.args.length > ((strip_first) ? 1 : 0)) {
        ...
        function print_function_call(self, output) {
            ...
            function print_positional_args() {
                var i, pargs, expr, is_first;
                i = 0;
                pargs = self.args.args;
                while (i < pargs.length) {
                    expr = pargs[(typeof i === "number" && i < 0) ? pargs.length + i : i];
                    is_first = i === 0;
                    if (!is_first) {
                        output.print(".concat(");
                    }
                    if (expr.is_array) {
                        ...
                        output.print("[");
                        while (i < pargs.length && !pargs[(typeof i === "number" && i < 0) ? pargs.length + i : i].is_array) {
                            pargs[(typeof i === "number" && i < 0) ? pargs.length + i : i].value.print(output);
                            if (i + 1 < pargs.length && !pargs[ρσ_bound_index(i + 1, pargs)].is_array) {
                                output.print(",");
                                output.space();
                            }
                            i += 1;
            ...
            is_repeatable = true;
            if (is_new && !self.args.args.length && !has_kwargs && !self.args.starargs) {
            ...
            if (is_prototype_call && self.args.args.length > 1) {
            ...
            if (!defined_methods["__repr__"]) {
                define_default_method("__repr__", (function() {
                    var ρσ_anonfunc = function () {
                        ...
                        output.indent();
                        output.spaced("return", "\"<\"", "+", "__name__", "+", "\".\"", "+", "this.constructor.name", "");
        ...
        function declare_exports(module_id, exports, output, docstrings) {
            ...
            for (var ρσ_Index75 of ρσ_Iter75) {
                ...
                if (!Object.prototype.hasOwnProperty.call(seen, symbol.name)) {
                    ...
                    [output.space(), output.print("=")];
                    [output.space(), output.print(symbol.refname || symbol.name)];
    ...
    (function(){
        ...
        UNICODE = (function(){
            var ρσ_d = Object.create(null);
            ρσ_d["letter"] = new RegExp("[\\u0041-\\u005A\\u0061-\\u007A\\u00AA\\u00B5\\u00BA\\u00C0-\\u00D" + "6\\u00D8-\\u00F6\\u00F8-\\u02C1\\u02C6-\\u02D1\\u02E0-\\u02E4\\u02E" + "C\\u02EE\\u0370-\\u0374\\u0376\\u0377\\u037A-\\u037D\\u0386\\u038" + "8-\\u038A\\u038C\\u038E-\\u03A1\\u03A3-\\u03F5\\u03F7-\\u0481\\u048" + "A-\\u0523\\u0531-\\u0556\\u0559\\u0561-\\u0587\\u05D0-\\u05EA\\u05F" + "0-\\u05F2\\u0621-\\u064A\\u066E\\u066F\\u0671-\\u06D3\\u06D5\\u06E" + "5\\u06E6\\u06EE\\u06EF\\u06FA-\\u06FC\\u06FF\\u0710\\u0712-\\u072" + "F\\u074D-\\u07A5\\u07B1\\u07CA-\\u07EA\\u07F4\\u07F5\\u07FA\\u090" + "4-\\u0939\\u093D\\u0950\\u0958-\\u0961\\u0971\\u0972\\u097B-\\u097" + "F\\u0985-\\u098C\\u098F\\u0990\\u0993-\\u09A8\\u09AA-\\u09B0\\u09B" + "2\\u09B6-\\u09B9\\u09BD\\u09CE\\u09DC\\u09DD\\u09DF-\\u09E1\\u09F" + "0\\u09F1\\u0A05-\\u0A0A\\u0A0F\\u0A10\\u0A13-\\u0A28\\u0A2A-\\u0A3" + "0\\u0A32\\u0A33\\u0A35\\u0A36\\u0A38\\u0A39\\u0A59-\\u0A5C\\u0A5" + "E\\u0A72-\\u0A74\\u0A85-\\u0A8D\\u0A8F-\\u0A91\\u0A93-\\u0AA8\\u0AA" + "A-\\u0AB0\\u0AB2\\u0AB3\\u0AB5-\\u0AB9\\u0ABD\\u0AD0\\u0AE0\\u0AE" + "1\\u0B05-\\u0B0C\\u0B0F\\u0B10\\u0B13-\\u0B28\\u0B2A-\\u0B30\\u0B3" + "2\\u0B33\\u0B35-\\u0B39\\u0B3D\\u0B5C\\u0B5D\\u0B5F-\\u0B61\\u0B7" + "1\\u0B83\\u0B85-\\u0B8A\\u0B8E-\\u0B90\\u0B92-\\u0B95\\u0B99\\u0B9" + "A\\u0B9C\\u0B9E\\u0B9F\\u0BA3\\u0BA4\\u0BA8-\\u0BAA\\u0BAE-\\u0BB" + "9\\u0BD0\\u0C05-\\u0C0C\\u0C0E-\\u0C10\\u0C12-\\u0C28\\u0C2A-\\u0C3" + "3\\u0C35-\\u0C39\\u0C3D\\u0C58\\u0C59\\u0C60\\u0C61\\u0C85-\\u0C8" + "C\\u0C8E-\\u0C90\\u0C92-\\u0CA8\\u0CAA-\\u0CB3\\u0CB5-\\u0CB9\\u0CB" + "D\\u0CDE\\u0CE0\\u0CE1\\u0D05-\\u0D0C\\u0D0E-\\u0D10\\u0D12-\\u0D2" + "8\\u0D2A-\\u0D39\\u0D3D\\u0D60\\u0D61\\u0D7A-\\u0D7F\\u0D85-\\u0D9" + "6\\u0D9A-\\u0DB1\\u0DB3-\\u0DBB\\u0DBD\\u0DC0-\\u0DC6\\u0E01-\\u0E3" + "0\\u0E32\\u0E33\\u0E40-\\u0E46\\u0E81\\u0E82\\u0E84\\u0E87\\u0E8" + "8\\u0E8A\\u0E8D\\u0E94-\\u0E97\\u0E99-\\u0E9F\\u0EA1-\\u0EA3\\u0EA" + "5\\u0EA7\\u0EAA\\u0EAB\\u0EAD-\\u0EB0\\u0EB2\\u0EB3\\u0EBD\\u0EC" + "0-\\u0EC4\\u0EC6\\u0EDC\\u0EDD\\u0F00\\u0F40-\\u0F47\\u0F49-\\u0F6" + "C\\u0F88-\\u0F8B\\u1000-\\u102A\\u103F\\u1050-\\u1055\\u105A-\\u105" + "D\\u1061\\u1065\\u1066\\u106E-\\u1070\\u1075-\\u1081\\u108E\\u10A" + "0-\\u10C5\\u10D0-\\u10FA\\u10FC\\u1100-\\u1159\\u115F-\\u11A2\\u11A" + "8-\\u11F9\\u1200-\\u1248\\u124A-\\u124D\\u1250-\\u1256\\u1258\\u125" + "A-\\u125D\\u1260-\\u1288\\u128A-\\u128D\\u1290-\\u12B0\\u12B2-\\u12B" + "5\\u12B8-\\u12BE\\u12C0\\u12C2-\\u12C5\\u12C8-\\u12D6\\u12D8-\\u131" + "0\\u1312-\\u1315\\u1318-\\u135A\\u1380-\\u138F\\u13A0-\\u13F4\\u140" + "1-\\u166C\\u166F-\\u1676\\u1681-\\u169A\\u16A0-\\u16EA\\u1700-\\u170" + "C\\u170E-\\u1711\\u1720-\\u1731\\u1740-\\u1751\\u1760-\\u176C\\u176" + "E-\\u1770\\u1780-\\u17B3\\u17D7\\u17DC\\u1820-\\u1877\\u1880-\\u18A" + "8\\u18AA\\u1900-\\u191C\\u1950-\\u196D\\u1970-\\u1974\\u1980-\\u19A" + "9\\u19C1-\\u19C7\\u1A00-\\u1A16\\u1B05-\\u1B33\\u1B45-\\u1B4B\\u1B8" + "3-\\u1BA0\\u1BAE\\u1BAF\\u1C00-\\u1C23\\u1C4D-\\u1C4F\\u1C5A-\\u1C7" + "D\\u1D00-\\u1DBF\\u1E00-\\u1F15\\u1F18-\\u1F1D\\u1F20-\\u1F45\\u1F4" + "8-\\u1F4D\\u1F50-\\u1F57\\u1F59\\u1F5B\\u1F5D\\u1F5F-\\u1F7D\\u1F8" + "0-\\u1FB4\\u1FB6-\\u1FBC\\u1FBE\\u1FC2-\\u1FC4\\u1FC6-\\u1FCC\\u1FD" + "0-\\u1FD3\\u1FD6-\\u1FDB\\u1FE0-\\u1FEC\\u1FF2-\\u1FF4\\u1FF6-\\u1FF" + "C\\u2071\\u207F\\u2090-\\u2094\\u2102\\u2107\\u210A-\\u2113\\u211" + "5\\u2119-\\u211D\\u2124\\u2126\\u2128\\u212A-\\u212D\\u212F-\\u213" + "9\\u213C-\\u213F\\u2145-\\u2149\\u214E\\u2183\\u2184\\u2C00-\\u2C2" + "E\\u2C30-\\u2C5E\\u2C60-\\u2C6F\\u2C71-\\u2C7D\\u2C80-\\u2CE4\\u2D0" + "0-\\u2D25\\u2D30-\\u2D65\\u2D6F\\u2D80-\\u2D96\\u2DA0-\\u2DA6\\u2DA" + "8-\\u2DAE\\u2DB0-\\u2DB6\\u2DB8-\\u2DBE\\u2DC0-\\u2DC6\\u2DC8-\\u2DC" + "E\\u2DD0-\\u2DD6\\u2DD8-\\u2DDE\\u2E2F\\u3005\\u3006\\u3031-\\u303" + "5\\u303B\\u303C\\u3041-\\u3096\\u309D-\\u309F\\u30A1-\\u30FA\\u30F" + "C-\\u30FF\\u3105-\\u312D\\u3131-\\u318E\\u31A0-\\u31B7\\u31F0-\\u31F" + "F\\u3400\\u4DB5\\u4E00\\u9FC3\\uA000-\\uA48C\\uA500-\\uA60C\\uA61" + "0-\\uA61F\\uA62A\\uA62B\\uA640-\\uA65F\\uA662-\\uA66E\\uA67F-\\uA69" + "7\\uA717-\\uA71F\\uA722-\\uA788\\uA78B\\uA78C\\uA7FB-\\uA801\\uA80" + "3-\\uA805\\uA807-\\uA80A\\uA80C-\\uA822\\uA840-\\uA873\\uA882-\\uA8B" + "3\\uA90A-\\uA925\\uA930-\\uA946\\uAA00-\\uAA28\\uAA40-\\uAA42\\uAA4" + "4-\\uAA4B\\uAC00\\uD7A3\\uF900-\\uFA2D\\uFA30-\\uFA6A\\uFA70-\\uFAD" + "9\\uFB00-\\uFB06\\uFB13-\\uFB17\\uFB1D\\uFB1F-\\uFB28\\uFB2A-\\uFB3" + "6\\uFB38-\\uFB3C\\uFB3E\\uFB40\\uFB41\\uFB43\\uFB44\\uFB46-\\uFBB" + "1\\uFBD3-\\uFD3D\\uFD50-\\uFD8F\\uFD92-\\uFDC7\\uFDF0-\\uFDFB\\uFE7" + "0-\\uFE74\\uFE76-\\uFEFC\\uFF21-\\uFF3A\\uFF41-\\uFF5A\\uFF66-\\uFFB" + "E\\uFFC2-\\uFFC7\\uFFCA-\\uFFCF\\uFFD2-\\uFFD7\\uFFDA-\\uFFDC]");
            ρσ_d["non_spacing_mark"] = new RegExp("[\\u0300-\\u036F\\u0483-\\u0487\\u0591-\\u05BD\\u05BF\\u05C1\\u05C" + "2\\u05C4\\u05C5\\u05C7\\u0610-\\u061A\\u064B-\\u065E\\u0670\\u06D" + "6-\\u06DC\\u06DF-\\u06E4\\u06E7\\u06E8\\u06EA-\\u06ED\\u0711\\u073" + "0-\\u074A\\u07A6-\\u07B0\\u07EB-\\u07F3\\u0816-\\u0819\\u081B-\\u082" + "3\\u0825-\\u0827\\u0829-\\u082D\\u0900-\\u0902\\u093C\\u0941-\\u094" + "8\\u094D\\u0951-\\u0955\\u0962\\u0963\\u0981\\u09BC\\u09C1-\\u09C" + "4\\u09CD\\u09E2\\u09E3\\u0A01\\u0A02\\u0A3C\\u0A41\\u0A42\\u0A4" + "7\\u0A48\\u0A4B-\\u0A4D\\u0A51\\u0A70\\u0A71\\u0A75\\u0A81\\u0A8" + "2\\u0ABC\\u0AC1-\\u0AC5\\u0AC7\\u0AC8\\u0ACD\\u0AE2\\u0AE3\\u0B0" + "1\\u0B3C\\u0B3F\\u0B41-\\u0B44\\u0B4D\\u0B56\\u0B62\\u0B63\\u0B8" + "2\\u0BC0\\u0BCD\\u0C3E-\\u0C40\\u0C46-\\u0C48\\u0C4A-\\u0C4D\\u0C5" + "5\\u0C56\\u0C62\\u0C63\\u0CBC\\u0CBF\\u0CC6\\u0CCC\\u0CCD\\u0CE" + "2\\u0CE3\\u0D41-\\u0D44\\u0D4D\\u0D62\\u0D63\\u0DCA\\u0DD2-\\u0DD" + "4\\u0DD6\\u0E31\\u0E34-\\u0E3A\\u0E47-\\u0E4E\\u0EB1\\u0EB4-\\u0EB" + "9\\u0EBB\\u0EBC\\u0EC8-\\u0ECD\\u0F18\\u0F19\\u0F35\\u0F37\\u0F3" + "9\\u0F71-\\u0F7E\\u0F80-\\u0F84\\u0F86\\u0F87\\u0F90-\\u0F97\\u0F9" + "9-\\u0FBC\\u0FC6\\u102D-\\u1030\\u1032-\\u1037\\u1039\\u103A\\u103" + "D\\u103E\\u1058\\u1059\\u105E-\\u1060\\u1071-\\u1074\\u1082\\u108" + "5\\u1086\\u108D\\u109D\\u135F\\u1712-\\u1714\\u1732-\\u1734\\u175" + "2\\u1753\\u1772\\u1773\\u17B7-\\u17BD\\u17C6\\u17C9-\\u17D3\\u17D" + "D\\u180B-\\u180D\\u18A9\\u1920-\\u1922\\u1927\\u1928\\u1932\\u193" + "9-\\u193B\\u1A17\\u1A18\\u1A56\\u1A58-\\u1A5E\\u1A60\\u1A62\\u1A6" + "5-\\u1A6C\\u1A73-\\u1A7C\\u1A7F\\u1B00-\\u1B03\\u1B34\\u1B36-\\u1B3" + "A\\u1B3C\\u1B42\\u1B6B-\\u1B73\\u1B80\\u1B81\\u1BA2-\\u1BA5\\u1BA" + "8\\u1BA9\\u1C2C-\\u1C33\\u1C36\\u1C37\\u1CD0-\\u1CD2\\u1CD4-\\u1CE" + "0\\u1CE2-\\u1CE8\\u1CED\\u1DC0-\\u1DE6\\u1DFD-\\u1DFF\\u20D0-\\u20D" + "C\\u20E1\\u20E5-\\u20F0\\u2CEF-\\u2CF1\\u2DE0-\\u2DFF\\u302A-\\u302" + "F\\u3099\\u309A\\uA66F\\uA67C\\uA67D\\uA6F0\\uA6F1\\uA802\\uA80" + "6\\uA80B\\uA825\\uA826\\uA8C4\\uA8E0-\\uA8F1\\uA926-\\uA92D\\uA94" + "7-\\uA951\\uA980-\\uA982\\uA9B3\\uA9B6-\\uA9B9\\uA9BC\\uAA29-\\uAA2" + "E\\uAA31\\uAA32\\uAA35\\uAA36\\uAA43\\uAA4C\\uAAB0\\uAAB2-\\uAAB" + "4\\uAAB7\\uAAB8\\uAABE\\uAABF\\uAAC1\\uABE5\\uABE8\\uABED\\uFB1" + "E\\uFE00-\\uFE0F\\uFE20-\\uFE26]");
            ρσ_d["space_combining_mark"] = new RegExp("[\\u0903\\u093E-\\u0940\\u0949-\\u094C\\u094E\\u0982\\u0983\\u09B" + "E-\\u09C0\\u09C7\\u09C8\\u09CB\\u09CC\\u09D7\\u0A03\\u0A3E-\\u0A4" + "0\\u0A83\\u0ABE-\\u0AC0\\u0AC9\\u0ACB\\u0ACC\\u0B02\\u0B03\\u0B3" + "E\\u0B40\\u0B47\\u0B48\\u0B4B\\u0B4C\\u0B57\\u0BBE\\u0BBF\\u0BC" + "1\\u0BC2\\u0BC6-\\u0BC8\\u0BCA-\\u0BCC\\u0BD7\\u0C01-\\u0C03\\u0C4" + "1-\\u0C44\\u0C82\\u0C83\\u0CBE\\u0CC0-\\u0CC4\\u0CC7\\u0CC8\\u0CC" + "A\\u0CCB\\u0CD5\\u0CD6\\u0D02\\u0D03\\u0D3E-\\u0D40\\u0D46-\\u0D4" + "8\\u0D4A-\\u0D4C\\u0D57\\u0D82\\u0D83\\u0DCF-\\u0DD1\\u0DD8-\\u0DD" + "F\\u0DF2\\u0DF3\\u0F3E\\u0F3F\\u0F7F\\u102B\\u102C\\u1031\\u103" + "8\\u103B\\u103C\\u1056\\u1057\\u1062-\\u1064\\u1067-\\u106D\\u108" + "3\\u1084\\u1087-\\u108C\\u108F\\u109A-\\u109C\\u17B6\\u17BE-\\u17C" + "5\\u17C7\\u17C8\\u1923-\\u1926\\u1929-\\u192B\\u1930\\u1931\\u193" + "3-\\u1938\\u19B0-\\u19C0\\u19C8\\u19C9\\u1A19-\\u1A1B\\u1A55\\u1A5" + "7\\u1A61\\u1A63\\u1A64\\u1A6D-\\u1A72\\u1B04\\u1B35\\u1B3B\\u1B3" + "D-\\u1B41\\u1B43\\u1B44\\u1B82\\u1BA1\\u1BA6\\u1BA7\\u1BAA\\u1C2" + "4-\\u1C2B\\u1C34\\u1C35\\u1CE1\\u1CF2\\uA823\\uA824\\uA827\\uA88" + "0\\uA881\\uA8B4-\\uA8C3\\uA952\\uA953\\uA983\\uA9B4\\uA9B5\\uA9B" + "A\\uA9BB\\uA9BD-\\uA9C0\\uAA2F\\uAA30\\uAA33\\uAA34\\uAA4D\\uAA7" + "B\\uABE3\\uABE4\\uABE6\\uABE7\\uABE9\\uABEA\\uABEC]");
    ...
    (function(){
        var __name__ = "parse";
        var COMPILER_VERSION, PYTHON_FLAGS, CACHE_VERSION, NATIVE_CLASSES, ERROR_CLASSES, COMMON_STATIC, FORBIDDEN_CLASS_VARS, UNARY_PREFIX, ASSIGNMENT, PRECEDENCE, STATEMENTS_WITH_LABELS, ATOMIC_START_TOKEN, compile_time_decorators;
        var AST_ArgsDef = ρσ_modules.ast.AST_ArgsDef;
        var AST_Array = ρσ_modules.ast.AST_Array;
        var AST_Assign = ρσ_modules.ast.AST_Assign;
        var AST_Binary = ρσ_modules.ast.AST_Binary;
        var AST_BlockStatement = ρσ_modules.ast.AST_BlockStatement;
        ...
        var AST_CallArg = ρσ_modules.ast.AST_CallArg;
        var AST_CallArgs = ρσ_modules.ast.AST_CallArgs;
        ...
        PRECEDENCE = (function() {
            ...
            return ρσ_anonfunc;
        })()([ [ "||" ], [ "&&" ], [ "|" ], [ "^" ], [ "&" ], [ "==", "===", "!=", "!==" ], [ "<", ">", "<=", ">=", "in", "nin", "instanceof" ], [ ">>", "<<", ">>>" ], [ "+", "-" ], [ "*", "/", "//", "%" ], [ "**" ] ], Object.create(null));
        ...
        function create_parser_ctx(S, import_dirs, module_id, baselib_items, imported_module_ids, imported_modules, importing_modules, options) {
            ...
            function is_recoverable_error(e) {
                return e instanceof SyntaxError;
            };
            if (!is_recoverable_error.__argnames__) Object.defineProperties(is_recoverable_error, {
                __argnames__ : {value: ["e"]},
                __module__ : {value: "parse"}
            });

            function record_recovery(e) {
                S.recovered_errors.push((function(){
                    var ρσ_d = Object.create(null);
                    ρσ_d["message"] = e.message;
                    ρσ_d["line"] = e.line;
                    ρσ_d["col"] = e.col;
                    ρσ_d["pos"] = e.pos;
                    ρσ_d["endpos"] = e.endpos;
                    ρσ_d["is_eof"] = e.is_eof;
                    return ρσ_d;
                }).call(this));
            };
            if (!record_recovery.__argnames__) Object.defineProperties(record_recovery, {
                __argnames__ : {value: ["e"]},
                __module__ : {value: "parse"}
            });

            async function skip_to_recovery_point() {
                while (!is_("eof")) {
                    try {
                        next();
                    } catch (ρσ_Exception) {
                    ...
                    if (is_("eof") || is_("punc", "}") || S.token.nlb) {
                        return;
                    }
                }
            };
            if (!skip_to_recovery_point.__module__) Object.defineProperties(skip_to_recovery_point, {
                __module__ : {value: "parse"}
            });
            ...
            function embed_tokens(parser) {
                async function with_embedded_tokens() {
                    var start, expr, end;
                    start = S.token;
                    expr = await parser();
                    if (expr === undefined) {
            ...
            var statement = embed_tokens((function() {
                var ρσ_anonfunc = async function statement() {
                    var tmp_, p, bs_body, do_body, do_cond, while_cond, while_body, start, func, chain, cond, msg, ret_val, value, node, tmp;
                    ...
                    if (tmp_ === "string") {
                        ...
                        if (tmp_ === "break") {
                            ...
                            do_cond = await (function() {
                                var ρσ_anonfunc = async function () {
                                    var tmp;
                                    expect(".");
                            ...
                            next();
                            start = prev();
                            func = await function_((ρσ_expr_temp = S.in_class)[ρσ_expr_temp.length-1], false, true);
                            func.start = start;
                            func.end = prev();
                            ...
                            start = prev();
                            func = await function_((ρσ_expr_temp = S.in_class)[ρσ_expr_temp.length-1], false);
                            func.start = start;
                            func.end = prev();
                            chain = await subscripts(func, true);
                            if (chain === func) {
                            ...
                            if (S.in_function === 0 || !(ρσ_expr_temp = S.functions)[ρσ_expr_temp.length-1].is_async) {
            ...
            async function simple_statement(tmp) {
                tmp = await expression(true);
                semicolon();
                return new AST_SimpleStatement((function(){
                    var ρσ_d = Object.create(null);
            ...
            async function yield_() {
                var is_yield_from, yld_val;
                if (S.in_function === 0) {
                    croak("'yield' outside of function");
                }
                if ((ρσ_expr_temp = S.functions)[ρσ_expr_temp.length-1].is_async) {
            ...
            async function for_in(init, list_comp) {
                var lhs, obj, fi_body;
            ...
            async function for_js() {
                var condition, fj_body;
            ...
            async function do_import(key) {
                ...
                _rfn = [null];
                function _capture_resolve(resolve) {
                    _rfn[0] = resolve;
                };
                if (!_capture_resolve.__argnames__) Object.defineProperties(_capture_resolve, {
                    __argnames__ : {value: ["resolve"]},
                    __module__ : {value: "parse"}
                });

                loading_promises[(typeof key === "number" && key < 0) ? loading_promises.length + key : key] = new Promise(_capture_resolve);
                try {
                    ...
                    async function safe_stat(base_path) {
                        ...
                        for (var ρσ_Index98 of ρσ_Iter98) {
                            ...
                            try {
                                ...
                                return [ st.mtimeMs, path, (has_prop(st, "content")) ? st.content : null ];
                            } catch (ρσ_Exception) {
                                ρσ_last_exception = ρσ_Exception;
                                {
                                    var e = ρσ_Exception;
                    ...
                    if (!safe_stat.__argnames__) Object.defineProperties(safe_stat, {
...
ρσ_unpack = ρσ_unpack_asarray(3, ρσ_unpack);
                            file_mtime = ρσ_unpack[0];
                            filename = ρσ_unpack[1];
                            prefetched_src = ρσ_unpack[2];
                            if (filename !== null) {
                                break;
                            }
                        }
                    ...
                    srchash = src_code = null;
                    cache_ok = cached && cached.v === CACHE_VERSION && cached.compiler_version === COMPILER_VERSION;
                    if (cache_ok && file_mtime !== null && cached.mtime !== null && cached.mtime === file_mtime) {
                        srchash = cached.signature;
                    } else {
                        src_code = prefetched_src || await readfile(filename, "utf-8");
                        srchash = sha1sum(src_code);
                        if (!cache_ok || cached.signature !== srchash) {
                            cached = null;
                        }
                    }
                    if (cached !== null) {
                        ...
                        for (var ρσ_Index101 of ρσ_Iter101) {
                            ...
                            classes[(typeof cname === "number" && cname < 0) ? classes.length + cname : cname] = (function(){
                                ...
                                ρσ_d["static"] = ci.static || Object.create(null);
                                ρσ_d["bound"] = ci.bound || [];
                                ρσ_d["classvars"] = ci.classvars || Object.create(null);
                                return ρσ_d;
                            }).call(this);
                        }
                        meta = (function(){
                            ...
                            ρσ_d["imports"] = imported_modules;
                            ρσ_d["exports"] = (function() {
                                var ρσ_Iter = cached.exported_names, ρσ_Result = [], n;
                                ρσ_Iter = ((typeof ρσ_Iter[Symbol.iterator] === "function") ? (ρσ_Iter instanceof Map ? ρσ_Iter.keys() : ρσ_Iter) : Object.keys(ρσ_Iter));
                                for (var ρσ_Index of ρσ_Iter) {
                                    n = ρσ_Index;
                            ...
                            ρσ_d["baselib"] = cached.baselib || Object.create(null);
                            ρσ_d["classes"] = classes;
                            return ρσ_d;
                        }).call(this);
                        if (cached.has_side_effects !== undefined) {
                        ...
                        imported_modules[(typeof key === "number" && key < 0) ? imported_modules.length + key : key] = module;
                    } else {
                        await parse(src_code, (function(){
                            var ρσ_d = Object.create(null);
                            ρσ_d["filename"] = filename;
                            ρσ_d["toplevel"] = null;
                    ...
                    ρσ_delitem(loading_promises, key);
                    if (_rfn[0]) {
                        _rfn[0](null);
                    }
                }
            ...
            async function import_(from_import) {
            ...
            async function class_() {
                var name, externaldecorator, class_details, bases, class_parent, a, docstrings, cls_decorators, cls_body, definition, descriptor, stmt, class_var_names, visitor;
                ...
                cls_body = await (function() {
                    var ρσ_anonfunc = async function (loop, labels) {
                        var a;
                ...
                definition = new AST_Class((function(){
                    ...
                    ρσ_d["statements"] = [];
                    ρσ_d["decorators"] = cls_decorators;
                    ρσ_d["body"] = cls_body;
                    return ρσ_d;
                }).call(this));
            ...
            async function function_() {
                ...
                var name, is_anonymous, staticmethod, property_getter, property_setter, staticloc, ctor, return_annotation, is_generator, docstrings, fn_argnames, fn_decorators, fn_body, definition, assignments, j, i, nonlocals;
                ...
                is_generator = [];
                docstrings = [];
                fn_argnames = await (function() {
                    var ρσ_anonfunc = async function () {
                        var a, starargs_sym, kwargs_sym, defaults, has_defaults, first, seen_names, def_line, current_arg_name, name_token;
                        a = [];
                        ...
                        while (!is_("punc", ")")) {
                            ...
                            if (is_("operator", "**")) {
                                ...
                                if (is_("operator", "=")) {
                                    ...
                                    next();
                                    defaults[(typeof current_arg_name === "number" && current_arg_name < 0) ? defaults.length + current_arg_name : current_arg_name] = await expression(false);
                                    has_defaults = true;
                                } else {
                                    if (has_defaults) {
                        ...
                        S.in_parenthesized_expr = false;
                        return new AST_ArgsDef((function(){
                            var ρσ_d = Object.create(null);
                            ρσ_d["args"] = a;
                            ρσ_d["starargs"] = starargs_sym;
                            ρσ_d["kwargs"] = kwargs_sym;
                            ρσ_d["defaults"] = defaults;
                            ρσ_d["has_defaults"] = has_defaults;
                            ρσ_d["is_simple_func"] = !starargs_sym && !kwargs_sym && !has_defaults;
                            return ρσ_d;
                        }).call(this));
                    };
                    if (!ρσ_anonfunc.__module__) Object.defineProperties(ρσ_anonfunc, {
                ...
                definition = new ctor((function(){
                    ...
                    ρσ_d["argnames"] = fn_argnames;
                    ρσ_d["localvars"] = [];
                    ρσ_d["decorators"] = fn_decorators;
                    ρσ_d["docstrings"] = docstrings;
                    ρσ_d["body"] = fn_body;
                    return ρσ_d;
                }).call(this));
                ...
                if (is_node_type(definition, AST_Method)) {
                    ...
                    if (definition.argnames.args.length < 1 && !definition.static) {
                ...
                if (definition.is_async && definition.is_generator) {
            ...
            async function block_(docstrings) {
            ...
            async function try_() {
                var body, bcatch, bfinally, belse, start, exceptions, name, except_body, belse_body, bfinally_body;
                body = await block_();
                bcatch = [];
                bfinally = null;
                belse = null;
            ...
            async function vardefs(symbol_class) {
                var a, vd_start, vd_name, varval;
                a = [];
                while (true) {
                    vd_start = S.token;
            ...
            async function nonlocal_(is_global) {
                var defs, vardef;
            ...
            async function new_() {
                ...
                return await subscripts(new AST_New((function(){
                    var ρσ_d = Object.create(null);
                    ρσ_d["start"] = start;
            ...
            async function expr_atom(allow_calls) {
                var start, tmp_, prev_parens, ex, ret, cls, func, value;
                if (is_("operator", "new")) {
                    return await new_();
                }
                start = S.token;
                if (is_("punc")) {
                    ...
                    if (tmp_ === "(") {
                        ...
                        if (is_("keyword", "for")) {
                            ret = await read_comprehension(new AST_GeneratorComprehension((function(){
                                var ρσ_d = Object.create(null);
                                ρσ_d["statement"] = ex;
                                return ρσ_d;
                            }).call(this)), ")");
            ...
            async function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
                var first, a, saw_starargs, pargs, kwargs, arg;
                first = true;
                a = [];
                saw_starargs = false;
                ...
                if (func_call) {
                    ...
                    return new AST_CallArgs((function(){
                        var ρσ_d = Object.create(null);
                        ρσ_d["args"] = pargs;
                        ρσ_d["kwargs"] = kwargs;
                        ρσ_d["kwarg_items"] = [];
                        ρσ_d["starargs"] = saw_starargs;
                        return ρσ_d;
                    }).call(this));
                }
                return a;
            ...
            async function func_call_list(empty) {
                var a, first, kwargs, kwarg_items, starargs, single_comprehension, arg, comp;
                a = [];
                first = true;
                kwargs = [];
                kwarg_items = [];
                ...
                if (empty) {
                    return new AST_CallArgs((function(){
                        ...
                        ρσ_d["args"] = a;
                        ρσ_d["kwargs"] = kwargs;
                        ρσ_d["kwarg_items"] = kwarg_items;
                        ρσ_d["starargs"] = starargs;
                        return ρσ_d;
                    }).call(this));
                }
                ...
                while (!is_("punc", ")") && !is_("eof")) {
                    ...
                    if (is_("operator", "*")) {
                        ...
                        a.push(new AST_CallArg((function(){
                            var ρσ_d = Object.create(null);
                            ρσ_d["value"] = arg;
                            ρσ_d["is_array"] = true;
                            return ρσ_d;
                        ...
                        if (is_node_type(arg, AST_Assign)) {
                            ...
                            if (is_("keyword", "for")) {
                                ...
                                comp = await read_comprehension(new AST_GeneratorComprehension((function(){
                                    var ρσ_d = Object.create(null);
                                    ρσ_d["statement"] = arg;
                                    return ρσ_d;
                                }).call(this)), ")");
            ...
            var array_ = embed_tokens((function() {
                var ρσ_anonfunc = async function array_() {
                    var expr, arr_rest;
                    expect("[");
                    expr = [];
                    if (!is_("punc", "]")) {
                        ...
                        if (is_("keyword", "for")) {
                            return await read_comprehension(new AST_ListComprehension((function(){
                                var ρσ_d = Object.create(null);
                    ...
                    return new AST_Array((function(){
                        var ρσ_d = Object.create(null);
                        ρσ_d["elements"] = expr.concat(arr_rest);
                        return ρσ_d;
                    }).call(this));
                };
                if (!ρσ_anonfunc.__module__) Object.defineProperties(ρσ_anonfunc, {
            ...
            var object_ = embed_tokens((function() {
                var ρσ_anonfunc = async function object_() {
                    var first, has_non_const_keys, is_pydict, is_jshash, a, start, ctx, orig, left, end, obj_val;
                    expect("{");
                    first = true;
                    ...
                    while (!is_("punc", "}")) {
                        ...
                        if (is_("keyword", "for")) {
                            return await read_comprehension(new AST_SetComprehension((function(){
                                var ρσ_d = Object.create(null);
                                ρσ_d["statement"] = left;
                                return ρσ_d;
                            }).call(this)), "}");
            ...
            async function set_(start, end, expr) {
                var ostart, a, set_val;
                ostart = start;
                a = [ new AST_SetItem((function(){
                    var ρσ_d = Object.create(null);
                    ρσ_d["start"] = start;
                    ρσ_d["end"] = end;
                    ρσ_d["value"] = expr;
            ...
            async function read_comprehension(obj, terminator) {
                var forloop;
            ...
            async function dict_comprehension(a, is_pydict, is_jshash) {
                ...
                return await read_comprehension(new AST_DictComprehension((function(){
                    var ρσ_d = Object.create(null);
                    ρσ_d["statement"] = left;
            ...
            async function getitem(expr, allow_calls) {
                var start, is_py_sub, slice_bounds, is_slice, splice_assign, _ca, _sb, i, _ca2, _ca3, assignment, assign_operator;
                start = expr.start;
                next();
                ...
                if (is_slice) {
                    if (is_("operator", "=")) {
                        ...
                        return await subscripts(new AST_Splice((function(){
                            var ρσ_d = Object.create(null);
                            ρσ_d["start"] = start;
                            ρσ_d["expression"] = expr;
                        ...
                        return await subscripts(new AST_Call((function(){
                            var ρσ_d = Object.create(null);
                            ρσ_d["start"] = start;
                            ...
                            ρσ_d["args"] = new AST_CallArgs((function(){
                                var ρσ_d = Object.create(null);
                                ρσ_d["args"] = _ca;
                                ρσ_d["kwargs"] = [];
                                ρσ_d["kwarg_items"] = [];
                    ...
                    if (is_py_sub) {
                        ...
                        return await subscripts(new AST_ItemAccess((function(){
                            var ρσ_d = Object.create(null);
                            ρσ_d["start"] = start;
                            ρσ_d["expression"] = expr;
                            ρσ_d["property"] = slice_bounds[0] || new AST_Number((function(){
                    ...
                    return await subscripts(new AST_Sub((function(){
                        var ρσ_d = Object.create(null);
                        ρσ_d["start"] = start;
                        ρσ_d["expression"] = expr;
                        ρσ_d["property"] = slice_bounds[0] || new AST_Number((function(){
            ...
            async function call_(expr) {
                var start, prev_parens, call_args, ret, c, funcname, classcall_args, tmp_, jstype_args, args, basic_args;
                start = expr.start;
                prev_parens = S.in_parenthesized_expr;
                S.in_parenthesized_expr = true;
                next();
                if (!expr.parens && get_class_in_scope(expr)) {
                    ...
                    ret = await subscripts(new AST_New((function(){
                        var ρσ_d = Object.create(null);
                        ρσ_d["start"] = start;
                        ρσ_d["expression"] = expr;
                        ρσ_d["args"] = call_args;
                    ...
                    if (c) {
                        ...
                        if (tmp_ === "jstype") {
                            ...
                            ret = new AST_UnaryPrefix((function(){
                                ...
                                ρσ_d["expression"] = jstype_args.args[0].value;
                                ρσ_d["end"] = prev();
                                return ρσ_d;
                            }).call(this));
                            S.in_parenthesized_expr = prev_parens;
                            ...
                            ret = new AST_Binary((function(){
                                var ρσ_d = Object.create(null);
                                ρσ_d["start"] = start;
                                ρσ_d["left"] = args.args[0].value;
                                ρσ_d["operator"] = "instanceof";
                                ρσ_d["right"] = args.args[1].value;
                                ρσ_d["end"] = prev();
                                return ρσ_d;
                            }).call(this));
                            S.in_parenthesized_expr = prev_parens;
                    ...
                    ret = await subscripts(new AST_Call((function(){
                        var ρσ_d = Object.create(null);
                        ρσ_d["start"] = start;
                        ρσ_d["expression"] = expr;
                        ρσ_d["args"] = basic_args;
                        ρσ_d["end"] = prev();
                        return ρσ_d;
                    }).call(this)), true);
                    S.in_parenthesized_expr = prev_parens;
            ...
            async function get_attr(expr, allow_calls) {
                ...
                return await subscripts(new AST_Dot((function(){
                    var ρσ_d = Object.create(null);
            ...
            async function existential(expr, allow_calls) {
            ...
            async function subscripts(expr, allow_calls) {
                if (is_("punc", ".")) {
            ...
            async function maybe_unary(allow_calls) {
            ...
            async function expr_op(left, min_prec, no_in) {
            ...
            async function maybe_conditional(no_in) {
                var start, expr, ne, cond_alt, conditional;
                start = S.token;
            ...
            async function maybe_assign(no_in, only_plain_assignment) {
                var start, left, val, assign_right;
                start = S.token;
            ...
            async function expression(commas, no_in) {
                var start, expr, left, seq_cdr;
                start = S.token;
                ...
                if (commas) {
                    left = [ expr ];
                    while (is_("punc", ",") && (!peek().nlb || S.in_parenthesized_expr) || S.in_parenthesized_expr && S.token.nlb && !is_("punc", ")")) {
                        if (is_("punc", ",")) {
                            next();
                        }
            ...
            async function run_parser() {
                var start, body, docstrings, first_token, toplevel, element, shebang, ds, end, recovered, tok_ctx, seen_exports, item, classes_cache, cls, cname, has_se, idx_exec_refs_set, idx_import_bindings, idx_top_defs, idx_pinned, idx_dec, idx_def_refs, idx_local, idx_arg, idx_imp, se_found, idx_stmt, cache_meta;
                start = S.token = next();
                body = [];
                docstrings = [];
                first_token = true;
                ...
                if (options.recover_errors) {
                    ...
                    try {
                        ...
                        if (tok_ctx && tok_ctx.recovered_errors && tok_ctx.recovered_errors.length) {
                    ...
                    try {
                        ...
                        for (var ρσ_Index121 of ρσ_Iter121) {
                            ...
                            classes_cache[(typeof cname === "number" && cname < 0) ? classes_cache.length + cname : cname] = (function(){
                                var ρσ_d = Object.create(null);
                                ρσ_d["static"] = cls.static || Object.create(null);
                                ρσ_d["bound"] = cls.bound || [];
                                ρσ_d["classvars"] = cls.classvars || Object.create(null);
                                return ρσ_d;
                            }).call(this);
                        }
                        has_se = false;
                        idx_exec_refs_set = Object.create(null);
                        idx_import_bindings = Object.create(null);
                        idx_top_defs = Object.create(null);
                        function _collect_refs_into(node, refs_set) {
                            function _rv(n) {
                                if (is_node_type(n, AST_SymbolRef)) {
                                    refs_set[ρσ_bound_index(n.name, refs_set)] = true;
                                }
                            };
                            if (!_rv.__argnames__) Object.defineProperties(_rv, {
                                __argnames__ : {value: ["n"]},
                                __module__ : {value: "parse"}
                            });
                        ...
                        if (!_collect_refs_into.__argnames__) Object.defineProperties(_collect_refs_into, {
                            __argnames__ : {value: ["node", "refs_set"]},
                            __module__ : {value: "parse"}
                        });
                        ...
                        for (var ρσ_Index122 of ρσ_Iter122) {
                            ...
                            if (is_node_type(idx_stmt, AST_Function) || is_node_type(idx_stmt, AST_Class)) {
                                if (idx_stmt.name) {
                                    ...
                                    idx_def_refs = Object.create(null);
                                    _collect_refs_into(idx_stmt, idx_def_refs);
                                    idx_top_defs[ρσ_bound_index(idx_stmt.name.name, idx_top_defs)] = (function(){
                                        var ρσ_d = Object.create(null);
                                        ρσ_d["pinned"] = idx_pinned;
                                        ρσ_d["refs"] = Object.keys(idx_def_refs);
                                        return ρσ_d;
                                    }).call(this);
                                }
                                    ...
                                    if (idx_imp.argnames && idx_imp.argnames.length) {
                                        ...
                                        for (var ρσ_Index125 of ρσ_Iter125) {
                                            ...
                                            idx_import_bindings[(typeof idx_local === "number" && idx_local < 0) ? idx_import_bindings.length + idx_local : idx_local] = (function(){
                                                var ρσ_d = Object.create(null);
                                                ρσ_d["source"] = idx_imp.key;
                                                ρσ_d["imported_name"] = idx_arg.name;
                                                ρσ_d["is_namespace"] = false;
                                                return ρσ_d;
                                            }).call(this);
                                        }
                                    } else {
                                        idx_local = (idx_imp.alias) ? idx_imp.alias.name : idx_imp.key.split(".")[0];
                                        idx_import_bindings[(typeof idx_local === "number" && idx_local < 0) ? idx_import_bindings.length + idx_local : idx_local] = (function(){
                                            var ρσ_d = Object.create(null);
                                            ρσ_d["source"] = idx_imp.key;
                                            ρσ_d["imported_name"] = null;
                                            ρσ_d["is_namespace"] = true;
                                            return ρσ_d;
                                        }).call(this);
                                    }
                                }
                                ...
                                if (!has_se) {
                                    se_found = [false];
                                    function se_check(se_node, se_descend) {
                                        if (is_node_type(se_node, AST_Call)) {
                                            se_found[0] = true;
                                            return true;
                                        }
                                    };
                                    if (!se_check.__argnames__) Object.defineProperties(se_check, {
                                        __argnames__ : {value: ["se_node", "se_descend"]},
                                        __module__ : {value: "parse"}
                                    });
                        ...
                        cache_meta = (function(){
                            var ρσ_d = Object.create(null);
                            ρσ_d["v"] = CACHE_VERSION;
                            ρσ_d["signature"] = options._src_hash;
                            ρσ_d["compiler_version"] = COMPILER_VERSION;
                            ρσ_d["imported_module_ids"] = toplevel.imported_module_ids;
                            ρσ_d["exported_names"] = (function() {
                                var ρσ_Iter = toplevel.exports, ρσ_Result = [], sym;
                                ρσ_Iter = ((typeof ρσ_Iter[Symbol.iterator] === "function") ? (ρσ_Iter instanceof Map ? ρσ_Iter.keys() : ρσ_Iter) : Object.keys(ρσ_Iter));
                                for (var ρσ_Index of ρσ_Iter) {
                                    sym = ρσ_Index;
                                    ρσ_Result.push(sym.name);
                                }
                                ρσ_Result = ρσ_list_constructor(ρσ_Result);
                                return ρσ_Result;
                            })();
                            ρσ_d["baselib"] = toplevel.baselib || Object.create(null);
                            ρσ_d["classes"] = classes_cache;
                            ρσ_d["has_side_effects"] = has_se;
                            ρσ_d["index"] = (function(){
                                var ρσ_d = Object.create(null);
                                ρσ_d["exec_refs"] = Object.keys(idx_exec_refs_set);
                                ρσ_d["import_bindings"] = idx_import_bindings;
                                ρσ_d["top_defs"] = idx_top_defs;
                                return ρσ_d;
                            }).call(this);
                            return ρσ_d;
                        }).call(this);
                        if (options._file_mtime !== null && options._file_mtime !== undefined) {
        ...
        async function parse(text, options) {
            ...
            S = (function(){
                var ρσ_d = Object.create(null);
                ρσ_d["input"] = (typeof text === "string") ? tokenizer(text, options.filename, options.recover_errors) : text;
                ρσ_d["recovered_errors"] = [];
                ρσ_d["token"] = null;
                ρσ_d["prev"] = null;
                ρσ_d["peeked"] = [];
                ...
                ρσ_d["in_class"] = [ false ];
                ρσ_d["classes"] = [ Object.create(null) ];
                ρσ_d["functions"] = [ Object.create(null) ];
                ρσ_d["labels"] = [];
                ρσ_d["decorators"] = [];
            ...
            if (typeof text === "string" && !options._src_hash) {
        ...
        ρσ_modules.parse.CACHE_VERSION = CACHE_VERSION;
        ...
        function generate_code() {
            ...
            PARENS(AST_New, (function() {
                var ρσ_anonfunc = function (output) {
                    var p;
                    p = output.parent();
                    if (this.args.args.length === 0 && (is_node_type(p, AST_PropAccess) || is_node_type(p, AST_BaseCall) && p.expression === this)) {
                        return true;
                    }
                };
                if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
    ...
    (function(){
        ...
        if (!_make_ident_chars.__module__) Object.defineProperties(_make_ident_chars, {
        ...
        ρσ_modules["output.stream"]._make_ident_chars = _make_ident_chars;
